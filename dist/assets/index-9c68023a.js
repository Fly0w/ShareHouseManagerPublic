 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gw="FirebaseError";class xt extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=gw,Object.setPrototypeOf(this,xt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ts.prototype.create)}}class Ts{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?_w(i,r):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new xt(s,a,r)}}function _w(n,e){return n.replace(yw,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const yw=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qw{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(jw(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function jw(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Xu="@firebase/app",Mp="0.9.15";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr=new Map,xo=new Map;function Ac(n,e){try{n.container.addComponent(e)}catch(t){us.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function y_(n,e){n.container.addOrOverwriteComponent(e)}function pr(n){const e=n.name;if(xo.has(e))return us.debug(`There were multiple attempts to register component ${e}.`),!1;xo.set(e,n);for(const t of fr.values())Ac(t,n);return!0}function v_(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function g2(n,e,t=dr){v_(n,e).clearInstance(t)}function _2(){xo.clear()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sr=p2;function ld(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:dr,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw Vn.create("bad-app-name",{appName:String(s)});if(t||(t=h_()),!t)throw Vn.create("no-options");const i=fr.get(s);if(i){if(Qu(t,i.options)&&Qu(r,i.config))return i;throw Vn.create("duplicate-app",{appName:s})}const o=new Aw(s);for(const c of xo.values())o.addComponent(c);const a=new v2(t,r,o);return fr.set(s,a),a}function I2(n=dr){const e=fr.get(n);if(!e&&n===dr&&h_())return ld();if(!e)throw Vn.create("no-app",{appName:n});return e}function w2(){return Array.from(fr.values())}async function I_(n){const e=n.name;fr.has(e)&&(fr.delete(e),await Promise.all(n.container.getProviders().map(t=>t.delete())),n.isDeleted=!0)}function En(n,e,t){var r;let s=(r=m2[n])!==null&&r!==void 0?r:n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${s}" with version "${e}":`];i&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),us.warn(a.join(" "));return}pr(new bn(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}function w_(n,e){if(n!==null&&typeof n!="function")throw Vn.create("invalid-log-argument");Cw(n,e)}function E_(n){Pw(n)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E2="firebase-heartbeat-database",T2=1,Po="firebase-heartbeat-store";let Eu=null;function T_(){return Eu||(Eu=Uw(E2,T2,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(Po)}}}).catch(n=>{throw Vn.create("idb-open",{originalErrorMessage:n.message})})),Eu}async function b2(n){try{return await(await T_()).transaction(Po).objectStore(Po).get(b_(n))}catch(e){if(e instanceof xt)us.warn(e.message);else{const t=Vn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});us.warn(t.message)}}}async function Lp(n,e){try{const r=(await T_()).transaction(Po,"readwrite");await r.objectStore(Po).put(e,b_(n)),await r.done}catch(t){if(t instanceof xt)us.warn(t.message);else{const r=Vn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});us.warn(r.message)}}}function b_(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A2=1024,R2=30*24*60*60*1e3;class S2{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new P2(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=Fp();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(s=>s.date===r)))return this._heartbeatsCache.heartbeats.push({date:r,agent:t}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(s=>{const i=new Date(s.date).valueOf();return Date.now()-i<=R2}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Fp(),{heartbeatsToSend:t,unsentEntries:r}=x2(this._heartbeatsCache.heartbeats),s=Tc(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}}function Fp(){return new Date().toISOString().substring(0,10)}function x2(n,e=A2){const t=[];let r=n.slice();for(const s of n){const i=t.find(o=>o.agent===s.agent);if(i){if(i.dates.push(s.date),Up(t)>e){i.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),Up(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class P2{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return So()?mw().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await b2(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const s=await this.read();return Lp(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const s=await this.read();return Lp(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function Up(n){return Tc(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function C2(n){pr(new bn("platform-logger",e=>new qw(e),"PRIVATE")),pr(new bn("heartbeat",e=>new S2(e),"PRIVATE")),En(Xu,Mp,n),En(Xu,Mp,"esm2017"),En("fire-js","")}C2("");const k2=Object.freeze(Object.defineProperty({__proto__:null,FirebaseError:xt,SDK_VERSION:Sr,_DEFAULT_ENTRY_NAME:dr,_addComponent:Ac,_addOrOverwriteComponent:y_,_apps:fr,_clearComponents:_2,_components:xo,_getProvider:v_,_registerComponent:pr,_removeServiceInstance:g2,deleteApp:I_,getApp:I2,getApps:w2,initializeApp:ld,onLog:w_,registerVersion:En,setLogLevel:E_},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 ...
 */if(fw()&&self.firebase!==void 0){$p.warn(`
  ...
  `);const n=self.firebase.SDK_VERSION;n&&n.indexOf("LITE")>=0&&$p.warn(`
    ...
    `)}const xr=O2;F2();var U2="firebase",B2="10.1.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */xr.registerVersion(U2,B2,"app-compat");function ud(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(n);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(n,r[s])&&(t[r[s]]=n[r[s]]);return t}const qi={FACEBOOK:"facebook.com",GITHUB:"github.com",GOOGLE:"google.com",PASSWORD:"password",PHONE:"phone",TWITTER:"twitter.com"},Vs={EMAIL_SIGNIN:"EMAIL_SIGNIN",PASSWORD_RESET:"PASSWORD_RESET",RECOVER_EMAIL:"RECOVER_EMAIL",REVERT_SECOND_FACTOR_ADDITION:"REVERT_SECOND_FACTOR_ADDITION",VERIFY_AND_CHANGE_EMAIL:"VERIFY_AND_CHANGE_EMAIL",VERIFY_EMAIL:"VERIFY_EMAIL"};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rc=new ol("@firebase/auth");function z2(n,...e){Rc.logLevel<=fe.WARN&&Rc.warn(`Auth (${Sr}): ${n}`,...e)}function oc(n,...e){Rc.logLevel<=fe.ERROR&&Rc.error(`Auth (${Sr}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yt(n,...e){throw hd(n,...e)}function gt(n,...e){return hd(n,...e)}function x_(n,e,t){const r=Object.assign(Object.assign({},j2()),{[e]:t});return new Ts("auth","Firebase",r).create(e,{appName:n.name})}function Ei(n,e,t){const r=t;if(!(e instanceof r))throw r.name!==e.constructor.name&&yt(n,"argument-error"),x_(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function hd(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return S_.create(n,...e)}function P(n,e,...t){if(!n)throw hd(e,...t)}function _n(n){const e="INTERNAL ASSERTION FAILED: "+n;throw oc(e),new Error(e)}function nn(n,e){n||_n(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Co(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function dd(){return qp()==="http:"||qp()==="https:"}function qp(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mn(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof xt&&tE(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function tE({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ko(n){var e;const t=n.auth,r=await n.getIdToken(),s=await Mn(n,X2(t,{idToken:r}));P(s==null?void 0:s.users.length,t,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const o=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?iE(i.providerUserInfo):[],a=sE(n.providerData,o),c=n.isAnonymous,l=!(n.email&&i.passwordHash)&&!(a!=null&&a.length),u=c?l:!1,h={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:a,metadata:new D_(i.createdAt,i.lastLoginAt),isAnonymous:u};Object.assign(n,h)}async function rE(n){const e=Q(n);await ko(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function sE(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function iE(n){return n.map(e=>{var{providerId:t}=e,r=ud(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oE(n,e){const t=await C_(n,{},async()=>{const r=wi({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=n.config,o=k_(n,s,"/v1/token",`key=${i}`),a=await n._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",P_.fetch()(o,{method:"POST",headers:a,body:r})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Do{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){P(e.idToken,"internal-error"),P(typeof e.idToken<"u","internal-error"),P(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):eE(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return P(!this.accessToken||this.refreshToken,e,"user-token-expired"),!t&&this.accessToken&&!this.isExpired?this.accessToken:this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:r,refreshToken:s,expiresIn:i}=await oE(e,t);this.updateTokensAndExpiration(r,s,Number(i))}updateTokensAndExpiration(e,t,r){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,t){const{refreshToken:r,accessToken:s,expirationTime:i}=t,o=new Do;return r&&(P(typeof r=="string","internal-error",{appName:e}),o.refreshToken=r),s&&(P(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),i&&(P(typeof i=="number","internal-error",{appName:e}),o.expirationTime=i),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Do,this.toJSON())}_performRefresh(){return _n("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jp=new Map;function jt(n){nn(n instanceof Function,"Expected a class definition");let e=jp.get(n);return e?(nn(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,jp.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B_(n,e=[]){let t;switch(n){case"Browser":t=zp(Be());break;case"Worker":t=`${zp(Be())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Sr}/${r}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bu(n,e){return qn(n,"POST","/v1/accounts:signInWithPassword",Ze(n,e))}async function cl(n,e){return nt(n,"POST","/v1/accounts:sendOobCode",Ze(n,e))}async function TE(n,e){return cl(n,e)}async function Au(n,e){return cl(n,e)}async function Ru(n,e){return cl(n,e)}async function bE(n,e){return cl(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function AE(n,e){return qn(n,"POST","/v1/accounts:signInWithEmailLink",Ze(n,e))}async function RE(n,e){return qn(n,"POST","/v1/accounts:signInWithEmailLink",Ze(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function On(n,e){return qn(n,"POST","/v1/accounts:signInWithIdp",Ze(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function NE(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function VE(n){const e=js(to(n)).link,t=e?js(to(e)).deep_link_id:null,r=js(to(n)).deep_link_id;return(r?js(to(r)).link:null)||r||t||e||n}class ll{constructor(e){var t,r,s,i,o,a;const c=js(to(e)),l=(t=c.apiKey)!==null&&t!==void 0?t:null,u=(r=c.oobCode)!==null&&r!==void 0?r:null,h=NE((s=c.mode)!==null&&s!==void 0?s:null);P(l&&u&&h,"argument-error"),this.apiKey=l,this.operation=h,this.code=u,this.continueUrl=(i=c.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const t=VE(e);try{return new ll(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pr{constructor(){this.providerId=Pr.PROVIDER_ID}static credential(e,t){return No._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=ll.parseLink(t);return P(r,"argument-error"),No._fromEmailAndCode(e,r.code,r.tenantId)}}Pr.PROVIDER_ID="password";Pr.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Pr.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ai extends jn{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}class Ks extends Ai{static credentialFromJSON(e){const t=typeof e=="string"?JSON.parse(e):e;return P("providerId"in t&&"signInMethod"in t,"argument-error"),An._fromParams(t)}credential(e){return this._credential(Object.assign(Object.assign({},e),{nonce:e.rawNonce}))}_credential(e){return P(e.idToken||e.accessToken,"argument-error"),An._fromParams(Object.assign(Object.assign({},e),{providerId:this.providerId,signInMethod:this.providerId}))}static credentialFromResult(e){return Ks.oauthCredentialFromTaggedObject(e)}static credentialFromError(e){return Ks.oauthCredentialFromTaggedObject(e.customData||{})}static oauthCredentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r,oauthTokenSecret:s,pendingToken:i,nonce:o,providerId:a}=e;if(!r&&!s&&!t&&!i||!a)return null;try{return new Ks(a)._credential({idToken:t,accessToken:r,nonce:o,pendingToken:i})}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ME="saml.";class Sc extends jn{constructor(e){P(e.startsWith(ME),"argument-error"),super(e)}static credentialFromResult(e){return Sc.samlCredentialFromTaggedObject(e)}static credentialFromError(e){return Sc.samlCredentialFromTaggedObject(e.customData||{})}static credentialFromJSON(e){const t=ri.fromJSON(e);return P(t,"argument-error"),t}static samlCredentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{pendingToken:t,providerId:r}=e;if(!t||!r)return null;try{return ri._create(r,t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ac(n,e){return qn(n,"POST","/v1/accounts:signUp",Ze(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xc extends xt{constructor(e,t,r,s){var i;super(t.code,t.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,xc.prototype),this.customData={appName:e.name,tenantId:(i=e.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:t.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,t,r,s){return new xc(e,t,r,s)}}function W_(n,e,t,r){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?xc._fromErrorAndOperation(n,i,e,r):i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function UE(n,e){return qn(n,"POST","/v1/accounts:signInWithCustomToken",Ze(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function HE(n,e,t){var r;const s=Qe(n),i={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function o(a,c){P(c.handleCodeInApp,s,"argument-error"),c&&Hs(s,a,c)}if(!((r=s._getRecaptchaConfig())===null||r===void 0)&&r.emailPasswordEnabled){const a=await mr(s,i,"getOobCode",!0);o(a,t),await Ru(s,a)}else o(i,t),await Ru(s,i).catch(async a=>{if(a.code==="auth/missing-recaptcha-token"){console.log("Email link sign-in is protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the sign-in flow.");const c=await mr(s,i,"getOobCode",!0);o(c,t),await Ru(s,c)}else return Promise.reject(a)})}function WE(n,e){const t=ll.parseLink(e);return(t==null?void 0:t.operation)==="EMAIL_SIGNIN"}async function QE(n,e,t){const r=Q(n),s=Pr.credentialWithLink(e,t||Co());return P(s._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),hl(r,s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vd{constructor(e,t,r){this.session=e,this.hints=t,this.signInResolver=r}static _fromError(e,t){const r=Qe(e),s=t.customData._serverResponse,i=(s.mfaInfo||[]).map(a=>da._fromServerResponse(r,a));P(s.mfaPendingCredential,r,"internal-error");const o=Jr._fromMfaPendingCredential(s.mfaPendingCredential);return new vd(o,i,async a=>{const c=await a._process(r,o);delete s.mfaInfo,delete s.mfaPendingCredential;const l=Object.assign(Object.assign({},s),{idToken:c.idToken,refreshToken:c.refreshToken});switch(t.operationType){case"signIn":const u=await Qt._fromIdTokenResponse(r,t.operationType,l);return await r._updateCurrentUser(u.user),u;case"reauthenticate":return P(t.user,r,"internal-error"),Qt._forOperation(t.user,t.operationType,l);default:yt(r,"internal-error")}})}async resolveSignIn(e){const t=e;return this.signInResolver(t)}}function uT(n,e){var t;const r=Q(n),s=e;return P(e.customData.operationType,r,"argument-error"),P((t=s.customData._serverResponse)===null||t===void 0?void 0:t.mfaPendingCredential,r,"argument-error"),vd._fromError(r,s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r0{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Pc,"1"),this.storage.removeItem(Pc),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PT(n,e){return nt(n,"POST","/v2/accounts/mfaSignIn:start",Ze(n,e))}function CT(n,e){return nt(n,"POST","/v2/accounts/mfaSignIn:finalize",Ze(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xu=j_("rcb"),MT=new ua(3e4,6e4),LT="https://www.google.com/recaptcha/api.js?";class FT{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!(!((e=Xe().grecaptcha)===null||e===void 0)&&e.render)}load(e,t=""){return P(UT(t),e,"argument-error"),this.shouldResolveImmediately(t)&&Gp(Xe().grecaptcha)?Promise.resolve(Xe().grecaptcha):new Promise((r,s)=>{const i=Xe().setTimeout(()=>{s(gt(e,"network-request-failed"))},MT.get());Xe()[xu]=()=>{Xe().clearTimeout(i),delete Xe()[xu];const a=Xe().grecaptcha;if(!a||!Gp(a)){s(gt(e,"internal-error"));return}const c=a.render;a.render=(l,u)=>{const h=c(l,u);return this.counter++,h},this.hostLanguage=t,r(a)};const o=`${LT}?${wi({onload:xu,render:"explicit",hl:t})}`;md(o).catch(()=>{clearTimeout(i),s(gt(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var t;return!!(!((t=Xe().grecaptcha)===null||t===void 0)&&t.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function UT(n){return n.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(n)}class BT{async load(e){return new NT(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const l0="recaptcha",$T={theme:"light",type:"image"};let qT=class{constructor(e,t,r=Object.assign({},$T)){this.parameters=r,this.type=l0,this.destroyed=!1,this.widgetId=null,this.tokenChangeListeners=new Set,this.renderPromise=null,this.recaptcha=null,this.auth=Qe(e),this.isInvisible=this.parameters.size==="invisible",P(typeof document<"u",this.auth,"operation-not-supported-in-this-environment");const s=typeof t=="string"?document.getElementById(t):t;P(s,this.auth,"argument-error"),this.container=s,this.parameters.callback=this.makeTokenCallback(this.parameters.callback),this._recaptchaLoader=this.auth.settings.appVerificationDisabledForTesting?new BT:new FT,this.validateStartingState()}async verify(){this.assertNotDestroyed();const e=await this.render(),t=this.getAssertedRecaptcha(),r=t.getResponse(e);return r||new Promise(s=>{const i=o=>{o&&(this.tokenChangeListeners.delete(i),s(o))};this.tokenChangeListeners.add(i),this.isInvisible&&t.execute(e)})}render(){try{this.assertNotDestroyed()}catch(e){return Promise.reject(e)}return this.renderPromise?this.renderPromise:(this.renderPromise=this.makeRenderPromise().catch(e=>{throw this.renderPromise=null,e}),this.renderPromise)}_reset(){this.assertNotDestroyed(),this.widgetId!==null&&this.getAssertedRecaptcha().reset(this.widgetId)}clear(){this.assertNotDestroyed(),this.destroyed=!0,this._recaptchaLoader.clearedOneInstance(),this.isInvisible||this.container.childNodes.forEach(e=>{this.container.removeChild(e)})}validateStartingState(){P(!this.parameters.sitekey,this.auth,"argument-error"),P(this.isInvisible||!this.container.hasChildNodes(),this.auth,"argument-error"),P(typeof document<"u",this.auth,"operation-not-supported-in-this-environment")}makeTokenCallback(e){return t=>{if(this.tokenChangeListeners.forEach(r=>r(t)),typeof e=="function")e(t);else if(typeof e=="string"){const r=Xe()[e];typeof r=="function"&&r(t)}}}assertNotDestroyed(){P(!this.destroyed,this.auth,"internal-error")}async makeRenderPromise(){if(await this.init(),!this.widgetId){let e=this.container;if(!this.isInvisible){const t=document.createElement("div");e.appendChild(t),e=t}this.widgetId=this.getAssertedRecaptcha().render(e,this.parameters)}return this.widgetId}async init(){P(dd()&&!Ed(),this.auth,"internal-error"),await jT(),this.recaptcha=await this._recaptchaLoader.load(this.auth,this.auth.languageCode||void 0);const e=await hE(this.auth);P(e,this.auth,"internal-error"),this.parameters.sitekey=e}getAssertedRecaptcha(){return P(this.recaptcha,this.auth,"internal-error"),this.recaptcha}};function jT(){let n=null;return new Promise(e=>{if(document.readyState==="complete"){e();return}n=()=>e(),window.addEventListener("load",n)}).catch(e=>{throw n&&window.removeEventListener("load",n),e})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Td{constructor(e,t){this.verificationId=e,this.onConfirmation=t}confirm(e){const t=is._fromVerification(this.verificationId,e);return this.onConfirmation(t)}}async function zT(n,e,t){const r=Qe(n),s=await pl(r,e,Q(t));return new Td(s,i=>hl(r,i))}async function GT(n,e,t){const r=Q(n);await ul(!1,r,"phone");const s=await pl(r.auth,e,Q(t));return new Td(s,i=>X_(r,i))}async function KT(n,e,t){const r=Q(n),s=await pl(r.auth,e,Q(t));return new Td(s,i=>Z_(r,i))}async function pl(n,e,t){var r;const s=await t.verify();try{P(typeof s=="string",n,"argument-error"),P(t.type===l0,n,"argument-error");let i;if(typeof e=="string"?i={phoneNumber:e}:i=e,"session"in i){const o=i.session;if("phoneNumber"in i)return P(o.type==="enroll",n,"internal-error"),(await hT(n,{idToken:o.credential,phoneEnrollmentInfo:{phoneNumber:i.phoneNumber,recaptchaToken:s}})).phoneSessionInfo.sessionInfo;{P(o.type==="signin",n,"internal-error");const a=((r=i.multiFactorHint)===null||r===void 0?void 0:r.uid)||i.multiFactorUid;return P(a,n,"missing-multi-factor-info"),(await PT(n,{mfaPendingCredential:o.credential,mfaEnrollmentId:a,phoneSignInInfo:{recaptchaToken:s}})).phoneResponseInfo.sessionInfo}}else{const{sessionInfo:o}=await xE(n,{phoneNumber:i.phoneNumber,recaptchaToken:s});return o}}finally{t._reset()}}async function HT(n,e){await gd(Q(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bs(n,e){return e?jt(e):(P(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ib(n,e,t){return ob(n,e,t)}async function ob(n,e,t){const r=Qe(n);Ei(n,e,jn),await r._initializationPromise;const s=bs(r,t);return await Ad(s,r),s._openRedirect(r,e,"signInViaRedirect")}function ab(n,e,t){return cb(n,e,t)}async function cb(n,e,t){const r=Q(n);Ei(r.auth,e,jn),await r.auth._initializationPromise;const s=bs(r.auth,t);await Ad(s,r.auth);const i=await f0(r);return s._openRedirect(r.auth,e,"reauthViaRedirect",i)}function lb(n,e,t){return ub(n,e,t)}async function ub(n,e,t){const r=Q(n);Ei(r.auth,e,jn),await r.auth._initializationPromise;const s=bs(r.auth,t);await ul(!1,r,e.providerId),await Ad(s,r.auth);const i=await f0(r);return s._openRedirect(r.auth,e,"linkViaRedirect",i)}async function hb(n,e){return await Qe(n)._initializationPromise,ml(n,e,!1)}async function ml(n,e,t=!1){const r=Qe(n),s=bs(r,e),o=await new nb(r,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}async function f0(n){const e=fa(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wb=new ua(5e3,15e3),Eb="__/auth/iframe",Tb="emulator/auth/iframe",bb={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ab=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Rb(n){const e=n.config;P(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?fd(e,Tb):`https://${n.config.authDomain}/${Eb}`,r={apiKey:e.apiKey,appName:n.name,v:Sr},s=Ab.get(n.config.apiHost);s&&(r.eid=s);const i=n._getFrameworks();return i.length&&(r.fw=i.join(",")),`${t}?${wi(r).slice(1)}`}async function Sb(n){const e=await Ib(n),t=Xe().gapi;return P(t,n,"internal-error"),e.open({where:document.body,url:Rb(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:bb,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const o=gt(n,"network-request-failed"),a=Xe().setTimeout(()=>{i(o)},wb.get());function c(){Xe().clearTimeout(a),s(r)}r.ping(c).then(c,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xb={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Pb=500,Cb=600,kb="_blank",Db="http://localhost";class em{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Nb(n,e,t,r=Pb,s=Cb){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let a="";const c=Object.assign(Object.assign({},xb),{width:r.toString(),height:s.toString(),top:i,left:o}),l=Be().toLowerCase();t&&(a=O_(l)?kb:t),V_(l)&&(e=e||Db,c.scrollbars="yes");const u=Object.entries(c).reduce((d,[m,E])=>`${d}${m}=${E},`,"");if(cE(l)&&a!=="_self")return Vb(e||"",a),new em(null);const h=window.open(e||"",a,u);P(h,n,"popup-blocked");try{h.focus()}catch{}return new em(h)}function Vb(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ob="__/auth/handler",Mb="emulator/auth/handler",Lb=encodeURIComponent("fac");async function eh(n,e,t,r,s,i){P(n.config.authDomain,n,"auth-domain-config-required"),P(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:Sr,eventId:s};if(e instanceof jn){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",vw(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,h]of Object.entries(i||{}))o[u]=h}if(e instanceof Ai){const u=e.getScopes().filter(h=>h!=="");u.length>0&&(o.scopes=u.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const c=await n._getAppCheckToken(),l=c?`#${Lb}=${encodeURIComponent(c)}`:"";return`${Fb(n)}?${wi(a).slice(1)}${l}`}function Fb({config:n}){return n.emulator?fd(n,Mb):`https://${n.authDomain}/${Ob}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pu="webStorageSupport";class Ub{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=hs,this._completeRedirectFn=ml,this._overrideRedirectResult=Rd}async _openPopup(e,t,r,s){var i;nn((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const o=await eh(e,t,r,Co(),s);return Nb(e,o,fa())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await eh(e,t,r,Co(),s);return IT(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(nn(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await Sb(e),r=new p0(e);return t.register("authEvent",s=>(P(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Pu,{type:Pu},s=>{var i;const o=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[Pu];o!==void 0&&t(!!o),yt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=gb(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return U_()||pd()||Ti()}}const Bb=Ub;class $b{constructor(e){this.factorId=e}_process(e,t,r){switch(t.type){case"enroll":return this._finalizeEnroll(e,t.credential,r);case"signin":return this._finalizeSignIn(e,t.credential);default:return _n("unexpected MultiFactorSessionType")}}}class Sd extends $b{constructor(e){super("phone"),this.credential=e}static _fromCredential(e){return new Sd(e)}_finalizeEnroll(e,t,r){return dT(e,{idToken:t,displayName:r,phoneVerificationInfo:this.credential._makeVerificationRequest()})}_finalizeSignIn(e,t){return CT(e,{mfaPendingCredential:t,phoneVerificationInfo:this.credential._makeVerificationRequest()})}}class _0{constructor(){}static assertion(e){return Sd._fromCredential(e)}}_0.FACTOR_ID="phone";var tm="@firebase/auth",nm="1.1.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qt={LOCAL:"local",NONE:"none",SESSION:"session"},ji=P,w0="persistence";function E4(n,e){if(ji(Object.values(qt).includes(e),n,"invalid-persistence-type"),od()){ji(e!==qt.SESSION,n,"unsupported-persistence-type");return}if(id()){ji(e===qt.NONE,n,"unsupported-persistence-type");return}if(xd()){ji(e===qt.NONE||e===qt.LOCAL&&So(),n,"unsupported-persistence-type");return}ji(e===qt.NONE||v0(),n,"unsupported-persistence-type")}async function rh(n){await n._initializationPromise;const e=E0(),t=ss(w0,n.config.apiKey,n.name);e&&e.setItem(t,n._getPersistence())}function T4(n,e){const t=E0();if(!t)return[];const r=ss(w0,n,e);switch(t.getItem(r)){case qt.NONE:return[ni];case qt.LOCAL:return[Vo,hs];case qt.SESSION:return[hs];default:return[]}}function E0(){var n;try{return((n=w4())===null||n===void 0?void 0:n.sessionStorage)||null}catch{return null}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function R4(n){return b0(n)}function S4(n,e){var t;const r=(t=e.customData)===null||t===void 0?void 0:t._tokenResponse;if((e==null?void 0:e.code)==="auth/multi-factor-auth-required"){const s=e;s.resolver=new x4(n,uT(n,e))}else if(r){const s=b0(e),i=e;s&&(i.credential=s,i.tenantId=r.tenantId||void 0,i.email=r.email||void 0,i.phoneNumber=r.phoneNumber||void 0)}}function b0(n){const{_tokenResponse:e}=n instanceof xt?n.customData:n;if(!e)return null;if(!(n instanceof xt)&&"temporaryProof"in e&&"phoneNumber"in e)return ds.credentialFromResult(n);const t=e.providerId;if(!t||t===qi.PASSWORD)return null;let r;switch(t){case qi.GOOGLE:r=dn;break;case qi.FACEBOOK:r=hn;break;case qi.GITHUB:r=fn;break;case qi.TWITTER:r=pn;break;default:const{oauthIdToken:s,oauthAccessToken:i,oauthTokenSecret:o,pendingToken:a,nonce:c}=e;return!i&&!o&&!s&&!a?null:a?t.startsWith("saml.")?ri._create(t,a):An._fromParams({providerId:t,signInMethod:t,pendingToken:a,idToken:s,accessToken:i}):new Ks(t).credential({idToken:s,accessToken:i,rawNonce:c})}return n instanceof xt?r.credentialFromError(n):r.credentialFromResult(n)}function Dt(n,e){return e.catch(t=>{throw t instanceof xt&&S4(n,t),t}).then(t=>{const r=t.operationType,s=t.user;return{operationType:r,credential:R4(t),additionalUserInfo:lT(t),user:gl.getOrCreate(s)}})}async function sh(n,e){const t=await e;return{verificationId:t.verificationId,confirm:r=>Dt(n,t.confirm(r))}}class x4{constructor(e,t){this.resolver=t,this.auth=A4(e)}get session(){return this.resolver.session}get hints(){return this.resolver.hints}resolveSignIn(e){return Dt(T0(this.auth),this.resolver.resolveSignIn(e))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zi=P;class ih{constructor(e,t){if(this.app=e,t.isInitialized()){this._delegate=t.getImmediate(),this.linkUnderlyingAuth();return}const{apiKey:r}=e.options;zi(r,"invalid-api-key",{appName:e.name}),zi(r,"invalid-api-key",{appName:e.name});const s=typeof window<"u"?ir:void 0;this._delegate=t.initialize({options:{persistence:P4(r,e.name),popupRedirectResolver:s}}),this._delegate._updateErrorMap(q2),this.linkUnderlyingAuth()}get emulatorConfig(){return this._delegate.emulatorConfig}get currentUser(){return this._delegate.currentUser?gl.getOrCreate(this._delegate.currentUser):null}get languageCode(){return this._delegate.languageCode}set languageCode(e){this._delegate.languageCode=e}get settings(){return this._delegate.settings}get tenantId(){return this._delegate.tenantId}set tenantId(e){this._delegate.tenantId=e}useDeviceLanguage(){this._delegate.useDeviceLanguage()}signOut(){return this._delegate.signOut()}useEmulator(e,t){vE(this._delegate,e,t)}applyActionCode(e){return jE(this._delegate,e)}checkActionCode(e){return e0(this._delegate,e)}confirmPasswordReset(e,t){return qE(this._delegate,e,t)}async createUserWithEmailAndPassword(e,t){return Dt(this._delegate,GE(this._delegate,e,t))}fetchProvidersForEmail(e){return this.fetchSignInMethodsForEmail(e)}fetchSignInMethodsForEmail(e){return JE(this._delegate,e)}isSignInWithEmailLink(e){return WE(this._delegate,e)}async getRedirectResult(){zi(Cu(),this._delegate,"operation-not-supported-in-this-environment");const e=await hb(this._delegate,ir);return e?Dt(this._delegate,Promise.resolve(e)):{credential:null,user:null}}addFrameworkForLogging(e){h4(this._delegate,e)}onAuthStateChanged(e,t,r){const{next:s,error:i,complete:o}=im(e,t,r);return this._delegate.onAuthStateChanged(s,i,o)}onIdTokenChanged(e,t,r){const{next:s,error:i,complete:o}=im(e,t,r);return this._delegate.onIdTokenChanged(s,i,o)}sendSignInLinkToEmail(e,t){return HE(this._delegate,e,t)}sendPasswordResetEmail(e,t){return $E(this._delegate,e,t||void 0)}async setPersistence(e){E4(this._delegate,e);let t;switch(e){case qt.SESSION:t=hs;break;case qt.LOCAL:t=await jt(Vo)._isAvailable()?Vo:wd;break;case qt.NONE:t=ni;break;default:return yt("argument-error",{appName:this._delegate.name})}return this._delegate.setPersistence(t)}signInAndRetrieveDataWithCredential(e){return this.signInWithCredential(e)}signInAnonymously(){return Dt(this._delegate,LE(this._delegate))}signInWithCredential(e){return Dt(this._delegate,hl(this._delegate,e))}signInWithCustomToken(e){return Dt(this._delegate,BE(this._delegate,e))}signInWithEmailAndPassword(e,t){return Dt(this._delegate,KE(this._delegate,e,t))}signInWithEmailLink(e,t){return Dt(this._delegate,QE(this._delegate,e,t))}signInWithPhoneNumber(e,t){return sh(this._delegate,zT(this._delegate,e,t))}async signInWithPopup(e){return zi(Cu(),this._delegate,"operation-not-supported-in-this-environment"),Dt(this._delegate,XT(this._delegate,e,ir))}async signInWithRedirect(e){return zi(Cu(),this._delegate,"operation-not-supported-in-this-environment"),await rh(this._delegate),ib(this._delegate,e,ir)}updateCurrentUser(e){return this._delegate.updateCurrentUser(e)}verifyPasswordResetCode(e){return zE(this._delegate,e)}unwrap(){return this._delegate}_delete(){return this._delegate._delete()}linkUnderlyingAuth(){this._delegate.wrapped=()=>this}}ih.Persistence=qt;function im(n,e,t){let r=n;typeof n!="function"&&({next:r,error:e,complete:t}=n);const s=r;return{next:o=>s(o&&gl.getOrCreate(o)),error:e,complete:t}}function P4(n,e){const t=T4(n,e);if(typeof self<"u"&&!t.includes(Vo)&&t.push(Vo),typeof window<"u")for(const r of[wd,hs])t.includes(r)||t.push(r);return t.includes(ni)||t.push(ni),t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pd{constructor(){this.providerId="phone",this._delegate=new ds(T0(xr.auth()))}static credential(e,t){return ds.credential(e,t)}verifyPhoneNumber(e,t){return this._delegate.verifyPhoneNumber(e,t)}unwrap(){return this._delegate}}Pd.PHONE_SIGN_IN_METHOD=ds.PHONE_SIGN_IN_METHOD;Pd.PROVIDER_ID=ds.PROVIDER_ID;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C4=P;class k4{constructor(e,t,r=xr.app()){var s;C4((s=r.options)===null||s===void 0?void 0:s.apiKey,"invalid-api-key",{appName:r.name}),this._delegate=new qT(r.auth(),e,t),this.type=this._delegate.type}clear(){this._delegate.clear()}render(){return this._delegate.render()}verify(){return this._delegate.verify()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gr=new ol("@firebase/firestore");function yh(){return gr.logLevel}function $A(n){gr.setLogLevel(n)}function S(n,...e){if(gr.logLevel<=fe.DEBUG){const t=e.map(Xd);gr.debug(`Firestore (${xi}): ${n}`,...t)}}function Ge(n,...e){if(gr.logLevel<=fe.ERROR){const t=e.map(Xd);gr.error(`Firestore (${xi}): ${n}`,...t)}}function sn(n,...e){if(gr.logLevel<=fe.WARN){const t=e.map(Xd);gr.warn(`Firestore (${xi}): ${n}`,...t)}}function Xd(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function U(n="Unexpected state"){const e=`FIRESTORE (${xi}) INTERNAL ASSERTION FAILED: `+n;throw Ge(e),new Error(e)}function z(n,e){n||U()}function qA(n,e){n||U()}function O(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const y={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class T extends xt{constructor(e,t){super(e,t),this.code=e,this.message=t,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S1{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class jA{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(st.UNAUTHENTICATED))}shutdown(){}}class zA{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class GA{constructor(e){this.t=e,this.currentUser=st.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){let r=this.i;const s=c=>this.i!==r?(r=this.i,t(c)):Promise.resolve();let i=new at;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new at,e.enqueueRetryable(()=>s(this.currentUser))};const o=()=>{const c=i;e.enqueueRetryable(async()=>{await c.promise,await s(this.currentUser)})},a=c=>{S("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.auth.addAuthTokenListener(this.o),o()};this.t.onInit(c=>a(c)),setTimeout(()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?a(c):(S("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new at)}},0),o()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(S("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(z(typeof r.accessToken=="string"),new S1(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return z(e===null||typeof e=="string"),new st(e)}}class KA{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=st.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class HA{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new KA(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(st.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class WA{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class QA{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){const r=i=>{i.error!=null&&S("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const o=i.token!==this.R;return this.R=i.token,S("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{S("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.appCheck.addTokenListener(this.o)};this.A.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.A.getImmediate({optional:!0});i?s(i):S("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(z(typeof t.token=="string"),this.R=t.token,new WA(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class x1{static V(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=Math.floor(256/e.length)*e.length;let r="";for(;r.length<20;){const s=YA(40);for(let i=0;i<s.length;++i)r.length<20&&s[i]<t&&(r+=e.charAt(s[i]%e.length))}return r}}function ee(n,e){return n<e?-1:n>e?1:0}function ii(n,e,t){return n.length===e.length&&n.every((r,s)=>t(r,e[s]))}function P1(n){return n+"\0"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dr(n){if(n.code!==y.FAILED_PRECONDITION||n.message!==N1)throw n;S("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dl{constructor(e,t){this.action=e,this.transaction=t,this.aborted=!1,this.m=new at,this.transaction.oncomplete=()=>{this.m.resolve()},this.transaction.onabort=()=>{t.error?this.m.reject(new go(e,t.error)):this.m.resolve()},this.transaction.onerror=r=>{const s=ef(r.target.error);this.m.reject(new go(e,s))}}static open(e,t,r,s){try{return new Dl(t,e.transaction(s,r))}catch(i){throw new go(t,i)}}get g(){return this.m.promise}abort(e){e&&this.m.reject(e),this.aborted||(S("SimpleDb","Aborting transaction:",e?e.message:"Client-initiated abort"),this.aborted=!0,this.transaction.abort())}p(){const e=this.transaction;this.aborted||typeof e.commit!="function"||e.commit()}store(e){const t=this.transaction.objectStore(e);return new e6(t)}}class Xt{constructor(e,t,r){this.name=e,this.version=t,this.S=r,Xt.D(Be())===12.2&&Ge("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.")}static delete(e){return S("SimpleDb","Removing database:",e),jr(window.indexedDB.deleteDatabase(e)).toPromise()}static v(){if(!So())return!1;if(Xt.C())return!0;const e=Be(),t=Xt.D(e),r=0<t&&t<10,s=Xt.F(e),i=0<s&&s<4.5;return!(e.indexOf("MSIE ")>0||e.indexOf("Trident/")>0||e.indexOf("Edge/")>0||r||i)}static C(){var e;return typeof process<"u"&&((e=process.env)===null||e===void 0?void 0:e.M)==="YES"}static O(e,t){return e.store(t)}static D(e){const t=e.match(/i(?:phone|pad|pod) os ([\d_]+)/i),r=t?t[1].split("_").slice(0,2).join("."):"-1";return Number(r)}static F(e){const t=e.match(/Android ([\d.]+)/i),r=t?t[1].split(".").slice(0,2).join("."):"-1";return Number(r)}async N(e){return this.db||(S("SimpleDb","Opening database:",this.name),this.db=await new Promise((t,r)=>{const s=indexedDB.open(this.name,this.version);s.onsuccess=i=>{const o=i.target.result;t(o)},s.onblocked=()=>{r(new go(e,"Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."))},s.onerror=i=>{const o=i.target.error;o.name==="VersionError"?r(new T(y.FAILED_PRECONDITION,"A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")):o.name==="InvalidStateError"?r(new T(y.FAILED_PRECONDITION,"Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: "+o)):r(new go(e,o))},s.onupgradeneeded=i=>{S("SimpleDb",'Database "'+this.name+'" requires upgrade from version:',i.oldVersion);const o=i.target.result;this.S.B(o,s.transaction,i.oldVersion,this.version).next(()=>{S("SimpleDb","Database upgrade to version "+this.version+" complete")})}})),this.L&&(this.db.onversionchange=t=>this.L(t)),this.db}k(e){this.L=e,this.db&&(this.db.onversionchange=t=>e(t))}async runTransaction(e,t,r,s){const i=t==="readonly";let o=0;for(;;){++o;try{this.db=await this.N(e);const a=Dl.open(this.db,e,i?"readonly":"readwrite",r),c=s(a).next(l=>(a.p(),l)).catch(l=>(a.abort(l),_.reject(l))).toPromise();return c.catch(()=>{}),await a.g,c}catch(a){const c=a,l=c.name!=="FirebaseError"&&o<3;if(S("SimpleDb","Transaction failed with error:",c.message,"Retrying:",l),this.close(),!l)return Promise.reject(c)}}}close(){this.db&&this.db.close(),this.db=void 0}}class ZA{constructor(e){this.q=e,this.K=!1,this.$=null}get isDone(){return this.K}get U(){return this.$}set cursor(e){this.q=e}done(){this.K=!0}W(e){this.$=e}delete(){return jr(this.q.delete())}}class go extends T{constructor(e,t){super(y.UNAVAILABLE,`IndexedDB transaction '${e}' failed: ${t}`),this.name="IndexedDbTransactionError"}}function Nr(n){return n.name==="IndexedDbTransactionError"}class e6{constructor(e){this.store=e}put(e,t){let r;return t!==void 0?(S("SimpleDb","PUT",this.store.name,e,t),r=this.store.put(t,e)):(S("SimpleDb","PUT",this.store.name,"<auto-key>",e),r=this.store.put(e)),jr(r)}add(e){return S("SimpleDb","ADD",this.store.name,e,e),jr(this.store.add(e))}get(e){return jr(this.store.get(e)).next(t=>(t===void 0&&(t=null),S("SimpleDb","GET",this.store.name,e,t),t))}delete(e){return S("SimpleDb","DELETE",this.store.name,e),jr(this.store.delete(e))}count(){return S("SimpleDb","COUNT",this.store.name),jr(this.store.count())}G(e,t){const r=this.options(e,t);if(r.index||typeof this.store.getAll!="function"){const s=this.cursor(r),i=[];return this.j(s,(o,a)=>{i.push(a)}).next(()=>i)}{const s=this.store.getAll(r.range);return new _((i,o)=>{s.onerror=a=>{o(a.target.error)},s.onsuccess=a=>{i(a.target.result)}})}}H(e,t){const r=this.store.getAll(e,t===null?void 0:t);return new _((s,i)=>{r.onerror=o=>{i(o.target.error)},r.onsuccess=o=>{s(o.target.result)}})}J(e,t){S("SimpleDb","DELETE ALL",this.store.name);const r=this.options(e,t);r.Y=!1;const s=this.cursor(r);return this.j(s,(i,o,a)=>a.delete())}Z(e,t){let r;t?r=e:(r={},t=e);const s=this.cursor(r);return this.j(s,t)}X(e){const t=this.cursor({});return new _((r,s)=>{t.onerror=i=>{const o=ef(i.target.error);s(o)},t.onsuccess=i=>{const o=i.target.result;o?e(o.primaryKey,o.value).next(a=>{a?o.continue():r()}):r()}})}j(e,t){const r=[];return new _((s,i)=>{e.onerror=o=>{i(o.target.error)},e.onsuccess=o=>{const a=o.target.result;if(!a)return void s();const c=new ZA(a),l=t(a.primaryKey,a.value,c);if(l instanceof _){const u=l.catch(h=>(c.done(),_.reject(h)));r.push(u)}c.isDone?s():c.U===null?a.continue():a.continue(c.U)}}).next(()=>_.waitFor(r))}options(e,t){let r;return e!==void 0&&(typeof e=="string"?r=e:t=e),{index:r,range:t}}cursor(e){let t="next";if(e.reverse&&(t="prev"),e.index){const r=this.store.index(e.index);return e.Y?r.openKeyCursor(e.range,t):r.openCursor(e.range,t)}return this.store.openCursor(e.range,t)}}function jr(n){return new _((e,t)=>{n.onsuccess=r=>{const s=r.target.result;e(s)},n.onerror=r=>{const s=ef(r.target.error);t(s)}})}let wm=!1;function ef(n){const e=Xt.D(Be());if(e>=12.2&&e<13){const t="An internal error was encountered in the Indexed Database server";if(n.message.indexOf(t)>=0){const r=new T("internal",`IOS_INDEXEDDB_BUG1: IndexedDb has thrown '${t}'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.`);return wm||(wm=!0,setTimeout(()=>{throw r},0)),r}}return n}class t6{constructor(e,t){this.asyncQueue=e,this.ee=t,this.task=null}start(){this.te(15e3)}stop(){this.task&&(this.task.cancel(),this.task=null)}get started(){return this.task!==null}te(e){S("IndexBackiller",`Scheduled in ${e}ms`),this.task=this.asyncQueue.enqueueAfterDelay("index_backfill",e,async()=>{this.task=null;try{S("IndexBackiller",`Documents written: ${await this.ee.ne()}`)}catch(t){Nr(t)?S("IndexBackiller","Ignoring IndexedDB error during index backfill: ",t):await Dr(t)}await this.te(6e4)})}}class n6{constructor(e,t){this.localStore=e,this.persistence=t}async ne(e=50){return this.persistence.runTransaction("Backfill Indexes","readwrite-primary",t=>this.re(t,e))}re(e,t){const r=new Set;let s=t,i=!0;return _.doWhile(()=>i===!0&&s>0,()=>this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next(o=>{if(o!==null&&!r.has(o))return S("IndexBackiller",`Processing collection: ${o}`),this.ie(e,o,s).next(a=>{s-=a,r.add(o)});i=!1})).next(()=>t-s)}ie(e,t,r){return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e,t).next(s=>this.localStore.localDocuments.getNextDocuments(e,t,s,r).next(i=>{const o=i.changes;return this.localStore.indexManager.updateIndexEntries(e,o).next(()=>this.se(s,i)).next(a=>(S("IndexBackiller",`Updating offset: ${a}`),this.localStore.indexManager.updateCollectionGroup(e,t,a))).next(()=>o.size)}))}se(e,t){let r=e;return t.changes.forEach((s,i)=>{const o=D1(i);Zd(o,r)>0&&(r=o)}),new Gt(r.readTime,r.documentKey,Math.max(t.batchId,e.largestBatchId))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pt(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=Em(e)),e=r6(n.get(t),e);return Em(e)}function r6(n,e){let t=e;const r=n.length;for(let s=0;s<r;s++){const i=n.charAt(s);switch(i){case"\0":t+="";break;case"":t+="";break;default:t+=i}}return t}function Em(n){return n+""}function In(n){const e=n.length;if(z(e>=2),e===2)return z(n.charAt(0)===""&&n.charAt(1)===""),pe.emptyPath();const t=e-2,r=[];let s="";for(let i=0;i<e;){const o=n.indexOf("",i);switch((o<0||o>t)&&U(),n.charAt(o+1)){case"":const a=n.substring(i,o);let c;s.length===0?c=a:(s+=a,c=s,s=""),r.push(c);break;case"":s+=n.substring(i,o),s+="\0";break;case"":s+=n.substring(i,o+1);break;default:U()}i=o+2}return new pe(r)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke{constructor(e,t,r,s,i,o,a){this.key=e,this.documentType=t,this.version=r,this.readTime=s,this.createTime=i,this.data=o,this.documentState=a}static newInvalidDocument(e){return new ke(e,0,j.min(),j.min(),j.min(),pt.empty(),0)}static newFoundDocument(e,t,r,s){return new ke(e,1,t,j.min(),r,s,0)}static newNoDocument(e,t){return new ke(e,2,t,j.min(),j.min(),pt.empty(),0)}static newUnknownDocument(e,t){return new ke(e,3,t,j.min(),j.min(),pt.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(j.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=pt.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=pt.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=j.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof ke&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new ke(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O6=new xe(N.comparator);function Mt(){return O6}const ty=new xe(N.comparator);function oo(...n){let e=ty;for(const t of n)e=e.insert(t.key,t);return e}function ny(n){let e=ty;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function wn(){return yo()}function ry(){return yo()}function yo(){return new Vr(n=>n.toString(),(n,e)=>n.isEqual(e))}const M6=new xe(N.comparator),L6=new Ne(N.comparator);function te(...n){let e=L6;for(const t of n)e=e.add(t);return e}const F6=new Ne(ee);function of(){return F6}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pa{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,Ca.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Pa(j.min(),s,new xe(ee),Mt(),te())}}class Ca{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Ca(r,t,te(),te(),te())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T3{constructor(e){this.serializer=e}setIndexManager(e){this.indexManager=e}addEntry(e,t,r){return Fr(e).put(r)}removeEntry(e,t,r){return Fr(e).delete(function(i,o){const a=i.path.toArray();return[a.slice(0,a.length-2),a[a.length-2],qc(o),a[a.length-1]]}(t,r))}updateMetadata(e,t){return this.getMetadata(e).next(r=>(r.byteSize+=t,this.Xn(e,r)))}getEntry(e,t){let r=ke.newInvalidDocument(t);return Fr(e).Z({index:"documentKeyIndex",range:IDBKeyRange.only(Ji(t))},(s,i)=>{r=this.er(t,i)}).next(()=>r)}tr(e,t){let r={size:0,document:ke.newInvalidDocument(t)};return Fr(e).Z({index:"documentKeyIndex",range:IDBKeyRange.only(Ji(t))},(s,i)=>{r={document:this.er(t,i),size:zc(i)}}).next(()=>r)}getEntries(e,t){let r=Mt();return this.nr(e,t,(s,i)=>{const o=this.er(s,i);r=r.insert(s,o)}).next(()=>r)}rr(e,t){let r=Mt(),s=new xe(N.comparator);return this.nr(e,t,(i,o)=>{const a=this.er(i,o);r=r.insert(i,a),s=s.insert(i,zc(o))}).next(()=>({documents:r,ir:s}))}nr(e,t,r){if(t.isEmpty())return _.resolve();let s=new Ne(ag);t.forEach(c=>s=s.add(c));const i=IDBKeyRange.bound(Ji(s.first()),Ji(s.last())),o=s.getIterator();let a=o.getNext();return Fr(e).Z({index:"documentKeyIndex",range:i},(c,l,u)=>{const h=N.fromSegments([...l.prefixPath,l.collectionGroup,l.documentId]);for(;a&&ag(a,h)<0;)r(a,null),a=o.getNext();a&&a.isEqual(h)&&(r(a,l),a=o.hasNext()?o.getNext():null),a?u.W(Ji(a)):u.done()}).next(()=>{for(;a;)r(a,null),a=o.hasNext()?o.getNext():null})}getDocumentsMatchingQuery(e,t,r,s){const i=t.path,o=[i.popLast().toArray(),i.lastSegment(),qc(r.readTime),r.documentKey.path.isEmpty()?"":r.documentKey.path.lastSegment()],a=[i.popLast().toArray(),i.lastSegment(),[Number.MAX_SAFE_INTEGER,Number.MAX_SAFE_INTEGER],""];return Fr(e).G(IDBKeyRange.bound(o,a,!0)).next(c=>{let l=Mt();for(const u of c){const h=this.er(N.fromSegments(u.prefixPath.concat(u.collectionGroup,u.documentId)),u);h.isFoundDocument()&&(Sa(t,h)||s.has(h.key))&&(l=l.insert(h.key,h))}return l})}getAllFromCollectionGroup(e,t,r,s){let i=Mt();const o=og(t,r),a=og(t,Gt.max());return Fr(e).Z({index:"collectionGroupIndex",range:IDBKeyRange.bound(o,a,!0)},(c,l,u)=>{const h=this.er(N.fromSegments(l.prefixPath.concat(l.collectionGroup,l.documentId)),l);i=i.insert(h.key,h),i.size===s&&u.done()}).next(()=>i)}newChangeBuffer(e){return new b3(this,!!e&&e.trackRemovals)}getSize(e){return this.getMetadata(e).next(t=>t.byteSize)}getMetadata(e){return ig(e).get("remoteDocumentGlobalKey").next(t=>(z(!!t),t))}Xn(e,t){return ig(e).put("remoteDocumentGlobalKey",t)}er(e,t){if(t){const r=a3(this.serializer,t);if(!(r.isNoDocument()&&r.version.isEqual(j.min())))return r}return ke.newInvalidDocument(e)}}function Ly(n){return new T3(n)}class b3 extends My{constructor(e,t){super(),this.sr=e,this.trackRemovals=t,this._r=new Vr(r=>r.toString(),(r,s)=>r.isEqual(s))}applyChanges(e){const t=[];let r=0,s=new Ne((i,o)=>ee(i.canonicalString(),o.canonicalString()));return this.changes.forEach((i,o)=>{const a=this._r.get(i);if(t.push(this.sr.removeEntry(e,i,a.readTime)),o.isValidDocument()){const c=Km(this.sr.serializer,o);s=s.add(i.path.popLast());const l=zc(c);r+=l-a.size,t.push(this.sr.addEntry(e,i,c))}else if(r-=a.size,this.trackRemovals){const c=Km(this.sr.serializer,o.convertToNoDocument(j.min()));t.push(this.sr.addEntry(e,i,c))}}),s.forEach(i=>{t.push(this.sr.indexManager.addToCollectionParentIndex(e,i))}),t.push(this.sr.updateMetadata(e,r)),_.waitFor(t)}getFromCache(e,t){return this.sr.tr(e,t).next(r=>(this._r.set(t,{size:r.size,readTime:r.document.readTime}),r.document))}getAllFromCache(e,t){return this.sr.rr(e,t).next(({documents:r,ir:s})=>(s.forEach((i,o)=>{this._r.set(i,{size:o,readTime:r.get(i).readTime})}),r))}}function ig(n){return ut(n,"remoteDocumentGlobal")}function Fr(n){return ut(n,"remoteDocumentsV14")}function Ji(n){const e=n.path.toArray();return[e.slice(0,e.length-2),e[e.length-2],e[e.length-1]]}function og(n,e){const t=e.documentKey.path.toArray();return[n,qc(e.readTime),t.slice(0,t.length-2),t.length>0?t[t.length-1]:""]}function ag(n,e){const t=n.path.toArray(),r=e.path.toArray();let s=0;for(let i=0;i<t.length-2&&i<r.length-2;++i)if(s=ee(t[i],r[i]),s)return s;return s=ee(t.length,r.length),s||(s=ee(t[t.length-2],r[r.length-2]),s||ee(t[t.length-1],r[r.length-1]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _f{constructor(){this.lr=new Ne(rt.hr),this.Pr=new Ne(rt.Ir)}isEmpty(){return this.lr.isEmpty()}addReference(e,t){const r=new rt(e,t);this.lr=this.lr.add(r),this.Pr=this.Pr.add(r)}Tr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Er(new rt(e,t))}dr(e,t){e.forEach(r=>this.removeReference(r,t))}Ar(e){const t=new N(new pe([])),r=new rt(t,e),s=new rt(t,e+1),i=[];return this.Pr.forEachInRange([r,s],o=>{this.Er(o),i.push(o.key)}),i}Rr(){this.lr.forEach(e=>this.Er(e))}Er(e){this.lr=this.lr.delete(e),this.Pr=this.Pr.delete(e)}Vr(e){const t=new N(new pe([])),r=new rt(t,e),s=new rt(t,e+1);let i=te();return this.Pr.forEachInRange([r,s],o=>{i=i.add(o.key)}),i}containsKey(e){const t=new rt(e,0),r=this.lr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class rt{constructor(e,t){this.key=e,this.mr=t}static hr(e,t){return N.comparator(e.key,t.key)||ee(e.mr,t.mr)}static Ir(e,t){return ee(e.mr,t.mr)||N.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uy{constructor(e,t){this.Nr={},this.overlays={},this.Br=new Vt(0),this.Lr=!1,this.Lr=!0,this.referenceDelegate=e(this),this.kr=new k3(this),this.indexManager=new m3,this.remoteDocumentCache=function(s){return new P3(s)}(r=>this.referenceDelegate.qr(r)),this.serializer=new Py(t),this.Qr=new R3(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Lr=!1,Promise.resolve()}get started(){return this.Lr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new S3,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.Nr[e.toKey()];return r||(r=new x3(t,this.referenceDelegate),this.Nr[e.toKey()]=r),r}getTargetCache(){return this.kr}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Qr}runTransaction(e,t,r){S("MemoryPersistence","Starting transaction:",e);const s=new D3(this.Br.next());return this.referenceDelegate.Kr(),r(s).next(i=>this.referenceDelegate.$r(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Ur(e,t){return _.or(Object.values(this.Nr).map(r=>()=>r.containsKey(e,t)))}}class D3 extends V1{constructor(e){super(),this.currentSequenceNumber=e}}class Ul{constructor(e){this.persistence=e,this.Wr=new _f,this.Gr=null}static zr(e){return new Ul(e)}get jr(){if(this.Gr)return this.Gr;throw U()}addReference(e,t,r){return this.Wr.addReference(r,t),this.jr.delete(r.toString()),_.resolve()}removeReference(e,t,r){return this.Wr.removeReference(r,t),this.jr.add(r.toString()),_.resolve()}markPotentiallyOrphaned(e,t){return this.jr.add(t.toString()),_.resolve()}removeTarget(e,t){this.Wr.Ar(t.targetId).forEach(s=>this.jr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next(s=>{s.forEach(i=>this.jr.add(i.toString()))}).next(()=>r.removeTargetData(e,t))}Kr(){this.Gr=new Set}$r(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return _.forEach(this.jr,r=>{const s=N.fromPath(r);return this.Hr(e,s).next(i=>{i||t.removeEntry(s,j.min())})}).next(()=>(this.Gr=null,t.apply(e)))}updateLimboDocument(e,t){return this.Hr(e,t).next(r=>{r?this.jr.delete(t.toString()):this.jr.add(t.toString())})}qr(e){return 0}Hr(e,t){return _.or([()=>_.resolve(this.Wr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Ur(e,t)])}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class q3{constructor(e){this.so=e.so,this.oo=e.oo}_o(e){this.ao=e}uo(e){this.co=e}onMessage(e){this.lo=e}close(){this.oo()}send(e){this.so(e)}ho(){this.ao()}Po(e){this.co(e)}Io(e){this.lo(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const It="WebChannelConnection";class j3 extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.To=r+"://"+t.host,this.Eo=`projects/${s}/databases/${i}`,this.Ao=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Ro(){return!1}Vo(t,r,s,i,o){const a=ju(),c=this.mo(t,r);S("RestConnection",`Sending RPC '${t}' ${a}:`,c,s);const l={"google-cloud-resource-prefix":this.Eo,"x-goog-request-params":this.Ao};return this.fo(l,i,o),this.po(t,c,l,s).then(u=>(S("RestConnection",`Received RPC '${t}' ${a}: `,u),u),u=>{throw sn("RestConnection",`RPC '${t}' ${a} failed with error: `,u,"url: ",c,"request:",s),u})}yo(t,r,s,i,o,a){return this.Vo(t,r,s,i,o)}fo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+xi}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,o)=>t[o]=i),s&&s.headers.forEach((i,o)=>t[o]=i)}mo(t,r){const s=$3[t];return`${this.To}/v1/${r}:${s}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}po(e,t,r,s){const i=ju();return new Promise((o,a)=>{const c=new UA;c.setWithCredentials(!0),c.listenOnce(MA.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case Fu.NO_ERROR:const u=c.getResponseJson();S(It,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(u)),o(u);break;case Fu.TIMEOUT:S(It,`RPC '${e}' ${i} timed out`),a(new T(y.DEADLINE_EXCEEDED,"Request time out"));break;case Fu.HTTP_ERROR:const h=c.getStatus();if(S(It,`RPC '${e}' ${i} failed with status:`,h,"response text:",c.getResponseText()),h>0){let d=c.getResponseJson();Array.isArray(d)&&(d=d[0]);const m=d==null?void 0:d.error;if(m&&m.status&&m.message){const E=function(b){const B=b.toLowerCase().replace(/_/g,"-");return Object.values(y).indexOf(B)>=0?B:y.UNKNOWN}(m.status);a(new T(E,m.message))}else a(new T(y.UNKNOWN,"Server responded with status "+c.getStatus()))}else a(new T(y.UNAVAILABLE,"Connection failed."));break;default:U()}}finally{S(It,`RPC '${e}' ${i} completed.`)}});const l=JSON.stringify(s);S(It,`RPC '${e}' ${i} sending request:`,s),c.send(t,"POST",l,r,15)})}wo(e,t,r){const s=ju(),i=[this.To,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=VA(),a=OA(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},l=this.longPollingOptions.timeoutSeconds;l!==void 0&&(c.longPollingTimeout=Math.round(1e3*l)),this.useFetchStreams&&(c.xmlHttpFactory=new FA({})),this.fo(c.initMessageHeaders,t,r),c.encodeInitMessageHeaders=!0;const u=i.join("");S(It,`Creating RPC '${e}' stream ${s}: ${u}`,c);const h=o.createWebChannel(u,c);let d=!1,m=!1;const E=new q3({so:b=>{m?S(It,`Not sending because RPC '${e}' stream ${s} is closed:`,b):(d||(S(It,`Opening RPC '${e}' stream ${s} transport.`),h.open(),d=!0),S(It,`RPC '${e}' stream ${s} sending:`,b),h.send(b))},oo:()=>h.close()}),v=(b,B,G)=>{b.listen(B,$=>{try{G($)}catch(F){setTimeout(()=>{throw F},0)}})};return v(h,Ga.EventType.OPEN,()=>{m||S(It,`RPC '${e}' stream ${s} transport opened.`)}),v(h,Ga.EventType.CLOSE,()=>{m||(m=!0,S(It,`RPC '${e}' stream ${s} transport closed`),E.Po())}),v(h,Ga.EventType.ERROR,b=>{m||(m=!0,sn(It,`RPC '${e}' stream ${s} transport errored:`,b),E.Po(new T(y.UNAVAILABLE,"The operation could not be completed")))}),v(h,Ga.EventType.MESSAGE,b=>{var B;if(!m){const G=b.data[0];z(!!G);const $=G,F=$.error||((B=$[0])===null||B===void 0?void 0:B.error);if(F){S(It,`RPC '${e}' stream ${s} received error:`,F);const J=F.status;let re=function(ce){const Fe=Je[ce];if(Fe!==void 0)return py(Fe)}(J),Te=F.message;re===void 0&&(re=y.INTERNAL,Te="Unknown error status: "+J+" with message "+F.message),m=!0,E.Po(new T(re,Te)),h.close()}else S(It,`RPC '${e}' stream ${s} received:`,G),E.Io(G)}}),v(a,LA.STAT_EVENT,b=>{b.stat===vm.PROXY?S(It,`RPC '${e}' stream ${s} detected buffering proxy`):b.stat===vm.NOPROXY&&S(It,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{E.ho()},0),E}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ef{constructor(e,t,r=1e3,s=1.5,i=6e4){this.ii=e,this.timerId=t,this.So=r,this.bo=s,this.Do=i,this.vo=0,this.Co=null,this.Fo=Date.now(),this.reset()}reset(){this.vo=0}Mo(){this.vo=this.Do}xo(e){this.cancel();const t=Math.floor(this.vo+this.Oo()),r=Math.max(0,Date.now()-this.Fo),s=Math.max(0,t-r);s>0&&S("ExponentialBackoff",`Backing off for ${s} ms (base delay: ${this.vo} ms, delay with jitter: ${t} ms, last attempt: ${r} ms ago)`),this.Co=this.ii.enqueueAfterDelay(this.timerId,s,()=>(this.Fo=Date.now(),e())),this.vo*=this.bo,this.vo<this.So&&(this.vo=this.So),this.vo>this.Do&&(this.vo=this.Do)}No(){this.Co!==null&&(this.Co.skipDelay(),this.Co=null)}cancel(){this.Co!==null&&(this.Co.cancel(),this.Co=null)}Oo(){return(Math.random()-.5)*this.vo}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.d_?(Ge(t),this.d_=!1):S("OnlineStateTracker",t)}f_(){this.E_!==null&&(this.E_.cancel(),this.E_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KR{constructor(){this.Wa=Promise.resolve(),this.Ga=[],this.za=!1,this.ja=[],this.Ha=null,this.Ja=!1,this.Ya=!1,this.Za=[],this.Ko=new Ef(this,"async_queue_retry"),this.Xa=()=>{const t=gc();t&&S("AsyncQueue","Visibility state changed to "+t.visibilityState),this.Ko.No()};const e=gc();e&&typeof e.addEventListener=="function"&&e.addEventListener("visibilitychange",this.Xa)}get isShuttingDown(){return this.za}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.eu(),this.tu(e)}enterRestrictedMode(e){if(!this.za){this.za=!0,this.Ya=e||!1;const t=gc();t&&typeof t.removeEventListener=="function"&&t.removeEventListener("visibilitychange",this.Xa)}}enqueue(e){if(this.eu(),this.za)return new Promise(()=>{});const t=new at;return this.tu(()=>this.za&&this.Ya?Promise.resolve():(e().then(t.resolve,t.reject),t.promise)).then(()=>t.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Ga.push(e),this.nu()))}async nu(){if(this.Ga.length!==0){try{await this.Ga[0](),this.Ga.shift(),this.Ko.reset()}catch(e){if(!Nr(e))throw e;S("AsyncQueue","Operation failed with retryable error: "+e)}this.Ga.length>0&&this.Ko.xo(()=>this.nu())}}tu(e){const t=this.Wa.then(()=>(this.Ja=!0,e().catch(r=>{this.Ha=r,this.Ja=!1;const s=function(o){let a=o.message||"";return o.stack&&(a=o.stack.includes(o.message)?o.stack:o.message+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Sn(et.fromBase64String(e))}catch(t){throw new T(y.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Sn(et.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const r5=/^__.*__$/;class s5{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return this.fieldMask!==null?new Gn(e,this.data,this.fieldMask,t,this.fieldTransforms):new Ci(e,this.data,t,this.fieldTransforms)}}class Sv{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new Gn(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function xv(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw U()}}class Gl{constructor(e,t,r,s,i,o){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=s,i===void 0&&this.au(),this.fieldTransforms=i||[],this.fieldMask=o||[]}get path(){return this.settings.path}get uu(){return this.settings.uu}cu(e){return new Gl(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}lu(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),s=this.cu({path:r,hu:!1});return s.Pu(e),s}Iu(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),s=this.cu({path:r,hu:!1});return s.au(),s}Tu(e){return this.cu({path:void 0,hu:!0})}Eu(e){return Qc(e,this.settings.methodName,this.settings.du||!1,this.path,this.settings.Au)}contains(e){return this.fieldMask.find(t=>e.isPrefixOf(t))!==void 0||this.fieldTransforms.find(t=>e.isPrefixOf(t.field))!==void 0}au(){if(this.path)for(let e=0;e<this.path.length;e++)this.Pu(this.path.get(e))}Pu(e){if(e.length===0)throw this.Eu("Document fields must not be empty");if(xv(this.uu)&&r5.test(e))throw this.Eu('Document fields cannot begin and end with "__"')}}class i5{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||ka(e)}Ru(e,t,r,s=!1){return new Gl({uu:e,methodName:t,Au:r,path:Ke.emptyPath(),hu:!1,du:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function xs(n){const e=n._freezeSettings(),t=ka(n._databaseId);return new i5(n._databaseId,!!e.ignoreUndefinedProperties,t)}function Kl(n,e,t,r,s,i={}){const o=n.Ru(i.merge||i.mergeFields?2:0,e,t,s);Gf("Data must be an object, but it was:",o,r);const a=kv(r,o);let c,l;if(i.merge)c=new Ot(o.fieldMask),l=o.fieldTransforms;else if(i.mergeFields){const u=[];for(const h of i.mergeFields){const d=Bh(e,h,t);if(!o.contains(d))throw new T(y.INVALID_ARGUMENT,`Field '${d}' is specified in your field mask but missing from your input data.`);Nv(u,d)||u.push(d)}c=new Ot(u),l=o.fieldTransforms.filter(h=>c.covers(h.field))}else c=null,l=o.fieldTransforms;return new s5(new pt(a),c,l)}class Va extends Ss{_toFieldTransform(e){if(e.uu!==2)throw e.uu===1?e.Eu(`${this._methodName}() can only appear at the top level of your update data`):e.Eu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Va}}function Pv(n,e,t){return new Gl({uu:3,Au:e.settings.Au,methodName:n._methodName,hu:t},e.databaseId,e.serializer,e.ignoreUndefinedProperties)}class qf extends Ss{_toFieldTransform(e){return new xa(e.path,new ci)}isEqual(e){return e instanceof qf}}class o5 extends Ss{constructor(e,t){super(e),this.Vu=t}_toFieldTransform(e){const t=Pv(this,e,!0),r=this.Vu.map(i=>Ps(i,t)),s=new _s(r);return new xa(e.path,s)}isEqual(e){return this===e}}class a5 extends Ss{constructor(e,t){super(e),this.Vu=t}_toFieldTransform(e){const t=Pv(this,e,!0),r=this.Vu.map(i=>Ps(i,t)),s=new ys(r);return new xa(e.path,s)}isEqual(e){return this===e}}class c5 extends Ss{constructor(e,t){super(e),this.mu=t}_toFieldTransform(e){const t=new li(e.serializer,oy(e.serializer,this.mu));return new xa(e.path,t)}isEqual(e){return this===e}}function jf(n,e,t,r){const s=n.Ru(1,e,t);Gf("Data must be an object, but it was:",s,r);const i=[],o=pt.empty();Rs(r,(c,l)=>{const u=Kf(e,c,t);l=Q(l);const h=s.Iu(u);if(l instanceof Va)i.push(u);else{const d=Ps(l,h);d!=null&&(i.push(u),o.set(u,d))}});const a=new Ot(i);return new Sv(o,a,s.fieldTransforms)}function zf(n,e,t,r,s,i){const o=n.Ru(1,e,t),a=[Bh(e,r,t)],c=[s];if(i.length%2!=0)throw new T(y.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let d=0;d<i.length;d+=2)a.push(Bh(e,i[d])),c.push(i[d+1]);const l=[],u=pt.empty();for(let d=a.length-1;d>=0;--d)if(!Nv(l,a[d])){const m=a[d];let E=c[d];E=Q(E);const v=o.Iu(m);if(E instanceof Va)l.push(m);else{const b=Ps(E,v);b!=null&&(l.push(m),u.set(m,b))}}const h=new Ot(l);return new Sv(u,h,o.fieldTransforms)}function Cv(n,e,t,r=!1){return Ps(t,n.Ru(r?4:3,e))}function Ps(n,e){if(Dv(n=Q(n)))return Gf("Unsupported field value:",e,n),kv(n,e);if(n instanceof Ss)return function(r,s){if(!xv(s.uu))throw s.Eu(`${r._methodName}() can only be used with update() and set()`);if(!s.path)throw s.Eu(`${r._methodName}() is not currently supported inside arrays`);const i=r._toFieldTransform(s);i&&s.fieldTransforms.push(i)}(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.hu&&e.uu!==4)throw e.Eu("Nested arrays are not supported");return function(r,s){const i=[];let o=0;for(const a of r){let c=Ps(a,s.Tu(o));c==null&&(c={nullValue:"NULL_VALUE"}),i.push(c),o++}return{arrayValue:{values:i}}}(n,e)}return function(r,s){if((r=Q(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return oy(s.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const i=Le.fromDate(r);return{timestampValue:ui(s.serializer,i)}}if(r instanceof Le){const i=new Le(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:ui(s.serializer,i)}}if(r instanceof zl)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof Sn)return{bytesValue:yy(s.serializer,r._byteString)};if(r instanceof Ue){const i=s.databaseId,o=r.firestore._databaseId;if(!o.isEqual(i))throw s.Eu(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${i.projectId}/${i.database}`);return{referenceValue:ff(r.firestore._databaseId||s.databaseId,r._key.path)}}throw s.Eu(`Unsupported field value: ${jl(r)}`)}(n,e)}function kv(n,e){const t={};return B1(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Rs(n,(r,s)=>{const i=Ps(s,e.lu(r));i!=null&&(t[r]=i)}),{mapValue:{fields:t}}}function Dv(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof Le||n instanceof zl||n instanceof Sn||n instanceof Ue||n instanceof Ss)}function Gf(n,e,t){if(!Dv(t)||!function(s){return typeof s=="object"&&s!==null&&(Object.getPrototypeOf(s)===Object.prototype||Object.getPrototypeOf(s)===null)}(t)){const r=jl(t);throw r==="an object"?e.Eu(n+" a custom object"):e.Eu(n+" "+r)}}function Bh(n,e,t){if((e=Q(e))instanceof Tr)return e._internalPath;if(typeof e=="string")return Kf(n,e);throw Qc("Field path arguments must be of type string or ",n,!1,void 0,t)}const l5=new RegExp("[~\\*/\\[\\]]");function Kf(n,e,t){if(e.search(l5)>=0)throw Qc(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new Tr(...e.split("."))._internalPath}catch{throw Qc(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function Qc(n,e,t,r,s){const i=r&&!r.isEmpty(),o=s!==void 0;let a=`Function ${e}() called with invalid data`;t&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(i||o)&&(c+=" (found",i&&(c+=` in field ${r}`),o&&(c+=` in document ${s}`),c+=")"),new T(y.INVALID_ARGUMENT,a+n+c)}function Nv(n,e){return n.some(t=>t.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xl(n,e,t){let r;return r=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,r}class v5 extends Yf{constructor(e){super(),this.firestore=e}convertBytes(e){return new Sn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Ue(this.firestore,null,t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let k5=class extends class{constructor(t,r){this._firestore=t,this._transaction=r,this._dataReader=xs(t)}get(t){const r=sr(t,this._firestore),s=new v5(this._firestore);return this._transaction.lookup([r._key]).then(i=>{if(!i||i.length!==1)return U();const o=i[0];if(o.isFoundDocument())return new Xo(this._firestore,s,o.key,o,r.converter);if(o.isNoDocument())return new Xo(this._firestore,s,r._key,null,r.converter);throw U()})}set(t,r,s){const i=sr(t,this._firestore),o=Xl(i.converter,r,s),a=Kl(this._dataReader,"Transaction.set",i._key,o,i.converter!==null,s);return this._transaction.set(i._key,a),this}update(t,r,s,...i){const o=sr(t,this._firestore);let a;return a=typeof(r=Q(r))=="string"||r instanceof Tr?zf(this._dataReader,"Transaction.update",o._key,r,s,i):jf(this._dataReader,"Transaction.update",o._key,r),this._transaction.update(o._key,a),this}delete(t){const r=sr(t,this._firestore);return this._transaction.delete(r._key),this}}{constructor(e,t){super(e,t),this._firestore=e}get(e){const t=sr(e,this._firestore),r=new Cs(this._firestore);return super.get(e).then(s=>new Fn(this._firestore,r,t._key,s._document,new es(!1,!1),t.converter))}};function D5(n,e,t){n=ye(n,ze);const r=Object.assign(Object.assign({},P5),t);return function(i){if(i.maxAttempts<1)throw new T(y.INVALID_ARGUMENT,"Max attempts must be at least 1")}(r),function(i,o,a){const c=new at;return i.asyncQueue.enqueueAndForget(async()=>{const l=await MR(i);new VR(i.asyncQueue,l,a,o,c).run()}),c.promise}(ht(n),s=>e(new k5(n,s)),r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rg(){if(typeof Uint8Array>"u")throw new T("unimplemented","Uint8Arrays are not available in this environment.")}function Sg(){if(!w6())throw new T("unimplemented","Blobs are unavailable in Firestore in this environment.")}class Zo{constructor(e){this._delegate=e}static fromBase64String(e){return Sg(),new Zo(Sn.fromBase64String(e))}static fromUint8Array(e){return Rg(),new Zo(Sn.fromUint8Array(e))}toBase64(){return Sg(),this._delegate.toBase64()}toUint8Array(){return Rg(),this._delegate.toUint8Array()}isEqual(e){return this._delegate.isEqual(e._delegate)}toString(){return"Blob(base64: "+this.toBase64()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qh(n){return B5(n,["next","error","complete"])}function B5(n,e){if(typeof n!="object"||n===null)return!1;const t=n;for(const r of e)if(r in t&&typeof t[r]=="function")return!0;return!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $5{enableIndexedDbPersistence(e,t){return QR(e._delegate,{forceOwnership:t})}enableMultiTabIndexedDbPersistence(e){return YR(e._delegate)}clearIndexedDbPersistence(e){return JR(e._delegate)}}class Bv{constructor(e,t,r){this._delegate=t,this._persistenceProvider=r,this.INTERNAL={delete:()=>this.terminate()},e instanceof vr||(this._appCompat=e)}get _databaseId(){return this._delegate._databaseId}settings(e){const t=this._delegate._getSettings();!e.merge&&t.host!==e.host&&sn("You are overriding the original host. If you did not intend to override your settings, use {merge: true}."),e.merge&&(e=Object.assign(Object.assign({},t),e),delete e.merge),this._delegate._setSettings(e)}useEmulator(e,t,r={}){zR(this._delegate,e,t,r)}enableNetwork(){return ZR(this._delegate)}disableNetwork(){return e5(this._delegate)}enablePersistence(e){let t=!1,r=!1;return e&&(t=!!e.synchronizeTabs,r=!!e.experimentalForceOwningTab,gv("synchronizeTabs",t,"experimentalForceOwningTab",r)),t?this._persistenceProvider.enableMultiTabIndexedDbPersistence(this):this._persistenceProvider.enableIndexedDbPersistence(this,r)}clearPersistence(){return this._persistenceProvider.clearIndexedDbPersistence(this)}terminate(){return this._appCompat&&(this._appCompat._removeServiceInstance("firestore-compat"),this._appCompat._removeServiceInstance("firestore")),this._delegate._delete()}waitForPendingWrites(){return XR(this._delegate)}onSnapshotsInSync(e){return x5(this._delegate,e)}get app(){if(!this._appCompat)throw new T("failed-precondition","Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._appCompat}collection(e){try{return new _i(this,wv(this._delegate,e))}catch(t){throw Rt(t,"collection()","Firestore.collection()")}}doc(e){try{return new Ht(this,gi(this._delegate,e))}catch(t){throw Rt(t,"doc()","Firestore.doc()")}}collectionGroup(e){try{return new At(this,GR(this._delegate,e))}catch(t){throw Rt(t,"collectionGroup()","Firestore.collectionGroup()")}}runTransaction(e){return D5(this._delegate,t=>e(new $v(this,t)))}batch(){return ht(this._delegate),new qv(new C5(this._delegate,e=>Ma(this._delegate,e)))}loadBundle(e){return t5(this._delegate,e)}namedQuery(e){return n5(this._delegate,e).then(t=>t?new At(this,t):null)}}class Zl extends Yf{constructor(e){super(),this.firestore=e}convertBytes(e){return new Zo(new Sn(e))}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return Ht.forKey(t,this.firestore,null)}}function q5(n){$A(n)}class $v{constructor(e,t){this._firestore=e,this._delegate=t,this._userDataWriter=new Zl(e)}get(e){const t=ts(e);return this._delegate.get(t).then(r=>new ea(this._firestore,new Fn(this._firestore._delegate,this._userDataWriter,r._key,r._document,r.metadata,t.converter)))}set(e,t,r){const s=ts(e);return r?(Xf("Transaction.set",r),this._delegate.set(s,t,r)):this._delegate.set(s,t),this}update(e,t,r,...s){const i=ts(e);return arguments.length===2?this._delegate.update(i,t):this._delegate.update(i,t,r,...s),this}delete(e){const t=ts(e);return this._delegate.delete(t),this}}class qv{constructor(e){this._delegate=e}set(e,t,r){const s=ts(e);return r?(Xf("WriteBatch.set",r),this._delegate.set(s,t,r)):this._delegate.set(s,t),this}update(e,t,r,...s){const i=ts(e);return arguments.length===2?this._delegate.update(i,t):this._delegate.update(i,t,r,...s),this}delete(e){const t=ts(e);return this._delegate.delete(t),this}commit(){return this._delegate.commit()}}class Es{constructor(e,t,r){this._firestore=e,this._userDataWriter=t,this._delegate=r}fromFirestore(e,t){const r=new wo(this._firestore._delegate,this._userDataWriter,e._key,e._document,e.metadata,null);return this._delegate.fromFirestore(new ta(this._firestore,r),t??{})}toFirestore(e,t){return t?this._delegate.toFirestore(e,t):this._delegate.toFirestore(e)}static getInstance(e,t){const r=Es.INSTANCES;let s=r.get(e);s||(s=new WeakMap,r.set(e,s));let i=s.get(t);return i||(i=new Es(e,new Zl(e),t),s.set(t,i)),i}}Es.INSTANCES=new WeakMap;class Ht{constructor(e,t){this.firestore=e,this._delegate=t,this._userDataWriter=new Zl(e)}static forPath(e,t,r){if(e.length%2!==0)throw new T("invalid-argument",`Invalid document reference. Document references must have an even number of segments, but ${e.canonicalString()} has ${e.length}`);return new Ht(t,new Ue(t._delegate,r,new N(e)))}static forKey(e,t,r){return new Ht(t,new Ue(t._delegate,r,e))}get id(){return this._delegate.id}get parent(){return new _i(this.firestore,this._delegate.parent)}get path(){return this._delegate.path}collection(e){try{return new _i(this.firestore,wv(this._delegate,e))}catch(t){throw Rt(t,"collection()","DocumentReference.collection()")}}isEqual(e){return e=Q(e),e instanceof Ue?Ev(this._delegate,e):!1}set(e,t){t=Xf("DocumentReference.set",t);try{return t?bg(this._delegate,e,t):bg(this._delegate,e)}catch(r){throw Rt(r,"setDoc()","DocumentReference.set()")}}update(e,t,...r){try{return arguments.length===1?Ag(this._delegate,e):Ag(this._delegate,e,t,...r)}catch(s){throw Rt(s,"updateDoc()","DocumentReference.update()")}}delete(){return R5(this._delegate)}onSnapshot(...e){const t=jv(e),r=zv(e,s=>new ea(this.firestore,new Fn(this.firestore._delegate,this._userDataWriter,s._key,s._document,s.metadata,this._delegate.converter)));return Uv(this._delegate,t,r)}get(e){let t;return(e==null?void 0:e.source)==="cache"?t=w5(this._delegate):(e==null?void 0:e.source)==="server"?t=E5(this._delegate):t=$h(this._delegate),t.then(r=>new ea(this.firestore,new Fn(this.firestore._delegate,this._userDataWriter,r._key,r._document,r.metadata,this._delegate.converter)))}withConverter(e){return new Ht(this.firestore,e?this._delegate.withConverter(Es.getInstance(this.firestore,e)):this._delegate.withConverter(null))}}function Rt(n,e,t){return n.message=n.message.replace(e,t),n}function jv(n){for(const e of n)if(typeof e=="object"&&!qh(e))return e;return{}}function zv(n,e){var t,r;let s;return qh(n[0])?s=n[0]:qh(n[1])?s=n[1]:typeof n[0]=="function"?s={next:n[0],error:n[1],complete:n[2]}:s={next:n[1],error:n[2],complete:n[3]},{next:i=>{s.next&&s.next(e(i))},error:(t=s.error)===null||t===void 0?void 0:t.bind(s),complete:(r=s.complete)===null||r===void 0?void 0:r.bind(s)}}class ea{constructor(e,t){this._firestore=e,this._delegate=t}get ref(){return new Ht(this._firestore,this._delegate.ref)}get id(){return this._delegate.id}get metadata(){return this._delegate.metadata}get exists(){return this._delegate.exists()}data(e){return this._delegate.data(e)}get(e,t){return this._delegate.get(e,t)}isEqual(e){return Fv(this._delegate,e._delegate)}}class ta extends ea{data(e){const t=this._delegate.data(e);return qA(t!==void 0),t}}class At{constructor(e,t){this.firestore=e,this._delegate=t,this._userDataWriter=new Zl(e)}where(e,t,r){try{return new At(this.firestore,Zn(this._delegate,h5(e,t,r)))}catch(s){throw Rt(s,/(orderBy|where)\(\)/,"Query.$1()")}}orderBy(e,t){try{return new At(this.firestore,Zn(this._delegate,d5(e,t)))}catch(r){throw Rt(r,/(orderBy|where)\(\)/,"Query.$1()")}}limit(e){try{return new At(this.firestore,Zn(this._delegate,f5(e)))}catch(t){throw Rt(t,"limit()","Query.limit()")}}limitToLast(e){try{return new At(this.firestore,Zn(this._delegate,p5(e)))}catch(t){throw Rt(t,"limitToLast()","Query.limitToLast()")}}startAt(...e){try{return new At(this.firestore,Zn(this._delegate,m5(...e)))}catch(t){throw Rt(t,"startAt()","Query.startAt()")}}startAfter(...e){try{return new At(this.firestore,Zn(this._delegate,g5(...e)))}catch(t){throw Rt(t,"startAfter()","Query.startAfter()")}}endBefore(...e){try{return new At(this.firestore,Zn(this._delegate,_5(...e)))}catch(t){throw Rt(t,"endBefore()","Query.endBefore()")}}endAt(...e){try{return new At(this.firestore,Zn(this._delegate,y5(...e)))}catch(t){throw Rt(t,"endAt()","Query.endAt()")}}isEqual(e){return Tv(this._delegate,e._delegate)}get(e){let t;return(e==null?void 0:e.source)==="cache"?t=b5(this._delegate):(e==null?void 0:e.source)==="server"?t=A5(this._delegate):t=T5(this._delegate),t.then(r=>new jh(this.firestore,new br(this.firestore._delegate,this._userDataWriter,this._delegate,r._snapshot)))}onSnapshot(...e){const t=jv(e),r=zv(e,s=>new jh(this.firestore,new br(this.firestore._delegate,this._userDataWriter,this._delegate,s._snapshot)));return Uv(this._delegate,t,r)}withConverter(e){return new At(this.firestore,e?this._delegate.withConverter(Es.getInstance(this.firestore,e)):this._delegate.withConverter(null))}}class j5{constructor(e,t){this._firestore=e,this._delegate=t}get type(){return this._delegate.type}get doc(){return new ta(this._firestore,this._delegate.doc)}get oldIndex(){return this._delegate.oldIndex}get newIndex(){return this._delegate.newIndex}}class jh{constructor(e,t){this._firestore=e,this._delegate=t}get query(){return new At(this._firestore,this._delegate.query)}get metadata(){return this._delegate.metadata}get size(){return this._delegate.size}get empty(){return this._delegate.empty}get docs(){return this._delegate.docs.map(e=>new ta(this._firestore,e))}docChanges(e){return this._delegate.docChanges(e).map(t=>new j5(this._firestore,t))}forEach(e,t){this._delegate.forEach(r=>{e.call(t,new ta(this._firestore,r))})}isEqual(e){return Fv(this._delegate,e._delegate)}}class _i extends At{constructor(e,t){super(e,t),this.firestore=e,this._delegate=t}get id(){return this._delegate.id}get path(){return this._delegate.path}get parent(){const e=this._delegate.parent;return e?new Ht(this.firestore,e):null}doc(e){try{return e===void 0?new Ht(this.firestore,gi(this._delegate)):new Ht(this.firestore,gi(this._delegate,e))}catch(t){throw Rt(t,"doc()","CollectionReference.doc()")}}add(e){return S5(this._delegate,e).then(t=>new Ht(this.firestore,t))}isEqual(e){return Ev(this._delegate,e._delegate)}withConverter(e){return new _i(this.firestore,e?this._delegate.withConverter(Es.getInstance(this.firestore,e)):this._delegate.withConverter(null))}}function ts(n){return ye(n,Ue)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const z5={Firestore:Bv,GeoPoint:zl,Timestamp:Le,Blob:Zo,Transaction:$v,WriteBatch:qv,DocumentReference:Ht,DocumentSnapshot:ea,Query:At,QueryDocumentSnapshot:ta,QuerySnapshot:jh,CollectionReference:_i,FieldPath:Zf,FieldValue:Hr,setLogLevel:q5,CACHE_SIZE_UNLIMITED:WR};function G5(n,e){n.INTERNAL.registerComponent(new bn("firestore-compat",t=>{const r=t.getProvider("app-compat").getImmediate(),s=t.getProvider("firestore").getImmediate();return e(r,s)},"PUBLIC").setServiceProps(Object.assign({},z5)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K5(n){G5(n,(e,t)=>new Bv(e,t,new $5)),n.registerVersion(F5,U5)}K5(xr);const H5={apiKey:"AIzaSyD5breK_Vk9VV7AHQEeN8_tQv-9mHyrWIw",authDomain:"sharehouse-96ee0.firebaseapp.com",projectId:"sharehouse-96ee0",storageBucket:"sharehouse-96ee0.appspot.com",messagingSenderId:"172112341807",appId:"1:172112341807:web:1718f46cc281c56a36cfda"};xr.initializeApp(H5);const Gv=xr.auth(),zh=xr.firestore(),W5=zh.collection("users");function ep(n,e){const t=Object.create(null),r=n.split(",");for(let s=0;s<r.length;s++)t[r[s]]=!0;return e?s=>!!t[s.toLowerCase()]:s=>!!t[s]}const Pe={},Zs=[],en=()=>{},Q5=()=>!1,Y5=/^on[^a-z]/,eu=n=>Y5.test(n),tp=n=>n.startsWith("onUpdate:"),vt=Object.assign,np=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},J5=Object.prototype.hasOwnProperty,me=(n,e)=>J5.call(n,e),Y=Array.isArray,ei=n=>La(n)==="[object Map]",tu=n=>La(n)==="[object Set]",xg=n=>La(n)==="[object Date]",se=n=>typeof n=="function",tt=n=>typeof n=="string",na=n=>typeof n=="symbol",Ve=n=>n!==null&&typeof n=="object",Kv=n=>Ve(n)&&se(n.then)&&se(n.catch),Hv=Object.prototype.toString,La=n=>Hv.call(n),X5=n=>La(n).slice(8,-1),Wv=n=>La(n)==="[object Object]",rp=n=>tt(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,yc=ep(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),nu=n=>{const e=Object.create(null);return t=>e[t]||(e[t]=n(t))},Z5=/-(\w)/g,xn=nu(n=>n.replace(Z5,(e,t)=>t?t.toUpperCase():"")),e8=/\B([A-Z])/g,Mi=nu(n=>n.replace(e8,"-$1").toLowerCase()),ru=nu(n=>n.charAt(0).toUpperCase()+n.slice(1)),zu=nu(n=>n?`on${ru(n)}`:""),ra=(n,e)=>!Object.is(n,e),vc=(n,e)=>{for(let t=0;t<n.length;t++)n[t](e)},Yc=(n,e,t)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,value:t})},Jc=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let Pg;const Gh=()=>Pg||(Pg=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function sp(n){if(Y(n)){const e={};for(let t=0;t<n.length;t++){const r=n[t],s=tt(r)?s8(r):sp(r);if(s)for(const i in s)e[i]=s[i]}return e}else{if(tt(n))return n;if(Ve(n))return n}}const t8=/;(?![^(]*\))/g,n8=/:([^]+)/,r8=/\/\*[^]*?\*\//g;function s8(n){const e={};return n.replace(r8,"").split(t8).forEach(t=>{if(t){const r=t.split(n8);r.length>1&&(e[r[0].trim()]=r[1].trim())}}),e}function he(n){let e="";if(tt(n))e=n;else if(Y(n))for(let t=0;t<n.length;t++){const r=he(n[t]);r&&(e+=r+" ")}else if(Ve(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const i8="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",o8=ep(i8);function Qv(n){return!!n||n===""}function a8(n,e){if(n.length!==e.length)return!1;let t=!0;for(let r=0;t&&r<n.length;r++)t=su(n[r],e[r]);return t}function su(n,e){if(n===e)return!0;let t=xg(n),r=xg(e);if(t||r)return t&&r?n.getTime()===e.getTime():!1;if(t=na(n),r=na(e),t||r)return n===e;if(t=Y(n),r=Y(e),t||r)return t&&r?a8(n,e):!1;if(t=Ve(n),r=Ve(e),t||r){if(!t||!r)return!1;const s=Object.keys(n).length,i=Object.keys(e).length;if(s!==i)return!1;for(const o in n){const a=n.hasOwnProperty(o),c=e.hasOwnProperty(o);if(a&&!c||!a&&c||!su(n[o],e[o]))return!1}}return String(n)===String(e)}function c8(n,e){return n.findIndex(t=>su(t,e))}const _e=n=>tt(n)?n:n==null?"":Y(n)||Ve(n)&&(n.toString===Hv||!se(n.toString))?JSON.stringify(n,Yv,2):String(n),Yv=(n,e)=>e&&e.__v_isRef?Yv(n,e.value):ei(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[r,s])=>(t[`${r} =>`]=s,t),{})}:tu(e)?{[`Set(${e.size})`]:[...e.values()]}:Ve(e)&&!Y(e)&&!Wv(e)?String(e):e;let $t;class Jv{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=$t,!e&&$t&&(this.index=($t.scopes||($t.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const t=$t;try{return $t=this,e()}finally{$t=t}}}on(){$t=this}off(){$t=this.parent}stop(e){if(this._active){let t,r;for(t=0,r=this.effects.length;t<r;t++)this.effects[t].stop();for(t=0,r=this.cleanups.length;t<r;t++)this.cleanups[t]();if(this.scopes)for(t=0,r=this.scopes.length;t<r;t++)this.scopes[t].stop(!0);if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0,this._active=!1}}}function Xv(n){return new Jv(n)}function l8(n,e=$t){e&&e.active&&e.effects.push(n)}function Zv(){return $t}function u8(n){$t&&$t.cleanups.push(n)}const ip=n=>{const e=new Set(n);return e.w=0,e.n=0,e},eI=n=>(n.w&Ar)>0,tI=n=>(n.n&Ar)>0,h8=({deps:n})=>{if(n.length)for(let e=0;e<n.length;e++)n[e].w|=Ar},d8=n=>{const{deps:e}=n;if(e.length){let t=0;for(let r=0;r<e.length;r++){const s=e[r];eI(s)&&!tI(s)?s.delete(n):e[t++]=s,s.w&=~Ar,s.n&=~Ar}e.length=t}},Xc=new WeakMap;let lo=0,Ar=1;const Kh=30;let Jt;const cs=Symbol(""),Hh=Symbol("");class op{constructor(e,t=null,r){this.fn=e,this.scheduler=t,this.active=!0,this.deps=[],this.parent=void 0,l8(this,r)}run(){if(!this.active)return this.fn();let e=Jt,t=lr;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=Jt,Jt=this,lr=!0,Ar=1<<++lo,lo<=Kh?h8(this):Cg(this),this.fn()}finally{lo<=Kh&&d8(this),Ar=1<<--lo,Jt=this.parent,lr=t,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Jt===this?this.deferStop=!0:this.active&&(Cg(this),this.onStop&&this.onStop(),this.active=!1)}}function Cg(n){const{deps:e}=n;if(e.length){for(let t=0;t<e.length;t++)e[t].delete(n);e.length=0}}let lr=!0;const nI=[];function Li(){nI.push(lr),lr=!1}function Fi(){const n=nI.pop();lr=n===void 0?!0:n}function Ft(n,e,t){if(lr&&Jt){let r=Xc.get(n);r||Xc.set(n,r=new Map);let s=r.get(t);s||r.set(t,s=ip()),rI(s)}}function rI(n,e){let t=!1;lo<=Kh?tI(n)||(n.n|=Ar,t=!eI(n)):t=!n.has(Jt),t&&(n.add(Jt),Jt.deps.push(n))}function Un(n,e,t,r,s,i){const o=Xc.get(n);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(t==="length"&&Y(n)){const c=Number(r);o.forEach((l,u)=>{(u==="length"||u>=c)&&a.push(l)})}else switch(t!==void 0&&a.push(o.get(t)),e){case"add":Y(n)?rp(t)&&a.push(o.get("length")):(a.push(o.get(cs)),ei(n)&&a.push(o.get(Hh)));break;case"delete":Y(n)||(a.push(o.get(cs)),ei(n)&&a.push(o.get(Hh)));break;case"set":ei(n)&&a.push(o.get(cs));break}if(a.length===1)a[0]&&Wh(a[0]);else{const c=[];for(const l of a)l&&c.push(...l);Wh(ip(c))}}function Wh(n,e){const t=Y(n)?n:[...n];for(const r of t)r.computed&&kg(r);for(const r of t)r.computed||kg(r)}function kg(n,e){(n!==Jt||n.allowRecurse)&&(n.scheduler?n.scheduler():n.run())}function f8(n,e){var t;return(t=Xc.get(n))==null?void 0:t.get(e)}const p8=ep("__proto__,__v_isRef,__isVue"),sI=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(na)),m8=ap(),g8=ap(!1,!0),_8=ap(!0),Dg=y8();function y8(){const n={};return["includes","indexOf","lastIndexOf"].forEach(e=>{n[e]=function(...t){const r=ve(this);for(let i=0,o=this.length;i<o;i++)Ft(r,"get",i+"");const s=r[e](...t);return s===-1||s===!1?r[e](...t.map(ve)):s}}),["push","pop","shift","unshift","splice"].forEach(e=>{n[e]=function(...t){Li();const r=ve(this)[e].apply(this,t);return Fi(),r}}),n}function v8(n){const e=ve(this);return Ft(e,"has",n),e.hasOwnProperty(n)}function ap(n=!1,e=!1){return function(r,s,i){if(s==="__v_isReactive")return!n;if(s==="__v_isReadonly")return n;if(s==="__v_isShallow")return e;if(s==="__v_raw"&&i===(n?e?O8:lI:e?cI:aI).get(r))return r;const o=Y(r);if(!n){if(o&&me(Dg,s))return Reflect.get(Dg,s,i);if(s==="hasOwnProperty")return v8}const a=Reflect.get(r,s,i);return(na(s)?sI.has(s):p8(s))||(n||Ft(r,"get",s),e)?a:He(a)?o&&rp(s)?a:a.value:Ve(a)?n?uI(a):ou(a):a}}const I8=iI(),w8=iI(!0);function iI(n=!1){return function(t,r,s,i){let o=t[r];if(yi(o)&&He(o)&&!He(s))return!1;if(!n&&(!Zc(s)&&!yi(s)&&(o=ve(o),s=ve(s)),!Y(t)&&He(o)&&!He(s)))return o.value=s,!0;const a=Y(t)&&rp(r)?Number(r)<t.length:me(t,r),c=Reflect.set(t,r,s,i);return t===ve(i)&&(a?ra(s,o)&&Un(t,"set",r,s):Un(t,"add",r,s)),c}}function E8(n,e){const t=me(n,e);n[e];const r=Reflect.deleteProperty(n,e);return r&&t&&Un(n,"delete",e,void 0),r}function T8(n,e){const t=Reflect.has(n,e);return(!na(e)||!sI.has(e))&&Ft(n,"has",e),t}function b8(n){return Ft(n,"iterate",Y(n)?"length":cs),Reflect.ownKeys(n)}const oI={get:m8,set:I8,deleteProperty:E8,has:T8,ownKeys:b8},A8={get:_8,set(n,e){return!0},deleteProperty(n,e){return!0}},R8=vt({},oI,{get:g8,set:w8}),cp=n=>n,iu=n=>Reflect.getPrototypeOf(n);function Za(n,e,t=!1,r=!1){n=n.__v_raw;const s=ve(n),i=ve(e);t||(e!==i&&Ft(s,"get",e),Ft(s,"get",i));const{has:o}=iu(s),a=r?cp:t?hp:sa;if(o.call(s,e))return a(n.get(e));if(o.call(s,i))return a(n.get(i));n!==s&&n.get(e)}function ec(n,e=!1){const t=this.__v_raw,r=ve(t),s=ve(n);return e||(n!==s&&Ft(r,"has",n),Ft(r,"has",s)),n===s?t.has(n):t.has(n)||t.has(s)}function tc(n,e=!1){return n=n.__v_raw,!e&&Ft(ve(n),"iterate",cs),Reflect.get(n,"size",n)}function Ng(n){n=ve(n);const e=ve(this);return iu(e).has.call(e,n)||(e.add(n),Un(e,"add",n,n)),this}function Vg(n,e){e=ve(e);const t=ve(this),{has:r,get:s}=iu(t);let i=r.call(t,n);i||(n=ve(n),i=r.call(t,n));const o=s.call(t,n);return t.set(n,e),i?ra(e,o)&&Un(t,"set",n,e):Un(t,"add",n,e),this}function Og(n){const e=ve(this),{has:t,get:r}=iu(e);let s=t.call(e,n);s||(n=ve(n),s=t.call(e,n)),r&&r.call(e,n);const i=e.delete(n);return s&&Un(e,"delete",n,void 0),i}function Mg(){const n=ve(this),e=n.size!==0,t=n.clear();return e&&Un(n,"clear",void 0,void 0),t}function nc(n,e){return function(r,s){const i=this,o=i.__v_raw,a=ve(o),c=e?cp:n?hp:sa;return!n&&Ft(a,"iterate",cs),o.forEach((l,u)=>r.call(s,c(l),c(u),i))}}function rc(n,e,t){return function(...r){const s=this.__v_raw,i=ve(s),o=ei(i),a=n==="entries"||n===Symbol.iterator&&o,c=n==="keys"&&o,l=s[n](...r),u=t?cp:e?hp:sa;return!e&&Ft(i,"iterate",c?Hh:cs),{next(){const{value:h,done:d}=l.next();return d?{value:h,done:d}:{value:a?[u(h[0]),u(h[1])]:u(h),done:d}},[Symbol.iterator](){return this}}}}function er(n){return function(...e){return n==="delete"?!1:this}}function S8(){const n={get(i){return Za(this,i)},get size(){return tc(this)},has:ec,add:Ng,set:Vg,delete:Og,clear:Mg,forEach:nc(!1,!1)},e={get(i){return Za(this,i,!1,!0)},get size(){return tc(this)},has:ec,add:Ng,set:Vg,delete:Og,clear:Mg,forEach:nc(!1,!0)},t={get(i){return Za(this,i,!0)},get size(){return tc(this,!0)},has(i){return ec.call(this,i,!0)},add:er("add"),set:er("set"),delete:er("delete"),clear:er("clear"),forEach:nc(!0,!1)},r={get(i){return Za(this,i,!0,!0)},get size(){return tc(this,!0)},has(i){return ec.call(this,i,!0)},add:er("add"),set:er("set"),delete:er("delete"),clear:er("clear"),forEach:nc(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(i=>{n[i]=rc(i,!1,!1),t[i]=rc(i,!0,!1),e[i]=rc(i,!1,!0),r[i]=rc(i,!0,!0)}),[n,t,e,r]}const[x8,P8,C8,k8]=S8();function lp(n,e){const t=e?n?k8:C8:n?P8:x8;return(r,s,i)=>s==="__v_isReactive"?!n:s==="__v_isReadonly"?n:s==="__v_raw"?r:Reflect.get(me(t,s)&&s in r?t:r,s,i)}const D8={get:lp(!1,!1)},N8={get:lp(!1,!0)},V8={get:lp(!0,!1)},aI=new WeakMap,cI=new WeakMap,lI=new WeakMap,O8=new WeakMap;function M8(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function L8(n){return n.__v_skip||!Object.isExtensible(n)?0:M8(X5(n))}function ou(n){return yi(n)?n:up(n,!1,oI,D8,aI)}function F8(n){return up(n,!1,R8,N8,cI)}function uI(n){return up(n,!0,A8,V8,lI)}function up(n,e,t,r,s){if(!Ve(n)||n.__v_raw&&!(e&&n.__v_isReactive))return n;const i=s.get(n);if(i)return i;const o=L8(n);if(o===0)return n;const a=new Proxy(n,o===2?r:t);return s.set(n,a),a}function ur(n){return yi(n)?ur(n.__v_raw):!!(n&&n.__v_isReactive)}function yi(n){return!!(n&&n.__v_isReadonly)}function Zc(n){return!!(n&&n.__v_isShallow)}function hI(n){return ur(n)||yi(n)}function ve(n){const e=n&&n.__v_raw;return e?ve(e):n}function au(n){return Yc(n,"__v_skip",!0),n}const sa=n=>Ve(n)?ou(n):n,hp=n=>Ve(n)?uI(n):n;function dI(n){lr&&Jt&&(n=ve(n),rI(n.dep||(n.dep=ip())))}function fI(n,e){n=ve(n);const t=n.dep;t&&Wh(t)}function He(n){return!!(n&&n.__v_isRef===!0)}function pI(n){return U8(n,!1)}function U8(n,e){return He(n)?n:new B8(n,e)}class B8{constructor(e,t){this.__v_isShallow=t,this.dep=void 0,this.__v_isRef=!0,this._rawValue=t?e:ve(e),this._value=t?e:sa(e)}get value(){return dI(this),this._value}set value(e){const t=this.__v_isShallow||Zc(e)||yi(e);e=t?e:ve(e),ra(e,this._rawValue)&&(this._rawValue=e,this._value=t?e:sa(e),fI(this))}}function $8(n){return He(n)?n.value:n}const q8={get:(n,e,t)=>$8(Reflect.get(n,e,t)),set:(n,e,t,r)=>{const s=n[e];return He(s)&&!He(t)?(s.value=t,!0):Reflect.set(n,e,t,r)}};function mI(n){return ur(n)?n:new Proxy(n,q8)}function j8(n){const e=Y(n)?new Array(n.length):{};for(const t in n)e[t]=G8(n,t);return e}class z8{constructor(e,t,r){this._object=e,this._key=t,this._defaultValue=r,this.__v_isRef=!0}get value(){const e=this._object[this._key];return e===void 0?this._defaultValue:e}set value(e){this._object[this._key]=e}get dep(){return f8(ve(this._object),this._key)}}function G8(n,e,t){const r=n[e];return He(r)?r:new z8(n,e,t)}class K8{constructor(e,t,r,s){this._setter=t,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new op(e,()=>{this._dirty||(this._dirty=!0,fI(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!s,this.__v_isReadonly=r}get value(){const e=ve(this);return dI(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function H8(n,e,t=!1){let r,s;const i=se(n);return i?(r=n,s=en):(r=n.get,s=n.set),new K8(r,s,i||!s,t)}function hr(n,e,t,r){let s;try{s=r?n(...r):n()}catch(i){cu(i,e,t)}return s}function tn(n,e,t,r){if(se(n)){const i=hr(n,e,t,r);return i&&Kv(i)&&i.catch(o=>{cu(o,e,t)}),i}const s=[];for(let i=0;i<n.length;i++)s.push(tn(n[i],e,t,r));return s}function cu(n,e,t,r=!0){const s=e?e.vnode:null;if(e){let i=e.parent;const o=e.proxy,a=t;for(;i;){const l=i.ec;if(l){for(let u=0;u<l.length;u++)if(l[u](n,o,a)===!1)return}i=i.parent}const c=e.appContext.config.errorHandler;if(c){hr(c,null,10,[n,o,a]);return}}W8(n,t,s,r)}function W8(n,e,t,r=!0){console.error(n)}let ia=!1,Qh=!1;const wt=[];let gn=0;const ti=[];let Cn=null,Wr=0;const gI=Promise.resolve();let dp=null;function _I(n){const e=dp||gI;return n?e.then(this?n.bind(this):n):e}function Q8(n){let e=gn+1,t=wt.length;for(;e<t;){const r=e+t>>>1;oa(wt[r])<n?e=r+1:t=r}return e}function fp(n){(!wt.length||!wt.includes(n,ia&&n.allowRecurse?gn+1:gn))&&(n.id==null?wt.push(n):wt.splice(Q8(n.id),0,n),yI())}function yI(){!ia&&!Qh&&(Qh=!0,dp=gI.then(II))}function Y8(n){const e=wt.indexOf(n);e>gn&&wt.splice(e,1)}function J8(n){Y(n)?ti.push(...n):(!Cn||!Cn.includes(n,n.allowRecurse?Wr+1:Wr))&&ti.push(n),yI()}function Lg(n,e=ia?gn+1:0){for(;e<wt.length;e++){const t=wt[e];t&&t.pre&&(wt.splice(e,1),e--,t())}}function vI(n){if(ti.length){const e=[...new Set(ti)];if(ti.length=0,Cn){Cn.push(...e);return}for(Cn=e,Cn.sort((t,r)=>oa(t)-oa(r)),Wr=0;Wr<Cn.length;Wr++)Cn[Wr]();Cn=null,Wr=0}}const oa=n=>n.id==null?1/0:n.id,X8=(n,e)=>{const t=oa(n)-oa(e);if(t===0){if(n.pre&&!e.pre)return-1;if(e.pre&&!n.pre)return 1}return t};function II(n){Qh=!1,ia=!0,wt.sort(X8);const e=en;try{for(gn=0;gn<wt.length;gn++){const t=wt[gn];t&&t.active!==!1&&hr(t,null,14)}}finally{gn=0,wt.length=0,vI(),ia=!1,dp=null,(wt.length||ti.length)&&II()}}function Z8(n,e,...t){if(n.isUnmounted)return;const r=n.vnode.props||Pe;let s=t;const i=e.startsWith("update:"),o=i&&e.slice(7);if(o&&o in r){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:d}=r[u]||Pe;d&&(s=t.map(m=>tt(m)?m.trim():m)),h&&(s=t.map(Jc))}let a,c=r[a=zu(e)]||r[a=zu(xn(e))];!c&&i&&(c=r[a=zu(Mi(e))]),c&&tn(c,n,6,s);const l=r[a+"Once"];if(l){if(!n.emitted)n.emitted={};else if(n.emitted[a])return;n.emitted[a]=!0,tn(l,n,6,s)}}function wI(n,e,t=!1){const r=e.emitsCache,s=r.get(n);if(s!==void 0)return s;const i=n.emits;let o={},a=!1;if(!se(n)){const c=l=>{const u=wI(l,e,!0);u&&(a=!0,vt(o,u))};!t&&e.mixins.length&&e.mixins.forEach(c),n.extends&&c(n.extends),n.mixins&&n.mixins.forEach(c)}return!i&&!a?(Ve(n)&&r.set(n,null),null):(Y(i)?i.forEach(c=>o[c]=null):vt(o,i),Ve(n)&&r.set(n,o),o)}function lu(n,e){return!n||!eu(e)?!1:(e=e.slice(2).replace(/Once$/,""),me(n,e[0].toLowerCase()+e.slice(1))||me(n,Mi(e))||me(n,e))}let mt=null,EI=null;function el(n){const e=mt;return mt=n,EI=n&&n.type.__scopeId||null,e}function TI(n,e=mt,t){if(!e||n._n)return n;const r=(...s)=>{r._d&&Wg(-1);const i=el(e);let o;try{o=n(...s)}finally{el(i),r._d&&Wg(1)}return o};return r._n=!0,r._c=!0,r._d=!0,r}function Gu(n){const{type:e,vnode:t,proxy:r,withProxy:s,props:i,propsOptions:[o],slots:a,attrs:c,emit:l,render:u,renderCache:h,data:d,setupState:m,ctx:E,inheritAttrs:v}=n;let b,B;const G=el(n);try{if(t.shapeFlag&4){const F=s||r;b=un(u.call(F,F,h,i,m,d,E)),B=c}else{const F=e;b=un(F.length>1?F(i,{attrs:c,slots:a,emit:l}):F(i,null)),B=e.props?c:eS(c)}}catch(F){Ao.length=0,cu(F,n,1),b=ae(Rr)}let $=b;if(B&&v!==!1){const F=Object.keys(B),{shapeFlag:J}=$;F.length&&J&7&&(o&&F.some(tp)&&(B=tS(B,o)),$=vi($,B))}return t.dirs&&($=vi($),$.dirs=$.dirs?$.dirs.concat(t.dirs):t.dirs),t.transition&&($.transition=t.transition),b=$,el(G),b}const eS=n=>{let e;for(const t in n)(t==="class"||t==="style"||eu(t))&&((e||(e={}))[t]=n[t]);return e},tS=(n,e)=>{const t={};for(const r in n)(!tp(r)||!(r.slice(9)in e))&&(t[r]=n[r]);return t};function nS(n,e,t){const{props:r,children:s,component:i}=n,{props:o,children:a,patchFlag:c}=e,l=i.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&c>=0){if(c&1024)return!0;if(c&16)return r?Fg(r,o,l):!!o;if(c&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const d=u[h];if(o[d]!==r[d]&&!lu(l,d))return!0}}}else return(s||a)&&(!a||!a.$stable)?!0:r===o?!1:r?o?Fg(r,o,l):!0:!!o;return!1}function Fg(n,e,t){const r=Object.keys(e);if(r.length!==Object.keys(n).length)return!0;for(let s=0;s<r.length;s++){const i=r[s];if(e[i]!==n[i]&&!lu(t,i))return!0}return!1}function rS({vnode:n,parent:e},t){for(;e&&e.subTree===n;)(n=e.vnode).el=t,e=e.parent}const sS=n=>n.__isSuspense;function iS(n,e){e&&e.pendingBranch?Y(n)?e.effects.push(...n):e.effects.push(n):J8(n)}const sc={};function Ic(n,e,t){return bI(n,e,t)}function bI(n,e,{immediate:t,deep:r,flush:s,onTrack:i,onTrigger:o}=Pe){var a;const c=Zv()===((a=ot)==null?void 0:a.scope)?ot:null;let l,u=!1,h=!1;if(He(n)?(l=()=>n.value,u=Zc(n)):ur(n)?(l=()=>n,r=!0):Y(n)?(h=!0,u=n.some(F=>ur(F)||Zc(F)),l=()=>n.map(F=>{if(He(F))return F.value;if(ur(F))return ns(F);if(se(F))return hr(F,c,2)})):se(n)?e?l=()=>hr(n,c,2):l=()=>{if(!(c&&c.isUnmounted))return d&&d(),tn(n,c,3,[m])}:l=en,e&&r){const F=l;l=()=>ns(F())}let d,m=F=>{d=G.onStop=()=>{hr(F,c,4)}},E;if(la)if(m=en,e?t&&tn(e,c,3,[l(),h?[]:void 0,m]):l(),s==="sync"){const F=tx();E=F.__watcherHandles||(F.__watcherHandles=[])}else return en;let v=h?new Array(n.length).fill(sc):sc;const b=()=>{if(G.active)if(e){const F=G.run();(r||u||(h?F.some((J,re)=>ra(J,v[re])):ra(F,v)))&&(d&&d(),tn(e,c,3,[F,v===sc?void 0:h&&v[0]===sc?[]:v,m]),v=F)}else G.run()};b.allowRecurse=!!e;let B;s==="sync"?B=b:s==="post"?B=()=>kt(b,c&&c.suspense):(b.pre=!0,c&&(b.id=c.uid),B=()=>fp(b));const G=new op(l,B);e?t?b():v=G.run():s==="post"?kt(G.run.bind(G),c&&c.suspense):G.run();const $=()=>{G.stop(),c&&c.scope&&np(c.scope.effects,G)};return E&&E.push($),$}function oS(n,e,t){const r=this.proxy,s=tt(n)?n.includes(".")?AI(r,n):()=>r[n]:n.bind(r,r);let i;se(e)?i=e:(i=e.handler,t=e);const o=ot;Ii(this);const a=bI(s,i.bind(r),t);return o?Ii(o):ls(),a}function AI(n,e){const t=e.split(".");return()=>{let r=n;for(let s=0;s<t.length&&r;s++)r=r[t[s]];return r}}function ns(n,e){if(!Ve(n)||n.__v_skip||(e=e||new Set,e.has(n)))return n;if(e.add(n),He(n))ns(n.value,e);else if(Y(n))for(let t=0;t<n.length;t++)ns(n[t],e);else if(tu(n)||ei(n))n.forEach(t=>{ns(t,e)});else if(Wv(n))for(const t in n)ns(n[t],e);return n}function Oe(n,e){const t=mt;if(t===null)return n;const r=fu(t)||t.proxy,s=n.dirs||(n.dirs=[]);for(let i=0;i<e.length;i++){let[o,a,c,l=Pe]=e[i];o&&(se(o)&&(o={mounted:o,updated:o}),o.deep&&ns(a),s.push({dir:o,instance:r,value:a,oldValue:void 0,arg:c,modifiers:l}))}return n}function Ur(n,e,t,r){const s=n.dirs,i=e&&e.dirs;for(let o=0;o<s.length;o++){const a=s[o];i&&(a.oldValue=i[o].value);let c=a.dir[r];c&&(Li(),tn(c,t,8,[n.el,a,n,e]),Fi())}}const Eo=n=>!!n.type.__asyncLoader,RI=n=>n.type.__isKeepAlive;function aS(n,e){SI(n,"a",e)}function cS(n,e){SI(n,"da",e)}function SI(n,e,t=ot){const r=n.__wdc||(n.__wdc=()=>{let s=t;for(;s;){if(s.isDeactivated)return;s=s.parent}return n()});if(uu(e,r,t),t){let s=t.parent;for(;s&&s.parent;)RI(s.parent.vnode)&&lS(r,e,t,s),s=s.parent}}function lS(n,e,t,r){const s=uu(e,n,r,!0);xI(()=>{np(r[e],s)},t)}function uu(n,e,t=ot,r=!1){if(t){const s=t[n]||(t[n]=[]),i=e.__weh||(e.__weh=(...o)=>{if(t.isUnmounted)return;Li(),Ii(t);const a=tn(e,t,n,o);return ls(),Fi(),a});return r?s.unshift(i):s.push(i),i}}const Hn=n=>(e,t=ot)=>(!la||n==="sp")&&uu(n,(...r)=>e(...r),t),uS=Hn("bm"),hS=Hn("m"),dS=Hn("bu"),fS=Hn("u"),pS=Hn("bum"),xI=Hn("um"),mS=Hn("sp"),gS=Hn("rtg"),_S=Hn("rtc");function yS(n,e=ot){uu("ec",n,e)}const PI="components";function K(n,e){return IS(PI,n,!0,e)||n}const vS=Symbol.for("v-ndc");function IS(n,e,t=!0,r=!1){const s=mt||ot;if(s){const i=s.type;if(n===PI){const a=XS(i,!1);if(a&&(a===e||a===xn(e)||a===ru(xn(e))))return i}const o=Ug(s[n]||i[n],e)||Ug(s.appContext[n],e);return!o&&r?i:o}}function Ug(n,e){return n&&(n[e]||n[xn(e)]||n[ru(xn(e))])}function Bn(n,e,t,r){let s;const i=t&&t[r];if(Y(n)||tt(n)){s=new Array(n.length);for(let o=0,a=n.length;o<a;o++)s[o]=e(n[o],o,void 0,i&&i[o])}else if(typeof n=="number"){s=new Array(n);for(let o=0;o<n;o++)s[o]=e(o+1,o,void 0,i&&i[o])}else if(Ve(n))if(n[Symbol.iterator])s=Array.from(n,(o,a)=>e(o,a,void 0,i&&i[a]));else{const o=Object.keys(n);s=new Array(o.length);for(let a=0,c=o.length;a<c;a++){const l=o[a];s[a]=e(n[l],l,a,i&&i[a])}}else s=[];return t&&(t[r]=s),s}function wS(n,e,t={},r,s){if(mt.isCE||mt.parent&&Eo(mt.parent)&&mt.parent.isCE)return e!=="default"&&(t.name=e),ae("slot",t,r&&r());let i=n[e];i&&i._c&&(i._d=!1),w();const o=i&&CI(i(t)),a=ge(De,{key:t.key||o&&o.key||`_${e}`},o||(r?r():[]),o&&n._===1?64:-2);return!s&&a.scopeId&&(a.slotScopeIds=[a.scopeId+"-s"]),i&&i._c&&(i._d=!0),a}function CI(n){return n.some(e=>BI(e)?!(e.type===Rr||e.type===De&&!CI(e.children)):!0)?n:null}const Yh=n=>n?qI(n)?fu(n)||n.proxy:Yh(n.parent):null,To=vt(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>Yh(n.parent),$root:n=>Yh(n.root),$emit:n=>n.emit,$options:n=>pp(n),$forceUpdate:n=>n.f||(n.f=()=>fp(n.update)),$nextTick:n=>n.n||(n.n=_I.bind(n.proxy)),$watch:n=>oS.bind(n)}),Ku=(n,e)=>n!==Pe&&!n.__isScriptSetup&&me(n,e),ES={get({_:n},e){const{ctx:t,setupState:r,data:s,props:i,accessCache:o,type:a,appContext:c}=n;let l;if(e[0]!=="$"){const m=o[e];if(m!==void 0)switch(m){case 1:return r[e];case 2:return s[e];case 4:return t[e];case 3:return i[e]}else{if(Ku(r,e))return o[e]=1,r[e];if(s!==Pe&&me(s,e))return o[e]=2,s[e];if((l=n.propsOptions[0])&&me(l,e))return o[e]=3,i[e];if(t!==Pe&&me(t,e))return o[e]=4,t[e];Jh&&(o[e]=0)}}const u=To[e];let h,d;if(u)return e==="$attrs"&&Ft(n,"get",e),u(n);if((h=a.__cssModules)&&(h=h[e]))return h;if(t!==Pe&&me(t,e))return o[e]=4,t[e];if(d=c.config.globalProperties,me(d,e))return d[e]},set({_:n},e,t){const{data:r,setupState:s,ctx:i}=n;return Ku(s,e)?(s[e]=t,!0):r!==Pe&&me(r,e)?(r[e]=t,!0):me(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(i[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:r,appContext:s,propsOptions:i}},o){let a;return!!t[o]||n!==Pe&&me(n,o)||Ku(e,o)||(a=i[0])&&me(a,o)||me(r,o)||me(To,o)||me(s.config.globalProperties,o)},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:me(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function Bg(n){return Y(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let Jh=!0;function TS(n){const e=pp(n),t=n.proxy,r=n.ctx;Jh=!1,e.beforeCreate&&$g(e.beforeCreate,n,"bc");const{data:s,computed:i,methods:o,watch:a,provide:c,inject:l,created:u,beforeMount:h,mounted:d,beforeUpdate:m,updated:E,activated:v,deactivated:b,beforeDestroy:B,beforeUnmount:G,destroyed:$,unmounted:F,render:J,renderTracked:re,renderTriggered:Te,errorCaptured:ie,serverPrefetch:ce,expose:Fe,inheritAttrs:Ut,components:on,directives:ks,filters:Bi}=e;if(l&&bS(l,r,null),o)for(const $e in o){const Re=o[$e];se(Re)&&(r[$e]=Re.bind(t))}if(s){const $e=s.call(t,t);Ve($e)&&(n.data=ou($e))}if(Jh=!0,i)for(const $e in i){const Re=i[$e],Mr=se(Re)?Re.bind(t,t):se(Re.get)?Re.get.bind(t,t):en,Fa=!se(Re)&&se(Re.set)?Re.set.bind(t):en,Lr=zI({get:Mr,set:Fa});Object.defineProperty(r,$e,{enumerable:!0,configurable:!0,get:()=>Lr.value,set:an=>Lr.value=an})}if(a)for(const $e in a)kI(a[$e],r,t,$e);if(c){const $e=se(c)?c.call(t):c;Reflect.ownKeys($e).forEach(Re=>{CS(Re,$e[Re])})}u&&$g(u,n,"c");function be($e,Re){Y(Re)?Re.forEach(Mr=>$e(Mr.bind(t))):Re&&$e(Re.bind(t))}if(be(uS,h),be(hS,d),be(dS,m),be(fS,E),be(aS,v),be(cS,b),be(yS,ie),be(_S,re),be(gS,Te),be(pS,G),be(xI,F),be(mS,ce),Y(Fe))if(Fe.length){const $e=n.exposed||(n.exposed={});Fe.forEach(Re=>{Object.defineProperty($e,Re,{get:()=>t[Re],set:Mr=>t[Re]=Mr})})}else n.exposed||(n.exposed={});J&&n.render===en&&(n.render=J),Ut!=null&&(n.inheritAttrs=Ut),on&&(n.components=on),ks&&(n.directives=ks)}function bS(n,e,t=en){Y(n)&&(n=Xh(n));for(const r in n){const s=n[r];let i;Ve(s)?"default"in s?i=bo(s.from||r,s.default,!0):i=bo(s.from||r):i=bo(s),He(i)?Object.defineProperty(e,r,{enumerable:!0,configurable:!0,get:()=>i.value,set:o=>i.value=o}):e[r]=i}}function $g(n,e,t){tn(Y(n)?n.map(r=>r.bind(e.proxy)):n.bind(e.proxy),e,t)}function kI(n,e,t,r){const s=r.includes(".")?AI(t,r):()=>t[r];if(tt(n)){const i=e[n];se(i)&&Ic(s,i)}else if(se(n))Ic(s,n.bind(t));else if(Ve(n))if(Y(n))n.forEach(i=>kI(i,e,t,r));else{const i=se(n.handler)?n.handler.bind(t):e[n.handler];se(i)&&Ic(s,i,n)}}function pp(n){const e=n.type,{mixins:t,extends:r}=e,{mixins:s,optionsCache:i,config:{optionMergeStrategies:o}}=n.appContext,a=i.get(e);let c;return a?c=a:!s.length&&!t&&!r?c=e:(c={},s.length&&s.forEach(l=>tl(c,l,o,!0)),tl(c,e,o)),Ve(e)&&i.set(e,c),c}function tl(n,e,t,r=!1){const{mixins:s,extends:i}=e;i&&tl(n,i,t,!0),s&&s.forEach(o=>tl(n,o,t,!0));for(const o in e)if(!(r&&o==="expose")){const a=AS[o]||t&&t[o];n[o]=a?a(n[o],e[o]):e[o]}return n}const AS={data:qg,props:jg,emits:jg,methods:uo,computed:uo,beforeCreate:bt,created:bt,beforeMount:bt,mounted:bt,beforeUpdate:bt,updated:bt,beforeDestroy:bt,beforeUnmount:bt,destroyed:bt,unmounted:bt,activated:bt,deactivated:bt,errorCaptured:bt,serverPrefetch:bt,components:uo,directives:uo,watch:SS,provide:qg,inject:RS};function qg(n,e){return e?n?function(){return vt(se(n)?n.call(this,this):n,se(e)?e.call(this,this):e)}:e:n}function RS(n,e){return uo(Xh(n),Xh(e))}function Xh(n){if(Y(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function bt(n,e){return n?[...new Set([].concat(n,e))]:e}function uo(n,e){return n?vt(Object.create(null),n,e):e}function jg(n,e){return n?Y(n)&&Y(e)?[...new Set([...n,...e])]:vt(Object.create(null),Bg(n),Bg(e??{})):e}function SS(n,e){if(!n)return e;if(!e)return n;const t=vt(Object.create(null),n);for(const r in e)t[r]=bt(n[r],e[r]);return t}function DI(){return{app:null,config:{isNativeTag:Q5,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let xS=0;function PS(n,e){return function(r,s=null){se(r)||(r=vt({},r)),s!=null&&!Ve(s)&&(s=null);const i=DI(),o=new Set;let a=!1;const c=i.app={_uid:xS++,_component:r,_props:s,_container:null,_context:i,_instance:null,version:nx,get config(){return i.config},set config(l){},use(l,...u){return o.has(l)||(l&&se(l.install)?(o.add(l),l.install(c,...u)):se(l)&&(o.add(l),l(c,...u))),c},mixin(l){return i.mixins.includes(l)||i.mixins.push(l),c},component(l,u){return u?(i.components[l]=u,c):i.components[l]},directive(l,u){return u?(i.directives[l]=u,c):i.directives[l]},mount(l,u,h){if(!a){const d=ae(r,s);return d.appContext=i,u&&e?e(d,l):n(d,l,h),a=!0,c._container=l,l.__vue_app__=c,fu(d.component)||d.component.proxy}},unmount(){a&&(n(null,c._container),delete c._container.__vue_app__)},provide(l,u){return i.provides[l]=u,c},runWithContext(l){aa=c;try{return l()}finally{aa=null}}};return c}}let aa=null;function CS(n,e){if(ot){let t=ot.provides;const r=ot.parent&&ot.parent.provides;r===t&&(t=ot.provides=Object.create(r)),t[n]=e}}function bo(n,e,t=!1){const r=ot||mt;if(r||aa){const s=r?r.parent==null?r.vnode.appContext&&r.vnode.appContext.provides:r.parent.provides:aa._context.provides;if(s&&n in s)return s[n];if(arguments.length>1)return t&&se(e)?e.call(r&&r.proxy):e}}function kS(){return!!(ot||mt||aa)}function DS(n,e,t,r=!1){const s={},i={};Yc(i,du,1),n.propsDefaults=Object.create(null),NI(n,e,s,i);for(const o in n.propsOptions[0])o in s||(s[o]=void 0);t?n.props=r?s:F8(s):n.type.props?n.props=s:n.props=i,n.attrs=i}function NS(n,e,t,r){const{props:s,attrs:i,vnode:{patchFlag:o}}=n,a=ve(s),[c]=n.propsOptions;let l=!1;if((r||o>0)&&!(o&16)){if(o&8){const u=n.vnode.dynamicProps;for(let h=0;h<u.length;h++){let d=u[h];if(lu(n.emitsOptions,d))continue;const m=e[d];if(c)if(me(i,d))m!==i[d]&&(i[d]=m,l=!0);else{const E=xn(d);s[E]=Zh(c,a,E,m,n,!1)}else m!==i[d]&&(i[d]=m,l=!0)}}}else{NI(n,e,s,i)&&(l=!0);let u;for(const h in a)(!e||!me(e,h)&&((u=Mi(h))===h||!me(e,u)))&&(c?t&&(t[h]!==void 0||t[u]!==void 0)&&(s[h]=Zh(c,a,h,void 0,n,!0)):delete s[h]);if(i!==a)for(const h in i)(!e||!me(e,h))&&(delete i[h],l=!0)}l&&Un(n,"set","$attrs")}function NI(n,e,t,r){const[s,i]=n.propsOptions;let o=!1,a;if(e)for(let c in e){if(yc(c))continue;const l=e[c];let u;s&&me(s,u=xn(c))?!i||!i.includes(u)?t[u]=l:(a||(a={}))[u]=l:lu(n.emitsOptions,c)||(!(c in r)||l!==r[c])&&(r[c]=l,o=!0)}if(i){const c=ve(t),l=a||Pe;for(let u=0;u<i.length;u++){const h=i[u];t[h]=Zh(s,c,h,l[h],n,!me(l,h))}}return o}function Zh(n,e,t,r,s,i){const o=n[t];if(o!=null){const a=me(o,"default");if(a&&r===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&se(c)){const{propsDefaults:l}=s;t in l?r=l[t]:(Ii(s),r=l[t]=c.call(null,e),ls())}else r=c}o[0]&&(i&&!a?r=!1:o[1]&&(r===""||r===Mi(t))&&(r=!0))}return r}function VI(n,e,t=!1){const r=e.propsCache,s=r.get(n);if(s)return s;const i=n.props,o={},a=[];let c=!1;if(!se(n)){const u=h=>{c=!0;const[d,m]=VI(h,e,!0);vt(o,d),m&&a.push(...m)};!t&&e.mixins.length&&e.mixins.forEach(u),n.extends&&u(n.extends),n.mixins&&n.mixins.forEach(u)}if(!i&&!c)return Ve(n)&&r.set(n,Zs),Zs;if(Y(i))for(let u=0;u<i.length;u++){const h=xn(i[u]);zg(h)&&(o[h]=Pe)}else if(i)for(const u in i){const h=xn(u);if(zg(h)){const d=i[u],m=o[h]=Y(d)||se(d)?{type:d}:vt({},d);if(m){const E=Hg(Boolean,m.type),v=Hg(String,m.type);m[0]=E>-1,m[1]=v<0||E<v,(E>-1||me(m,"default"))&&a.push(h)}}}const l=[o,a];return Ve(n)&&r.set(n,l),l}function zg(n){return n[0]!=="$"}function Gg(n){const e=n&&n.toString().match(/^\s*(function|class) (\w+)/);return e?e[2]:n===null?"null":""}function Kg(n,e){return Gg(n)===Gg(e)}function Hg(n,e){return Y(e)?e.findIndex(t=>Kg(t,n)):se(e)&&Kg(e,n)?0:-1}const OI=n=>n[0]==="_"||n==="$stable",mp=n=>Y(n)?n.map(un):[un(n)],VS=(n,e,t)=>{if(e._n)return e;const r=TI((...s)=>mp(e(...s)),t);return r._c=!1,r},MI=(n,e,t)=>{const r=n._ctx;for(const s in n){if(OI(s))continue;const i=n[s];if(se(i))e[s]=VS(s,i,r);else if(i!=null){const o=mp(i);e[s]=()=>o}}},LI=(n,e)=>{const t=mp(e);n.slots.default=()=>t},OS=(n,e)=>{if(n.vnode.shapeFlag&32){const t=e._;t?(n.slots=ve(e),Yc(e,"_",t)):MI(e,n.slots={})}else n.slots={},e&&LI(n,e);Yc(n.slots,du,1)},MS=(n,e,t)=>{const{vnode:r,slots:s}=n;let i=!0,o=Pe;if(r.shapeFlag&32){const a=e._;a?t&&a===1?i=!1:(vt(s,e),!t&&a===1&&delete s._):(i=!e.$stable,MI(e,s)),o=e}else e&&(LI(n,e),o={default:1});if(i)for(const a in s)!OI(a)&&!(a in o)&&delete s[a]};function ed(n,e,t,r,s=!1){if(Y(n)){n.forEach((d,m)=>ed(d,e&&(Y(e)?e[m]:e),t,r,s));return}if(Eo(r)&&!s)return;const i=r.shapeFlag&4?fu(r.component)||r.component.proxy:r.el,o=s?null:i,{i:a,r:c}=n,l=e&&e.r,u=a.refs===Pe?a.refs={}:a.refs,h=a.setupState;if(l!=null&&l!==c&&(tt(l)?(u[l]=null,me(h,l)&&(h[l]=null)):He(l)&&(l.value=null)),se(c))hr(c,a,12,[o,u]);else{const d=tt(c),m=He(c);if(d||m){const E=()=>{if(n.f){const v=d?me(h,c)?h[c]:u[c]:c.value;s?Y(v)&&np(v,i):Y(v)?v.includes(i)||v.push(i):d?(u[c]=[i],me(h,c)&&(h[c]=u[c])):(c.value=[i],n.k&&(u[n.k]=c.value))}else d?(u[c]=o,me(h,c)&&(h[c]=o)):m&&(c.value=o,n.k&&(u[n.k]=o))};o?(E.id=-1,kt(E,t)):E()}}}const kt=iS;function LS(n){return FS(n)}function FS(n,e){const t=Gh();t.__VUE__=!0;const{insert:r,remove:s,patchProp:i,createElement:o,createText:a,createComment:c,setText:l,setElementText:u,parentNode:h,nextSibling:d,setScopeId:m=en,insertStaticContent:E}=n,v=(p,g,I,R=null,A=null,k=null,L=!1,C=null,V=!!g.dynamicChildren)=>{if(p===g)return;p&&!Zi(p,g)&&(R=Ua(p),an(p,A,k,!0),p=null),g.patchFlag===-2&&(V=!1,g.dynamicChildren=null);const{type:x,ref:H,shapeFlag:q}=g;switch(x){case hu:b(p,g,I,R);break;case Rr:B(p,g,I,R);break;case wc:p==null&&G(g,I,R,L);break;case De:on(p,g,I,R,A,k,L,C,V);break;default:q&1?J(p,g,I,R,A,k,L,C,V):q&6?ks(p,g,I,R,A,k,L,C,V):(q&64||q&128)&&x.process(p,g,I,R,A,k,L,C,V,Ds)}H!=null&&A&&ed(H,p&&p.ref,k,g||p,!g)},b=(p,g,I,R)=>{if(p==null)r(g.el=a(g.children),I,R);else{const A=g.el=p.el;g.children!==p.children&&l(A,g.children)}},B=(p,g,I,R)=>{p==null?r(g.el=c(g.children||""),I,R):g.el=p.el},G=(p,g,I,R)=>{[p.el,p.anchor]=E(p.children,g,I,R,p.el,p.anchor)},$=({el:p,anchor:g},I,R)=>{let A;for(;p&&p!==g;)A=d(p),r(p,I,R),p=A;r(g,I,R)},F=({el:p,anchor:g})=>{let I;for(;p&&p!==g;)I=d(p),s(p),p=I;s(g)},J=(p,g,I,R,A,k,L,C,V)=>{L=L||g.type==="svg",p==null?re(g,I,R,A,k,L,C,V):ce(p,g,A,k,L,C,V)},re=(p,g,I,R,A,k,L,C)=>{let V,x;const{type:H,props:q,shapeFlag:W,transition:Z,dirs:le}=p;if(V=p.el=o(p.type,k,q&&q.is,q),W&8?u(V,p.children):W&16&&ie(p.children,V,null,R,A,k&&H!=="foreignObject",L,C),le&&Ur(p,null,R,"created"),Te(V,p,p.scopeId,L,R),q){for(const Ae in q)Ae!=="value"&&!yc(Ae)&&i(V,Ae,null,q[Ae],k,p.children,R,A,Pn);"value"in q&&i(V,"value",null,q.value),(x=q.onVnodeBeforeMount)&&ln(x,R,p)}le&&Ur(p,null,R,"beforeMount");const Se=(!A||A&&!A.pendingBranch)&&Z&&!Z.persisted;Se&&Z.beforeEnter(V),r(V,g,I),((x=q&&q.onVnodeMounted)||Se||le)&&kt(()=>{x&&ln(x,R,p),Se&&Z.enter(V),le&&Ur(p,null,R,"mounted")},A)},Te=(p,g,I,R,A)=>{if(I&&m(p,I),R)for(let k=0;k<R.length;k++)m(p,R[k]);if(A){let k=A.subTree;if(g===k){const L=A.vnode;Te(p,L,L.scopeId,L.slotScopeIds,A.parent)}}},ie=(p,g,I,R,A,k,L,C,V=0)=>{for(let x=V;x<p.length;x++){const H=p[x]=C?nr(p[x]):un(p[x]);v(null,H,g,I,R,A,k,L,C)}},ce=(p,g,I,R,A,k,L)=>{const C=g.el=p.el;let{patchFlag:V,dynamicChildren:x,dirs:H}=g;V|=p.patchFlag&16;const q=p.props||Pe,W=g.props||Pe;let Z;I&&Br(I,!1),(Z=W.onVnodeBeforeUpdate)&&ln(Z,I,g,p),H&&Ur(g,p,I,"beforeUpdate"),I&&Br(I,!0);const le=A&&g.type!=="foreignObject";if(x?Fe(p.dynamicChildren,x,C,I,R,le,k):L||Re(p,g,C,null,I,R,le,k,!1),V>0){if(V&16)Ut(C,g,q,W,I,R,A);else if(V&2&&q.class!==W.class&&i(C,"class",null,W.class,A),V&4&&i(C,"style",q.style,W.style,A),V&8){const Se=g.dynamicProps;for(let Ae=0;Ae<Se.length;Ae++){const Ye=Se[Ae],Yt=q[Ye],Ns=W[Ye];(Ns!==Yt||Ye==="value")&&i(C,Ye,Yt,Ns,A,p.children,I,R,Pn)}}V&1&&p.children!==g.children&&u(C,g.children)}else!L&&x==null&&Ut(C,g,q,W,I,R,A);((Z=W.onVnodeUpdated)||H)&&kt(()=>{Z&&ln(Z,I,g,p),H&&Ur(g,p,I,"updated")},R)},Fe=(p,g,I,R,A,k,L)=>{for(let C=0;C<g.length;C++){const V=p[C],x=g[C],H=V.el&&(V.type===De||!Zi(V,x)||V.shapeFlag&70)?h(V.el):I;v(V,x,H,null,R,A,k,L,!0)}},Ut=(p,g,I,R,A,k,L)=>{if(I!==R){if(I!==Pe)for(const C in I)!yc(C)&&!(C in R)&&i(p,C,I[C],null,L,g.children,A,k,Pn);for(const C in R){if(yc(C))continue;const V=R[C],x=I[C];V!==x&&C!=="value"&&i(p,C,x,V,L,g.children,A,k,Pn)}"value"in R&&i(p,"value",I.value,R.value)}},on=(p,g,I,R,A,k,L,C,V)=>{const x=g.el=p?p.el:a(""),H=g.anchor=p?p.anchor:a("");let{patchFlag:q,dynamicChildren:W,slotScopeIds:Z}=g;Z&&(C=C?C.concat(Z):Z),p==null?(r(x,I,R),r(H,I,R),ie(g.children,I,H,A,k,L,C,V)):q>0&&q&64&&W&&p.dynamicChildren?(Fe(p.dynamicChildren,W,I,A,k,L,C),(g.key!=null||A&&g===A.subTree)&&FI(p,g,!0)):Re(p,g,I,H,A,k,L,C,V)},ks=(p,g,I,R,A,k,L,C,V)=>{g.slotScopeIds=C,p==null?g.shapeFlag&512?A.ctx.activate(g,I,R,L,V):Bi(g,I,R,A,k,L,V):Qn(p,g,V)},Bi=(p,g,I,R,A,k,L)=>{const C=p.component=HS(p,R,A);if(RI(p)&&(C.ctx.renderer=Ds),WS(C),C.asyncDep){if(A&&A.registerDep(C,be),!p.el){const V=C.subTree=ae(Rr);B(null,V,g,I)}return}be(C,p,g,I,A,k,L)},Qn=(p,g,I)=>{const R=g.component=p.component;if(nS(p,g,I))if(R.asyncDep&&!R.asyncResolved){$e(R,g,I);return}else R.next=g,Y8(R.update),R.update();else g.el=p.el,R.vnode=g},be=(p,g,I,R,A,k,L)=>{const C=()=>{if(p.isMounted){let{next:H,bu:q,u:W,parent:Z,vnode:le}=p,Se=H,Ae;Br(p,!1),H?(H.el=le.el,$e(p,H,L)):H=le,q&&vc(q),(Ae=H.props&&H.props.onVnodeBeforeUpdate)&&ln(Ae,Z,H,le),Br(p,!0);const Ye=Gu(p),Yt=p.subTree;p.subTree=Ye,v(Yt,Ye,h(Yt.el),Ua(Yt),p,A,k),H.el=Ye.el,Se===null&&rS(p,Ye.el),W&&kt(W,A),(Ae=H.props&&H.props.onVnodeUpdated)&&kt(()=>ln(Ae,Z,H,le),A)}else{let H;const{el:q,props:W}=g,{bm:Z,m:le,parent:Se}=p,Ae=Eo(g);if(Br(p,!1),Z&&vc(Z),!Ae&&(H=W&&W.onVnodeBeforeMount)&&ln(H,Se,g),Br(p,!0),q&&_u){const Ye=()=>{p.subTree=Gu(p),_u(q,p.subTree,p,A,null)};Ae?g.type.__asyncLoader().then(()=>!p.isUnmounted&&Ye()):Ye()}else{const Ye=p.subTree=Gu(p);v(null,Ye,I,R,p,A,k),g.el=Ye.el}if(le&&kt(le,A),!Ae&&(H=W&&W.onVnodeMounted)){const Ye=g;kt(()=>ln(H,Se,Ye),A)}(g.shapeFlag&256||Se&&Eo(Se.vnode)&&Se.vnode.shapeFlag&256)&&p.a&&kt(p.a,A),p.isMounted=!0,g=I=R=null}},V=p.effect=new op(C,()=>fp(x),p.scope),x=p.update=()=>V.run();x.id=p.uid,Br(p,!0),x()},$e=(p,g,I)=>{g.component=p;const R=p.vnode.props;p.vnode=g,p.next=null,NS(p,g.props,R,I),MS(p,g.children,I),Li(),Lg(),Fi()},Re=(p,g,I,R,A,k,L,C,V=!1)=>{const x=p&&p.children,H=p?p.shapeFlag:0,q=g.children,{patchFlag:W,shapeFlag:Z}=g;if(W>0){if(W&128){Fa(x,q,I,R,A,k,L,C,V);return}else if(W&256){Mr(x,q,I,R,A,k,L,C,V);return}}Z&8?(H&16&&Pn(x,A,k),q!==x&&u(I,q)):H&16?Z&16?Fa(x,q,I,R,A,k,L,C,V):Pn(x,A,k,!0):(H&8&&u(I,""),Z&16&&ie(q,I,R,A,k,L,C,V))},Mr=(p,g,I,R,A,k,L,C,V)=>{p=p||Zs,g=g||Zs;const x=p.length,H=g.length,q=Math.min(x,H);let W;for(W=0;W<q;W++){const Z=g[W]=V?nr(g[W]):un(g[W]);v(p[W],Z,I,null,A,k,L,C,V)}x>H?Pn(p,A,k,!0,!1,q):ie(g,I,R,A,k,L,C,V,q)},Fa=(p,g,I,R,A,k,L,C,V)=>{let x=0;const H=g.length;let q=p.length-1,W=H-1;for(;x<=q&&x<=W;){const Z=p[x],le=g[x]=V?nr(g[x]):un(g[x]);if(Zi(Z,le))v(Z,le,I,null,A,k,L,C,V);else break;x++}for(;x<=q&&x<=W;){const Z=p[q],le=g[W]=V?nr(g[W]):un(g[W]);if(Zi(Z,le))v(Z,le,I,null,A,k,L,C,V);else break;q--,W--}if(x>q){if(x<=W){const Z=W+1,le=Z<H?g[Z].el:R;for(;x<=W;)v(null,g[x]=V?nr(g[x]):un(g[x]),I,le,A,k,L,C,V),x++}}else if(x>W)for(;x<=q;)an(p[x],A,k,!0),x++;else{const Z=x,le=x,Se=new Map;for(x=le;x<=W;x++){const Bt=g[x]=V?nr(g[x]):un(g[x]);Bt.key!=null&&Se.set(Bt.key,x)}let Ae,Ye=0;const Yt=W-le+1;let Ns=!1,xp=0;const $i=new Array(Yt);for(x=0;x<Yt;x++)$i[x]=0;for(x=Z;x<=q;x++){const Bt=p[x];if(Ye>=Yt){an(Bt,A,k,!0);continue}let cn;if(Bt.key!=null)cn=Se.get(Bt.key);else for(Ae=le;Ae<=W;Ae++)if($i[Ae-le]===0&&Zi(Bt,g[Ae])){cn=Ae;break}cn===void 0?an(Bt,A,k,!0):($i[cn-le]=x+1,cn>=xp?xp=cn:Ns=!0,v(Bt,g[cn],I,null,A,k,L,C,V),Ye++)}const Pp=Ns?US($i):Zs;for(Ae=Pp.length-1,x=Yt-1;x>=0;x--){const Bt=le+x,cn=g[Bt],Cp=Bt+1<H?g[Bt+1].el:R;$i[x]===0?v(null,cn,I,Cp,A,k,L,C,V):Ns&&(Ae<0||x!==Pp[Ae]?Lr(cn,I,Cp,2):Ae--)}}},Lr=(p,g,I,R,A=null)=>{const{el:k,type:L,transition:C,children:V,shapeFlag:x}=p;if(x&6){Lr(p.component.subTree,g,I,R);return}if(x&128){p.suspense.move(g,I,R);return}if(x&64){L.move(p,g,I,Ds);return}if(L===De){r(k,g,I);for(let q=0;q<V.length;q++)Lr(V[q],g,I,R);r(p.anchor,g,I);return}if(L===wc){$(p,g,I);return}if(R!==2&&x&1&&C)if(R===0)C.beforeEnter(k),r(k,g,I),kt(()=>C.enter(k),A);else{const{leave:q,delayLeave:W,afterLeave:Z}=C,le=()=>r(k,g,I),Se=()=>{q(k,()=>{le(),Z&&Z()})};W?W(k,le,Se):Se()}else r(k,g,I)},an=(p,g,I,R=!1,A=!1)=>{const{type:k,props:L,ref:C,children:V,dynamicChildren:x,shapeFlag:H,patchFlag:q,dirs:W}=p;if(C!=null&&ed(C,null,I,p,!0),H&256){g.ctx.deactivate(p);return}const Z=H&1&&W,le=!Eo(p);let Se;if(le&&(Se=L&&L.onVnodeBeforeUnmount)&&ln(Se,g,p),H&6)ew(p.component,I,R);else{if(H&128){p.suspense.unmount(I,R);return}Z&&Ur(p,null,g,"beforeUnmount"),H&64?p.type.remove(p,g,I,A,Ds,R):x&&(k!==De||q>0&&q&64)?Pn(x,g,I,!1,!0):(k===De&&q&384||!A&&H&16)&&Pn(V,g,I),R&&Rp(p)}(le&&(Se=L&&L.onVnodeUnmounted)||Z)&&kt(()=>{Se&&ln(Se,g,p),Z&&Ur(p,null,g,"unmounted")},I)},Rp=p=>{const{type:g,el:I,anchor:R,transition:A}=p;if(g===De){ZI(I,R);return}if(g===wc){F(p);return}const k=()=>{s(I),A&&!A.persisted&&A.afterLeave&&A.afterLeave()};if(p.shapeFlag&1&&A&&!A.persisted){const{leave:L,delayLeave:C}=A,V=()=>L(I,k);C?C(p.el,k,V):V()}else k()},ZI=(p,g)=>{let I;for(;p!==g;)I=d(p),s(p),p=I;s(g)},ew=(p,g,I)=>{const{bum:R,scope:A,update:k,subTree:L,um:C}=p;R&&vc(R),A.stop(),k&&(k.active=!1,an(L,p,g,I)),C&&kt(C,g),kt(()=>{p.isUnmounted=!0},g),g&&g.pendingBranch&&!g.isUnmounted&&p.asyncDep&&!p.asyncResolved&&p.suspenseId===g.pendingId&&(g.deps--,g.deps===0&&g.resolve())},Pn=(p,g,I,R=!1,A=!1,k=0)=>{for(let L=k;L<p.length;L++)an(p[L],g,I,R,A)},Ua=p=>p.shapeFlag&6?Ua(p.component.subTree):p.shapeFlag&128?p.suspense.next():d(p.anchor||p.el),Sp=(p,g,I)=>{p==null?g._vnode&&an(g._vnode,null,null,!0):v(g._vnode||null,p,g,null,null,null,I),Lg(),vI(),g._vnode=p},Ds={p:v,um:an,m:Lr,r:Rp,mt:Bi,mc:ie,pc:Re,pbc:Fe,n:Ua,o:n};let gu,_u;return e&&([gu,_u]=e(Ds)),{render:Sp,hydrate:gu,createApp:PS(Sp,gu)}}function Br({effect:n,update:e},t){n.allowRecurse=e.allowRecurse=t}function FI(n,e,t=!1){const r=n.children,s=e.children;if(Y(r)&&Y(s))for(let i=0;i<r.length;i++){const o=r[i];let a=s[i];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=s[i]=nr(s[i]),a.el=o.el),t||FI(o,a)),a.type===hu&&(a.el=o.el)}}function US(n){const e=n.slice(),t=[0];let r,s,i,o,a;const c=n.length;for(r=0;r<c;r++){const l=n[r];if(l!==0){if(s=t[t.length-1],n[s]<l){e[r]=s,t.push(r);continue}for(i=0,o=t.length-1;i<o;)a=i+o>>1,n[t[a]]<l?i=a+1:o=a;l<n[t[i]]&&(i>0&&(e[r]=t[i-1]),t[i]=r)}}for(i=t.length,o=t[i-1];i-- >0;)t[i]=o,o=e[o];return t}const BS=n=>n.__isTeleport,De=Symbol.for("v-fgt"),hu=Symbol.for("v-txt"),Rr=Symbol.for("v-cmt"),wc=Symbol.for("v-stc"),Ao=[];let Zt=null;function w(n=!1){Ao.push(Zt=n?null:[])}function $S(){Ao.pop(),Zt=Ao[Ao.length-1]||null}let ca=1;function Wg(n){ca+=n}function UI(n){return n.dynamicChildren=ca>0?Zt||Zs:null,$S(),ca>0&&Zt&&Zt.push(n),n}function D(n,e,t,r,s,i){return UI(f(n,e,t,r,s,i,!0))}function ge(n,e,t,r,s){return UI(ae(n,e,t,r,s,!0))}function BI(n){return n?n.__v_isVNode===!0:!1}function Zi(n,e){return n.type===e.type&&n.key===e.key}const du="__vInternal",$I=({key:n})=>n??null,Ec=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?tt(n)||He(n)||se(n)?{i:mt,r:n,k:e,f:!!t}:n:null);function f(n,e=null,t=null,r=0,s=null,i=n===De?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&$I(e),ref:e&&Ec(e),scopeId:EI,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:r,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:mt};return a?(gp(c,t),i&128&&n.normalize(c)):t&&(c.shapeFlag|=tt(t)?8:16),ca>0&&!o&&Zt&&(c.patchFlag>0||i&6)&&c.patchFlag!==32&&Zt.push(c),c}const ae=qS;function qS(n,e=null,t=null,r=0,s=null,i=!1){if((!n||n===vS)&&(n=Rr),BI(n)){const a=vi(n,e,!0);return t&&gp(a,t),ca>0&&!i&&Zt&&(a.shapeFlag&6?Zt[Zt.indexOf(n)]=a:Zt.push(a)),a.patchFlag|=-2,a}if(ZS(n)&&(n=n.__vccOpts),e){e=jS(e);let{class:a,style:c}=e;a&&!tt(a)&&(e.class=he(a)),Ve(c)&&(hI(c)&&!Y(c)&&(c=vt({},c)),e.style=sp(c))}const o=tt(n)?1:sS(n)?128:BS(n)?64:Ve(n)?4:se(n)?2:0;return f(n,e,t,r,s,o,i,!0)}function jS(n){return n?hI(n)||du in n?vt({},n):n:null}function vi(n,e,t=!1){const{props:r,ref:s,patchFlag:i,children:o}=n,a=e?zS(r||{},e):r;return{__v_isVNode:!0,__v_skip:!0,type:n.type,props:a,key:a&&$I(a),ref:e&&e.ref?t&&s?Y(s)?s.concat(Ec(e)):[s,Ec(e)]:Ec(e):s,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:o,target:n.target,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==De?i===-1?16:i|16:i,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:n.transition,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&vi(n.ssContent),ssFallback:n.ssFallback&&vi(n.ssFallback),el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce}}function Ie(n=" ",e=0){return ae(hu,null,n,e)}function Wn(n,e){const t=ae(wc,null,n);return t.staticCount=e,t}function oe(n="",e=!1){return e?(w(),ge(Rr,null,n)):ae(Rr,null,n)}function un(n){return n==null||typeof n=="boolean"?ae(Rr):Y(n)?ae(De,null,n.slice()):typeof n=="object"?nr(n):ae(hu,null,String(n))}function nr(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:vi(n)}function gp(n,e){let t=0;const{shapeFlag:r}=n;if(e==null)e=null;else if(Y(e))t=16;else if(typeof e=="object")if(r&65){const s=e.default;s&&(s._c&&(s._d=!1),gp(n,s()),s._c&&(s._d=!0));return}else{t=32;const s=e._;!s&&!(du in e)?e._ctx=mt:s===3&&mt&&(mt.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else se(e)?(e={default:e,_ctx:mt},t=32):(e=String(e),r&64?(t=16,e=[Ie(e)]):t=8);n.children=e,n.shapeFlag|=t}function zS(...n){const e={};for(let t=0;t<n.length;t++){const r=n[t];for(const s in r)if(s==="class")e.class!==r.class&&(e.class=he([e.class,r.class]));else if(s==="style")e.style=sp([e.style,r.style]);else if(eu(s)){const i=e[s],o=r[s];o&&i!==o&&!(Y(i)&&i.includes(o))&&(e[s]=i?[].concat(i,o):o)}else s!==""&&(e[s]=r[s])}return e}function ln(n,e,t,r=null){tn(n,e,7,[t,r])}const GS=DI();let KS=0;function HS(n,e,t){const r=n.type,s=(e?e.appContext:n.appContext)||GS,i={uid:KS++,vnode:n,type:r,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,scope:new Jv(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:VI(r,s),emitsOptions:wI(r,s),emit:null,emitted:null,propsDefaults:Pe,inheritAttrs:r.inheritAttrs,ctx:Pe,data:Pe,props:Pe,attrs:Pe,slots:Pe,refs:Pe,setupState:Pe,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=Z8.bind(null,i),n.ce&&n.ce(i),i}let ot=null,_p,Fs,Qg="__VUE_INSTANCE_SETTERS__";(Fs=Gh()[Qg])||(Fs=Gh()[Qg]=[]),Fs.push(n=>ot=n),_p=n=>{Fs.length>1?Fs.forEach(e=>e(n)):Fs[0](n)};const Ii=n=>{_p(n),n.scope.on()},ls=()=>{ot&&ot.scope.off(),_p(null)};function qI(n){return n.vnode.shapeFlag&4}let la=!1;function WS(n,e=!1){la=e;const{props:t,children:r}=n.vnode,s=qI(n);DS(n,t,s,e),OS(n,r);const i=s?QS(n,e):void 0;return la=!1,i}function QS(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=au(new Proxy(n.ctx,ES));const{setup:r}=t;if(r){const s=n.setupContext=r.length>1?JS(n):null;Ii(n),Li();const i=hr(r,n,0,[n.props,s]);if(Fi(),ls(),Kv(i)){if(i.then(ls,ls),e)return i.then(o=>{Yg(n,o,e)}).catch(o=>{cu(o,n,0)});n.asyncDep=i}else Yg(n,i,e)}else jI(n,e)}function Yg(n,e,t){se(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:Ve(e)&&(n.setupState=mI(e)),jI(n,t)}let Jg;function jI(n,e,t){const r=n.type;if(!n.render){if(!e&&Jg&&!r.render){const s=r.template||pp(n).template;if(s){const{isCustomElement:i,compilerOptions:o}=n.appContext.config,{delimiters:a,compilerOptions:c}=r,l=vt(vt({isCustomElement:i,delimiters:a},o),c);r.render=Jg(s,l)}}n.render=r.render||en}Ii(n),Li(),TS(n),Fi(),ls()}function YS(n){return n.attrsProxy||(n.attrsProxy=new Proxy(n.attrs,{get(e,t){return Ft(n,"get","$attrs"),e[t]}}))}function JS(n){const e=t=>{n.exposed=t||{}};return{get attrs(){return YS(n)},slots:n.slots,emit:n.emit,expose:e}}function fu(n){if(n.exposed)return n.exposeProxy||(n.exposeProxy=new Proxy(mI(au(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in To)return To[t](n)},has(e,t){return t in e||t in To}}))}function XS(n,e=!0){return se(n)?n.displayName||n.name:n.name||e&&n.__name}function ZS(n){return se(n)&&"__vccOpts"in n}const zI=(n,e)=>H8(n,e,la),ex=Symbol.for("v-scx"),tx=()=>bo(ex),nx="3.3.4",rx="http://www.w3.org/2000/svg",Qr=typeof document<"u"?document:null,Xg=Qr&&Qr.createElement("template"),sx={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,r)=>{const s=e?Qr.createElementNS(rx,n):Qr.createElement(n,t?{is:t}:void 0);return n==="select"&&r&&r.multiple!=null&&s.setAttribute("multiple",r.multiple),s},createText:n=>Qr.createTextNode(n),createComment:n=>Qr.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>Qr.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,r,s,i){const o=t?t.previousSibling:e.lastChild;if(s&&(s===i||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),t),!(s===i||!(s=s.nextSibling)););else{Xg.innerHTML=r?`<svg>${n}</svg>`:n;const a=Xg.content;if(r){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}e.insertBefore(a,t)}return[o?o.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}};function ix(n,e,t){const r=n._vtc;r&&(e=(e?[e,...r]:[...r]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}function ox(n,e,t){const r=n.style,s=tt(t);if(t&&!s){if(e&&!tt(e))for(const i in e)t[i]==null&&td(r,i,"");for(const i in t)td(r,i,t[i])}else{const i=r.display;s?e!==t&&(r.cssText=t):e&&n.removeAttribute("style"),"_vod"in n&&(r.display=i)}}const Zg=/\s*!important$/;function td(n,e,t){if(Y(t))t.forEach(r=>td(n,e,r));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const r=ax(n,e);Zg.test(t)?n.setProperty(Mi(r),t.replace(Zg,""),"important"):n[r]=t}}const e_=["Webkit","Moz","ms"],Hu={};function ax(n,e){const t=Hu[e];if(t)return t;let r=xn(e);if(r!=="filter"&&r in n)return Hu[e]=r;r=ru(r);for(let s=0;s<e_.length;s++){const i=e_[s]+r;if(i in n)return Hu[e]=i}return e}const t_="http://www.w3.org/1999/xlink";function cx(n,e,t,r,s){if(r&&e.startsWith("xlink:"))t==null?n.removeAttributeNS(t_,e.slice(6,e.length)):n.setAttributeNS(t_,e,t);else{const i=o8(e);t==null||i&&!Qv(t)?n.removeAttribute(e):n.setAttribute(e,i?"":t)}}function lx(n,e,t,r,s,i,o){if(e==="innerHTML"||e==="textContent"){r&&o(r,s,i),n[e]=t??"";return}const a=n.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){n._value=t;const l=a==="OPTION"?n.getAttribute("value"):n.value,u=t??"";l!==u&&(n.value=u),t==null&&n.removeAttribute(e);return}let c=!1;if(t===""||t==null){const l=typeof n[e];l==="boolean"?t=Qv(t):t==null&&l==="string"?(t="",c=!0):l==="number"&&(t=0,c=!0)}try{n[e]=t}catch{}c&&n.removeAttribute(e)}function Yr(n,e,t,r){n.addEventListener(e,t,r)}function ux(n,e,t,r){n.removeEventListener(e,t,r)}function hx(n,e,t,r,s=null){const i=n._vei||(n._vei={}),o=i[e];if(r&&o)o.value=r;else{const[a,c]=dx(e);if(r){const l=i[e]=mx(r,s);Yr(n,a,l,c)}else o&&(ux(n,a,o,c),i[e]=void 0)}}const n_=/(?:Once|Passive|Capture)$/;function dx(n){let e;if(n_.test(n)){e={};let r;for(;r=n.match(n_);)n=n.slice(0,n.length-r[0].length),e[r[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):Mi(n.slice(2)),e]}let Wu=0;const fx=Promise.resolve(),px=()=>Wu||(fx.then(()=>Wu=0),Wu=Date.now());function mx(n,e){const t=r=>{if(!r._vts)r._vts=Date.now();else if(r._vts<=t.attached)return;tn(gx(r,t.value),e,5,[r])};return t.value=n,t.attached=px(),t}function gx(n,e){if(Y(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(r=>s=>!s._stopped&&r&&r(s))}else return e}const r_=/^on[a-z]/,_x=(n,e,t,r,s=!1,i,o,a,c)=>{e==="class"?ix(n,r,s):e==="style"?ox(n,t,r):eu(e)?tp(e)||hx(n,e,t,r,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):yx(n,e,r,s))?lx(n,e,r,i,o,a,c):(e==="true-value"?n._trueValue=r:e==="false-value"&&(n._falseValue=r),cx(n,e,r,s))};function yx(n,e,t,r){return r?!!(e==="innerHTML"||e==="textContent"||e in n&&r_.test(e)&&se(t)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA"||r_.test(e)&&tt(t)?!1:e in n}const nl=n=>{const e=n.props["onUpdate:modelValue"]||!1;return Y(e)?t=>vc(e,t):e};function vx(n){n.target.composing=!0}function s_(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const it={created(n,{modifiers:{lazy:e,trim:t,number:r}},s){n._assign=nl(s);const i=r||s.props&&s.props.type==="number";Yr(n,e?"change":"input",o=>{if(o.target.composing)return;let a=n.value;t&&(a=a.trim()),i&&(a=Jc(a)),n._assign(a)}),t&&Yr(n,"change",()=>{n.value=n.value.trim()}),e||(Yr(n,"compositionstart",vx),Yr(n,"compositionend",s_),Yr(n,"change",s_))},mounted(n,{value:e}){n.value=e??""},beforeUpdate(n,{value:e,modifiers:{lazy:t,trim:r,number:s}},i){if(n._assign=nl(i),n.composing||document.activeElement===n&&n.type!=="range"&&(t||r&&n.value.trim()===e||(s||n.type==="number")&&Jc(n.value)===e))return;const o=e??"";n.value!==o&&(n.value=o)}},GI={deep:!0,created(n,{value:e,modifiers:{number:t}},r){const s=tu(e);Yr(n,"change",()=>{const i=Array.prototype.filter.call(n.options,o=>o.selected).map(o=>t?Jc(rl(o)):rl(o));n._assign(n.multiple?s?new Set(i):i:i[0])}),n._assign=nl(r)},mounted(n,{value:e}){i_(n,e)},beforeUpdate(n,e,t){n._assign=nl(t)},updated(n,{value:e}){i_(n,e)}};function i_(n,e){const t=n.multiple;if(!(t&&!Y(e)&&!tu(e))){for(let r=0,s=n.options.length;r<s;r++){const i=n.options[r],o=rl(i);if(t)Y(e)?i.selected=c8(e,o)>-1:i.selected=e.has(o);else if(su(rl(i),e)){n.selectedIndex!==r&&(n.selectedIndex=r);return}}!t&&n.selectedIndex!==-1&&(n.selectedIndex=-1)}}function rl(n){return"_value"in n?n._value:n.value}const Ix=["ctrl","shift","alt","meta"],wx={stop:n=>n.stopPropagation(),prevent:n=>n.preventDefault(),self:n=>n.target!==n.currentTarget,ctrl:n=>!n.ctrlKey,shift:n=>!n.shiftKey,alt:n=>!n.altKey,meta:n=>!n.metaKey,left:n=>"button"in n&&n.button!==0,middle:n=>"button"in n&&n.button!==1,right:n=>"button"in n&&n.button!==2,exact:(n,e)=>Ix.some(t=>n[`${t}Key`]&&!e.includes(t))},Wt=(n,e)=>(t,...r)=>{for(let s=0;s<e.length;s++){const i=wx[e[s]];if(i&&i(t,e))return}return n(t,...r)},sl={beforeMount(n,{value:e},{transition:t}){n._vod=n.style.display==="none"?"":n.style.display,t&&e?t.beforeEnter(n):eo(n,e)},mounted(n,{value:e},{transition:t}){t&&e&&t.enter(n)},updated(n,{value:e,oldValue:t},{transition:r}){!e!=!t&&(r?e?(r.beforeEnter(n),eo(n,!0),r.enter(n)):r.leave(n,()=>{eo(n,!1)}):eo(n,e))},beforeUnmount(n,{value:e}){eo(n,e)}};function eo(n,e){n.style.display=e?n._vod:"none"}const Ex=vt({patchProp:_x},sx);let o_;function Tx(){return o_||(o_=LS(Ex))}const bx=(...n)=>{const e=Tx().createApp(...n),{mount:t}=e;return e.mount=r=>{const s=Ax(r);if(!s)return;const i=e._component;!se(i)&&!i.render&&!i.template&&(i.template=s.innerHTML),s.innerHTML="";const o=t(s,!1,s instanceof SVGElement);return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},e};function Ax(n){return tt(n)?document.querySelector(n):n}var Rx=!1;/*!
 * pinia v2.1.6
 * (c) 2023 Eduardo San Martin Morote
 * @license MIT
 */let KI;const pu=n=>KI=n,HI=Symbol();function nd(n){return n&&typeof n=="object"&&Object.prototype.toString.call(n)==="[object Object]"&&typeof n.toJSON!="function"}var Ro;(function(n){n.direct="direct",n.patchObject="patch object",n.patchFunction="patch function"})(Ro||(Ro={}));function Sx(){const n=Xv(!0),e=n.run(()=>pI({}));let t=[],r=[];const s=au({install(i){pu(s),s._a=i,i.provide(HI,s),i.config.globalProperties.$pinia=s,r.forEach(o=>t.push(o)),r=[]},use(i){return!this._a&&!Rx?r.push(i):t.push(i),this},_p:t,_a:null,_e:n,_s:new Map,state:e});return s}const WI=()=>{};function a_(n,e,t,r=WI){n.push(e);const s=()=>{const i=n.indexOf(e);i>-1&&(n.splice(i,1),r())};return!t&&Zv()&&u8(s),s}function Us(n,...e){n.slice().forEach(t=>{t(...e)})}const xx=n=>n();function rd(n,e){n instanceof Map&&e instanceof Map&&e.forEach((t,r)=>n.set(r,t)),n instanceof Set&&e instanceof Set&&e.forEach(n.add,n);for(const t in e){if(!e.hasOwnProperty(t))continue;const r=e[t],s=n[t];nd(s)&&nd(r)&&n.hasOwnProperty(t)&&!He(r)&&!ur(r)?n[t]=rd(s,r):n[t]=r}return n}const Px=Symbol();function Cx(n){return!nd(n)||!n.hasOwnProperty(Px)}const{assign:tr}=Object;function kx(n){return!!(He(n)&&n.effect)}function Dx(n,e,t,r){const{state:s,actions:i,getters:o}=e,a=t.state.value[n];let c;function l(){a||(t.state.value[n]=s?s():{});const u=j8(t.state.value[n]);return tr(u,i,Object.keys(o||{}).reduce((h,d)=>(h[d]=au(zI(()=>{pu(t);const m=t._s.get(n);return o[d].call(m,m)})),h),{}))}return c=QI(n,l,e,t,r,!0),c}function QI(n,e,t={},r,s,i){let o;const a=tr({actions:{}},t),c={deep:!0};let l,u,h=[],d=[],m;const E=r.state.value[n];!i&&!E&&(r.state.value[n]={}),pI({});let v;function b(ie){let ce;l=u=!1,typeof ie=="function"?(ie(r.state.value[n]),ce={type:Ro.patchFunction,storeId:n,events:m}):(rd(r.state.value[n],ie),ce={type:Ro.patchObject,payload:ie,storeId:n,events:m});const Fe=v=Symbol();_I().then(()=>{v===Fe&&(l=!0)}),u=!0,Us(h,ce,r.state.value[n])}const B=i?function(){const{state:ce}=t,Fe=ce?ce():{};this.$patch(Ut=>{tr(Ut,Fe)})}:WI;function G(){o.stop(),h=[],d=[],r._s.delete(n)}function $(ie,ce){return function(){pu(r);const Fe=Array.from(arguments),Ut=[],on=[];function ks(be){Ut.push(be)}function Bi(be){on.push(be)}Us(d,{args:Fe,name:ie,store:J,after:ks,onError:Bi});let Qn;try{Qn=ce.apply(this&&this.$id===n?this:J,Fe)}catch(be){throw Us(on,be),be}return Qn instanceof Promise?Qn.then(be=>(Us(Ut,be),be)).catch(be=>(Us(on,be),Promise.reject(be))):(Us(Ut,Qn),Qn)}}const F={_p:r,$id:n,$onAction:a_.bind(null,d),$patch:b,$reset:B,$subscribe(ie,ce={}){const Fe=a_(h,ie,ce.detached,()=>Ut()),Ut=o.run(()=>Ic(()=>r.state.value[n],on=>{(ce.flush==="sync"?u:l)&&ie({storeId:n,type:Ro.direct,events:m},on)},tr({},c,ce)));return Fe},$dispose:G},J=ou(F);r._s.set(n,J);const re=r._a&&r._a.runWithContext||xx,Te=r._e.run(()=>(o=Xv(),re(()=>o.run(e))));for(const ie in Te){const ce=Te[ie];if(He(ce)&&!kx(ce)||ur(ce))i||(E&&Cx(ce)&&(He(ce)?ce.value=E[ie]:rd(ce,E[ie])),r.state.value[n][ie]=ce);else if(typeof ce=="function"){const Fe=$(ie,ce);Te[ie]=Fe,a.actions[ie]=ce}}return tr(J,Te),tr(ve(J),Te),Object.defineProperty(J,"$state",{get:()=>r.state.value[n],set:ie=>{b(ce=>{tr(ce,ie)})}}),r._p.forEach(ie=>{tr(J,o.run(()=>ie({store:J,app:r._a,pinia:r,options:a})))}),E&&i&&t.hydrate&&t.hydrate(J.$state,E),l=!0,u=!0,J}function mu(n,e,t){let r,s;const i=typeof e=="function";typeof n=="string"?(r=n,s=i?t:e):(s=n,r=n.id);function o(a,c){const l=kS();return a=a||(l?bo(HI,null):null),a&&pu(a),a=KI,a._s.has(r)||(i?QI(r,e,s,a):Dx(r,s,a)),a._s.get(r)}return o.$id=r,o}let Nx="Store";function Vx(...n){return n.reduce((e,t)=>(e[t.$id+Nx]=function(){return t(this.$pinia)},e),{})}function $n(n,e){return Array.isArray(e)?e.reduce((t,r)=>(t[r]=function(){return n(this.$pinia)[r]},t),{}):Object.keys(e).reduce((t,r)=>(t[r]=function(){const s=n(this.$pinia),i=e[r];return typeof i=="function"?i.call(this,s):s[i]},t),{})}function YI(n,e){return Array.isArray(e)?e.reduce((t,r)=>(t[r]=function(...s){return n(this.$pinia)[r](...s)},t),{}):Object.keys(e).reduce((t,r)=>(t[r]=function(...s){return n(this.$pinia)[e[r]](...s)},t),{})}function JI(n,e){return Array.isArray(e)?e.reduce((t,r)=>(t[r]={get(){return n(this.$pinia)[r]},set(s){return n(this.$pinia)[r]=s}},t),{}):Object.keys(e).reduce((t,r)=>(t[r]={get(){return n(this.$pinia)[e[r]]},set(s){return n(this.$pinia)[e[r]]=s}},t),{})}const ne=(n,e)=>{const t=n.__vccOpts||n;for(const[r,s]of e)t[r]=s;return t},Ox={name:"BurnableIcon"},Mx={version:"1.1",id:"Layer_1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512","xml:space":"preserve"},Lx=f("path",{style:{fill:"#ffb446"},d:`M97.103,353.103C97.103,440.86,168.244,512,256,512l0,0c87.756,0,158.897-71.14,158.897-158.897\r
                    ...
                    C141.241,247.172,97.103,273.655,97.103,353.103z`},null,-1),Fx=f("path",{style:{fill:"#ffdc64"},d:`M370.696,390.734c0,66.093-51.033,122.516-117.114,121.241\r
                    c-62.188-1.198-108.457-48.514-103.512-110.321c2.207-27.586,23.172-72.276,57.379-117.517l22.805,13.793\r
                    C229.517,242.023,256,167.724,256,167.724C273.396,246.007,370.696,266.298,370.696,390.734z`},null,-1),Ux=f("path",{style:{fill:"#ffffff"},d:`M211.862,335.448c-8.828,52.966-26.483,72.249-26.483,105.931C185.379,476.69,216.998,512,256,512\r
                    ...
                    C236.141,345.385,211.862,335.448,211.862,335.448z`},null,-1),Bx=[Lx,Fx,Ux];function $x(n,e,t,r,s,i){return w(),D("svg",Mx,Bx)}const yp=ne(Ox,[["render",$x]]),qx={name:"CanIcon"},jx={version:"1.1",id:"Layer_1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"25 0 450 550","xml:space":"preserve"},zx=Wn(`<rect x="98.22" y="99.265" style="fill:#ff7058;" width="305.11" height="350.041"></rect><path style="fill:#f2f2f2;" d="M375.118,0H126.433c-6.269,0-11.494,5.224-11.494,11.494s5.224,11.494,11.494,11.494h248.686\r
                        ...
                        "></polygon><path style="fill:#cdd6e0;" d="M375.118,39.706L375.118,39.706H126.433l0,0l7.314-15.673h234.057L375.118,39.706z"></path><g><path style="fill:#ffffff;" d="M403.331,117.029v26.122C293.616,185.992,204.8,291.527,98.22,344.816v-27.167\r
                            ...
                            C207.935,362.58,296.751,257.045,403.331,204.8z"></path></g><polygon style="fill:#e2e2e2;" points="98.22,449.306 119.118,501.551 382.433,501.551 403.331,449.306 "></polygon>`,6),Gx=[zx];function Kx(n,e,t,r,s,i){return w(),D("svg",jx,Gx)}const vp=ne(qx,[["render",Kx]]),Hx={name:"CardboardIcon"},Wx={version:"1.1",id:"_x35_",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"-30 0 500 500","xml:space":"preserve"},Qx=Wn(`<g><g><polygon style="fill:#cda23a;" points="0.012,131.343 0.012,380.658 232.514,511.988 232.514,0.012 		"></polygon><polygon style="fill:#c0932f;" points="465.028,131.343 465.028,380.658 385.355,425.679 311.716,467.268 232.514,512 232.514,0 \r
                        ...
                        465.028,380.658 465.028,131.343 	"></polygon></g>`,1),Yx=[Qx];function Jx(n,e,t,r,s,i){return w(),D("svg",Wx,Yx)}const Ip=ne(Hx,[["render",Jx]]),Xx={name:"GlassIcon"},Zx={version:"1.1",id:"_x36_",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"-110 0 400 500","xml:space":"preserve"},eP=Wn(`<g><linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="82.421" y1="512" x2="82.421" y2="-64.642"><stop offset="0" style="stop-color:#938070;"></stop><stop offset="0.7635" style="stop-color:#b08b6e;"></stop></linearGradient><path style="opacity:0.9;fill:#938070;" d="M164.003,308.394c-0.137,17.292-0.137,40.145-0.069,63.545\r
                    ...
                    C153.64,220.35,165.444,246.222,163.522,283.209z"></path></g>`,1),tP=[eP];function nP(n,e,t,r,s,i){return w(),D("svg",Zx,tP)}const wp=ne(Xx,[["render",nP]]),rP={name:"PETIcon"},sP={version:"1.1",id:"Layer_1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512","xml:space":"preserve"},iP=Wn(`<path style="fill:#e4eaf8;" d="M341.423,126.564l-55.45-62.381c-2.783-3.131-4.319-7.173-4.319-11.362V33.67h-51.307v19.151\r
        ...
        V16.34h54.267v148.021c0,4.512,3.657,8.17,8.17,8.17h211.336c4.513,0,8.17-3.658,8.17-8.17V16.34h54.267V487.289z"></path>`,7),hP=[uP];function dP(n,e,t,r,s,i){return w(),D("svg",lP,hP)}const Tp=ne(cP,[["render",dP]]),fP={name:"ThrowAwayIcon"},pP={version:"1.1",id:"_x32_",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512","xml:space":"preserve"},mP=Wn(`<g><path class="st0" d="M168.299,86.264c23.815,0,43.127-19.304,43.127-43.128C211.426,19.312,192.114,0,168.299,0\r
			...
			448.333,512 471.003,297.636 	"></polygon></g>`,1),gP=[mP];function _P(n,e,t,r,s,i){return w(),D("svg",pP,gP)}const bp=ne(fP,[["render",_P]]),yP={name:"AppGarbageDayWeek",props:["day","today"],components:{BurnableIcon:yp,CanIcon:vp,CardboardIcon:Ip,GlassIcon:wp,PETIcon:Ep,PlasticIcon:Tp,ThrowAwayIcon:bp}},vP={class:"relative text-center top-3"},IP={key:6,class:"flex flex-row justify-center items-center align-middle tracking-widest"};function wP(n,e,t,r,s,i){const o=K("BurnableIcon"),a=K("CanIcon"),c=K("CardboardIcon"),l=K("GlassIcon"),u=K("PETIcon"),h=K("PlasticIcon"),d=K("ThrowAwayIcon");return w(),D("div",{class:he(["flex flex-row justify-center w-full h-14 mt-3 rounded-full border-4",{" border-red-800":t.day.id===t.today," border-sky-700":t.day.id!==t.today}])},[f("div",{class:he(["w-1/6 h-full rounded-l-full text-slate-50 font-montserrat font-bold text-md",{"bg-red-500 ":t.day.id===t.today,"bg-sky-400 ":t.day.id!==t.today}])},[f("p",vP,_e(t.day.text),1)],2),f("div",{class:he(["flex flex-row justify-around w-4/6 h-full py-1 px-3 bg-opacity-90",{"bg-red-50 ":t.day.id===t.today,"bg-sky-50":t.day.id!==t.today}])},[t.day.icon.includes("Burn")?(w(),ge(o,{key:0,height:"100%"})):oe("",!0),t.day.icon.includes("Can")?(w(),ge(a,{key:1,height:"100%"})):oe("",!0),t.day.icon.includes("Cardboard")?(w(),ge(c,{key:2,height:"100%"})):oe("",!0),t.day.icon.includes("Glass")?(w(),ge(l,{key:3,height:"100%"})):oe("",!0),t.day.icon.includes("PET")?(w(),ge(u,{key:4,height:"100%"})):oe("",!0),t.day.icon.includes("Plastic")?(w(),ge(h,{key:5,height:"100%"})):oe("",!0),t.day.id===0?(w(),D("div",IP,[f("p",{class:he(["font-montserrat capitalize italic font-bold text-center text-xl text-sky-900",{"text-red-950":t.today===0}])}," Team change ! ",2)])):oe("",!0)],2),f("div",{class:he(["flex justify-center items-center h-full w-1/6 px-2 rounded-r-full",{"bg-red-400 ":t.day.id===t.today,"bg-sky-300 0":t.day.id!==t.today}])},[t.day.icon.includes("Throw")?(w(),ge(d,{key:0,height:"80%"})):oe("",!0)],2)],2)}const EP=ne(yP,[["render",wP]]),TP={name:"AppGarbageExplanation",components:{BurnableIcon:yp,CanIcon:vp,CardboardIcon:Ip,GlassIcon:wp,PETIcon:Ep,PlasticIcon:Tp,ThrowAwayIcon:bp},props:{toggle:Function}},bP={class:"flex flex-row w-full h-full"},AP={class:"flex flex-col justify-around items-start w-3/6 px-1"},RP={class:"flex flex-row justify-around items-center w-full h-1/4"},SP=f("p",{class:"w-3/4"},"Can",-1),xP={class:"flex flex-row justify-around items-center w-full h-1/4"},PP=f("p",{class:"w-3/4"},"Burnable",-1),CP={class:"flex flex-row justify-around items-center w-full h-1/4"},kP=f("p",{class:"w-3/4"},"Cardboard",-1),DP={class:"flex flex-col justify-around items-start w-3/6 px-1"},NP={class:"flex flex-row justify-around items-center w-full h-1/4"},VP=f("p",{class:"w-3/4"},"Glass",-1),OP={class:"flex flex-row justify-around items-center w-full h-1/4"},MP=f("p",{class:"w-3/4"},"PET",-1),LP={class:"flex flex-row justify-around items-center w-full h-1/4"},FP=f("p",{class:"w-3/4"},"Plastic",-1),UP={class:"w-full h-full px-7"},BP={class:"flex flex-row justify-around items-center h-full"},$P=f("p",{class:"w-5/6"},"Take the garbage out",-1);function qP(n,e,t,r,s,i){const o=K("CanIcon"),a=K("BurnableIcon"),c=K("CardboardIcon"),l=K("GlassIcon"),u=K("PETIcon"),h=K("PlasticIcon"),d=K("ThrowAwayIcon");return w(),D("div",{class:"flex flex-col w-5/6 h-fit absolute left-1/2 top-1/2 transform -translate-x-1/2 z-10 p-1 border-4 rounded-2xl border-slate-500 bg-slate-50 bg-opacity-90 text-lg text-emerald-950 font-montserrat font-semibold text-center",onClick:e[0]||(e[0]=Wt((...m)=>t.toggle&&t.toggle(...m),["prevent"]))},[f("div",bP,[f("div",AP,[f("div",RP,[ae(o,{class:"w-1/4",height:"100%"}),SP]),f("div",xP,[ae(a,{class:"w-1/4",height:"100%"}),PP]),f("div",CP,[ae(c,{class:"w-1/4",height:"100%"}),kP])]),f("div",DP,[f("div",NP,[ae(l,{class:"w-1/4",height:"100%"}),VP]),f("div",OP,[ae(u,{class:"w-1/4",height:"100%"}),MP]),f("div",LP,[ae(h,{class:"w-1/4",height:"100%"}),FP])])]),f("div",UP,[f("div",BP,[ae(d,{class:"w-1/6",height:"100%"}),$P])])])}const jP=ne(TP,[["render",qP]]),zP={name:"RobotIcon"},GP={version:"1.1",id:"Layer_1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512.001 512.001","xml:space":"preserve"},KP=Wn(`<circle style="fill:#f7a872;" cx="256.208" cy="30.844" r="22.45"></circle><path style="fill:#e88158;" d="M305.292,155.633c0-27.106-21.974-49.08-49.08-49.08s-49.08,21.974-49.08,49.08"></path><path style="fill:#d37250;" d="M256.212,106.553c-9.947,0-17.996,21.977-17.996,49.08h-31.084\r
	...
	C342.776,208.221,305.183,170.63,258.976,170.63z"></path>`,7),M9=[O9];function L9(n,e,t,r,s,i){return w(),D("svg",V9,M9)}const F9=ne(N9,[["render",L9]]),U9="/sponge.png",B9={name:"SpongeIcon"},$9={src:U9,alt:"Sponge icon"};function q9(n,e,t,r,s,i){return w(),D("img",$9)}const j9=ne(B9,[["render",q9]]),z9={name:"CleaningProductIcon"},G9={version:"1.1",id:"Layer_1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 494.4 494.4","xml:space":"preserve"},K9=Wn(`<path style="fill:#668b96;" d="M246.388,89.6c4,4,4,34.4,0,38.4l-50.4,26.4c-5.6,2.4-9.6,4-13.6,0l0,0c-4-4-4-9.6,0-13.6l50.4-50.4\r
	...
	c0-10.4,7.2-19.2,17.6-19.2h69.6c10.4,0,16.8,8,16.8,19.2V440z"></path><path style="fill:#4db20d;" d="M335.188,230.4V440c0,10.4-6.4,22.4-16.8,22.4h-69.6c-10.4,0-17.6-12-17.6-22.4V230.4"></path>`,14),H9=[K9];function W9(n,e,t,r,s,i){return w(),D("svg",G9,H9)}const Q9=ne(z9,[["render",W9]]),Y9={name:"ToiletPaperIcon"},J9={version:"1.1",id:"Layer_1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512","xml:space":"preserve"},X9=f("polyline",{style:{fill:"#c7c5cc"},points:`86.724,334.013 86.724,478.362 126.185,441.008 177.293,478.362 236.731,441.008 \r
	298.116,478.362 358.19,441.008 412.885,478.362 462.442,441.008 512,478.362 512,181.454 `},null,-1),Z9=f("path",{style:{fill:"#f8f8f8"},d:"M423.251,333.36H87.08C38.987,333.36,0,266.266,0,183.501S38.987,33.642,87.08,33.642h336.171"},null,-1),eC=f("ellipse",{style:{fill:"#e1e1e4"},cx:"424.913",cy:"183.498",rx:"87.085",ry:"149.86"},null,-1),tC=f("path",{style:{fill:"#c7c5cc"},d:`M426.27,112.955c-25.238,0-45.005,30.988-45.005,70.546s19.769,70.546,45.005,70.546\r
	s45.007-30.988,45.007-70.546S451.508,112.955,426.27,112.955z M426.27,234.883c-12.223,0-25.843-21.103-25.843-51.384\r
	s13.62-51.384,25.843-51.384c12.224,0,25.845,21.103,25.845,51.384S438.494,234.883,426.27,234.883z`},null,-1),nC=[X9,Z9,eC,tC];function rC(n,e,t,r,s,i){return w(),D("svg",J9,nC)}const sC=ne(Y9,[["render",rC]]),iC="/kitchen-paper.png",oC={name:"KitchenPaperIcon"},aC={src:iC,alt:"kitchen paper icon"};function cC(n,e,t,r,s,i){return w(),D("img",aC)}const lC=ne(oC,[["render",cC]]),uC={name:"AppGroceryItemButton",data(){return{toggleConfirm:!1,toggleOrderOk:!1}},methods:{sendAlertItem(n){this.toggleConfirm=!1,console.log("Sending alert for",n)},toggleItemOrderedScreen(){this.toggleOrderOk=!0,setTimeout(()=>{this.toggleOrderOk=!1},2e3)},isScreenHeightLessThan670(){return window.innerHeight<670},isScreenHeightGreaterThanOrEqualTo670(){return window.innerHeight>=670}},components:{TinFoilIcon:_9,PlasticBagsIcon:E9,DishSoapIcon:S9,PlasticWrapIcon:D9,ToiletPaperIcon:sC,SoapIcon:F9,SpongeIcon:j9,CleaningProductIcon:Q9,KitchenPaperIcon:lC},props:["category"]},hC={class:"mt-2 text-sm"},dC={class:"absolute flex flex-col items-center justify-around z-1 h-full w-full p-1 border-4 border-yellow-600 rounded-xl bg-slate-50 bg-opacity-90 font-montserrat text-cyan-900"},fC={class:"text-green-500"},pC={class:"flex flex-row justify-around items-center w-full h-2/6"},mC={class:"absolute flex flex-col items-center justify-around z-1 h-full w-full p-1 rounded-xl bg-sky-500 bg-opacity-90 font-montserrat text-white text-3xl"};function gC(n,e,t,r,s,i){const o=K("TinFoilIcon"),a=K("PlasticBagsIcon"),c=K("DishSoapIcon"),l=K("PlasticWrapIcon"),u=K("ToiletPaperIcon"),h=K("SoapIcon"),d=K("SpongeIcon"),m=K("CleaningProductIcon"),E=K("KitchenPaperIcon");return w(),D("div",{class:"relative flex flex-col items-center justify-center w-2/5 h-fit my-2 p-1.5 border-4 border-emerald-800 rounded-2xl bg-teal-400 font-montserrat font-bold text-slate-50 text-center shadow-lg shadow-cyan-500",onClick:e[2]||(e[2]=Wt(v=>s.toggleConfirm=!0,["prevent"]))},[t.category==="Tin Foil"?(w(),ge(o,{key:0,class:"w-5/6"})):oe("",!0),t.category==="Plastic Bags"?(w(),ge(a,{key:1,class:"w-4/6"})):oe("",!0),t.category==="Dish Soap"?(w(),ge(c,{key:2,class:"w-4/6"})):oe("",!0),t.category==="Plastic Wrap"?(w(),ge(l,{key:3,class:"w-4/6"})):oe("",!0),t.category==="Toilet Paper"?(w(),ge(u,{key:4,class:"w-4/6"})):oe("",!0),t.category==="Hand Soap"?(w(),ge(h,{key:5,class:"w-4/6"})):oe("",!0),t.category==="Sponge"?(w(),ge(d,{key:6,class:"w-4/6"})):oe("",!0),t.category==="Cleaning Product"?(w(),ge(m,{key:7,class:"w-4/6"})):oe("",!0),t.category==="Kitchen Paper"?(w(),ge(E,{key:8,class:"w-4/6"})):oe("",!0),f("p",hC,_e(t.category),1),Oe(f("div",dC,[f("p",{class:he(["",{"text-sm":i.isScreenHeightLessThan670(),"text-md":i.isScreenHeightGreaterThanOrEqualTo670()}])},[Ie(" Order "),f("span",fC,_e(t.category),1),Ie(" ? ")],2),f("div",pC,[f("div",{class:"flex justify-center items-center h-full w-2/5 border-4 border-red-900 rounded-2xl bg-red-600 text-red-800",onClick:e[0]||(e[0]=Wt(v=>s.toggleConfirm=!1,["stop"]))}," x "),f("div",{class:"flex justify-center items-center h-full w-2/5 border-4 border-emerald-600 rounded-2xl bg-emerald-500 text-green-800",onClick:e[1]||(e[1]=Wt(v=>(i.sendAlertItem(t.category),i.toggleItemOrderedScreen()),["stop"]))}," o ")])],512),[[sl,s.toggleConfirm]]),Oe(f("div",mC," Done ! ",512),[[sl,s.toggleOrderOk]])])}const _C=ne(uC,[["render",gC]]),yC={name:"AppGroceriesExplanation",methods:{isScreenHeightLessThan670(){return window.innerHeight<670},isScreenHeightGreaterThanOrEqualTo670(){return window.innerHeight>=670}},components:{},props:{toggle:Function}};function vC(n,e,t,r,s,i){return w(),D("div",{class:"flex flex-col w-5/6 h-fit absolute left-1/2 top-1/2 transform -translate-x-1/2 z-10 p-1 border-4 rounded-2xl border-slate-500 bg-slate-50 bg-opacity-95 text-emerald-950 font-montserrat",onClick:e[0]||(e[0]=Wt((...o)=>t.toggle&&t.toggle(...o),["prevent"]))},[f("div",{class:he(["flex flex-col justify-start items-start w-full h-full py-1 font-bold",{"px-1":i.isScreenHeightLessThan670(),"px-3":i.isScreenHeightGreaterThanOrEqualTo670()}])},[f("p",{class:he(["",{"text-lg mb-2":i.isScreenHeightLessThan670(),"text-xl mb-3":i.isScreenHeightGreaterThanOrEqualTo670()}])}," Need to buy something ? ",2),f("p",{class:he(["italic",{"text-sm mb-2":i.isScreenHeightLessThan670(),"mb-3":i.isScreenHeightGreaterThanOrEqualTo670()}])}," Let the duo on duty know that they have to buy those items by... ",2),f("p",{class:he(["",{"text-sm ml-2":i.isScreenHeightLessThan670(),"text-md ml-3":i.isScreenHeightGreaterThanOrEqualTo670()}])},[f("span",{class:he(["text-emerald-700",{"text-md":i.isScreenHeightLessThan670(),"text-xl":i.isScreenHeightGreaterThanOrEqualTo670()}])},"1. ",2),Ie("Pressing the desired item button ")],2),f("p",{class:he(["",{"text-sm ml-2":i.isScreenHeightLessThan670(),"text-md ml-3":i.isScreenHeightGreaterThanOrEqualTo670()}])},[f("span",{class:he(["text-purple-700",{"text-md":i.isScreenHeightLessThan670(),"text-xl":i.isScreenHeightGreaterThanOrEqualTo670()}])},"2. ",2),Ie("Confirming your choice ")],2),f("p",{class:he(["",{"text-sm ml-2":i.isScreenHeightLessThan670(),"text-md ml-3":i.isScreenHeightGreaterThanOrEqualTo670()}])},[f("span",{class:he(["text-sky-600",{"text-md":i.isScreenHeightLessThan670(),"text-xl":i.isScreenHeightGreaterThanOrEqualTo670()}])},"3. ",2),Ie("Done ! ")],2)],2)])}const IC=ne(yC,[["render",vC]]),wC={name:"AppChoresGroceries",data(){return{toggleExplanation:!1,categories:["Toilet Paper","Dish Soap","Hand Soap","Plastic Bags","Plastic Wrap","Tin Foil","Kitchen Paper","Sponge","Cleaning Product"]}},methods:{isScreenHeightLessThan670(){return window.innerHeight<670},isScreenHeightGreaterThanOrEqualTo670(){return window.innerHeight>=670},closeTabExp(){this.toggleExplanation=!1}},computed:{...$n(Ui,["listRooms","duoRoomsGroceries"]),...$n(Ap,["monthIDs","getDateToday"])},components:{RobotIcon:XI,AppGroceryItemButton:_C,AppGroceriesExplanation:IC}},EC={class:"flex flex-row h-28 items-center justify-center mt-4 px-2 bg-slate-50 bg-opacity-50 border-2 border-emerald-500 rounded-xl font-montserrat"},TC={class:"flex flex-col mr-2"},bC={class:"my-1 text-emerald-700 opacity-60"},AC={class:"font-bold"},RC={class:"font-bold"},SC={class:"text-lg text-emerald-800"},xC={class:"font-bold"},PC={class:"font-bold"},CC={class:"my-1 text-emerald-700 opacity-60"},kC={class:"font-bold"},DC={class:"font-bold"},NC={class:"flex justify-end pr-8 mt-2 w-full"},VC=f("p",{class:"relative top-0.5 font-montserrat font-bold text-3xl text-slate-700"},"?",-1),OC=[VC],MC={class:"relative w-full"};function LC(n,e,t,r,s,i){const o=K("RobotIcon"),a=K("AppGroceriesExplanation"),c=K("AppGroceryItemButton");return w(),D(De,null,[f("div",EC,[f("div",TC,[f("p",bC,[Ie(" Last month: "),f("span",AC,_e(n.listRooms[n.duoRoomsGroceries[n.monthIDs.lastMonthID][0]].residentName),1),Ie(" & "),f("span",RC,_e(n.listRooms[n.duoRoomsGroceries[n.monthIDs.lastMonthID][1]].residentName),1)]),f("p",SC,[Ie(" This month: "),f("span",xC,_e(n.listRooms[n.duoRoomsGroceries[n.monthIDs.thisMonthID][0]].residentName),1),Ie(" & "),f("span",PC,_e(n.listRooms[n.duoRoomsGroceries[n.monthIDs.thisMonthID][1]].residentName),1)]),f("p",CC,[Ie(" Next month: "),f("span",kC,_e(n.listRooms[n.duoRoomsGroceries[n.monthIDs.nextMonthID][0]].residentName),1),Ie(" & "),f("span",DC,_e(n.listRooms[n.duoRoomsGroceries[n.monthIDs.nextMonthID][1]].residentName),1)])]),ae(o,{height:"70%"})]),f("div",NC,[f("div",{class:"h-10 w-10 border-2 border-slate-400 rounded-full bg-slate-300 text-center active:scale-95",onClick:e[0]||(e[0]=Wt(l=>s.toggleExplanation=!s.toggleExplanation,["prevent"]))},OC)]),Oe(f("div",MC,[ae(a,{toggle:i.closeTabExp},null,8,["toggle"])],512),[[sl,s.toggleExplanation===!0]]),f("div",{class:he(["flex flex-row flex-wrap justify-around w-5/6 p-2 rounded-2xl bg-sky-100 bg-opacity-60 border-2 border-teal-500 overflow-y-auto",{"h-52":i.isScreenHeightLessThan670(),"h-96":i.isScreenHeightGreaterThanOrEqualTo670()}])},[(w(!0),D(De,null,Bn(s.categories,l=>(w(),ge(c,{key:l,category:l},null,8,["category"]))),128))],2)],64)}const FC=ne(wC,[["render",LC]]);const UC={name:"AutoScrollText"},BC={class:"scrolling-text-container w-full"},$C={class:"scrolling-text w-full"};function qC(n,e,t,r,s,i){return w(),D("div",BC,[f("div",$C,[wS(n.$slots,"content")])])}const jC=ne(UC,[["render",qC]]),zC={name:"AppChores",data(){return{choreTab:"Garbage",daysWeek:[{text:"Sun",id:0,icon:[],nextAction:{day:"Tomorrow night",type:["Burn"]}},{text:"Mon",id:1,icon:["Throw"],nextAction:{day:"Tonight",type:["Burn"]}},{text:"Tue",id:2,icon:["Burn"],nextAction:{day:"Tomorrow night",type:["Plastic","PET","Glass","Can","Cardboard","Throw"]}},{text:"Wed",id:3,icon:["Throw"],nextAction:{day:"Tonight",type:["Plastic","PET","Glass","Can","Cardboard","Throw"]}},{text:"Thu",id:4,icon:["Plastic","PET","Glass","Can","Cardboard","Throw"],nextAction:{day:"Tonight",type:["Burn"]}},{text:"Fri",id:5,icon:["Burn"],nextAction:{day:"Monday night",type:["Burn"]}},{text:"Sat",id:6,icon:[],nextAction:{day:"Monday night",type:["Burn"]}}]}},computed:{getDateToday(){return new Date().getDay()+0}},components:{AppChoresGarbage:d9,AppChoresGroceries:FC,BurnableIcon:yp,CanIcon:vp,CardboardIcon:Ip,GlassIcon:wp,PETIcon:Ep,PlasticIcon:Tp,AutoScrollText:jC}},GC={class:"w-full"},KC={class:"flex flex-row justify-between w-full items-center h-8"},HC=f("p",{class:""},"Take out",-1),WC={class:"flex flex-row h-full"},QC={class:""},YC={class:"flex flex-row mx-5 justify-center text-center text-lg font-montserrat font-bold border-2 border-sky-800 rounded-full"},JC={class:"flex flex-col items-center"};function XC(n,e,t,r,s,i){const o=K("BurnableIcon"),a=K("CanIcon"),c=K("CardboardIcon"),l=K("GlassIcon"),u=K("PETIcon"),h=K("PlasticIcon"),d=K("AutoScrollText"),m=K("AppChoresGarbage"),E=K("AppChoresGroceries");return w(),D("div",GC,[ae(d,{class:"w-full py-2 mb-3 bg-white bg-opacity-80 text-teal-700 text-center text-lg font-montserrat font-bold"},{content:TI(()=>[f("div",KC,[HC,f("div",WC,[s.daysWeek[i.getDateToday].nextAction.type.includes("Burn")?(w(),ge(o,{key:0,height:"100%"})):oe("",!0),s.daysWeek[i.getDateToday].nextAction.type.includes("Can")?(w(),ge(a,{key:1,height:"100%"})):oe("",!0),s.daysWeek[i.getDateToday].nextAction.type.includes("Cardboard")?(w(),ge(c,{key:2,height:"100%"})):oe("",!0),s.daysWeek[i.getDateToday].nextAction.type.includes("Glass")?(w(),ge(l,{key:3,height:"100%"})):oe("",!0),s.daysWeek[i.getDateToday].nextAction.type.includes("PET")?(w(),ge(u,{key:4,height:"100%"})):oe("",!0),s.daysWeek[i.getDateToday].nextAction.type.includes("Plastic")?(w(),ge(h,{key:5,height:"100%"})):oe("",!0)]),f("p",QC,"before "+_e(s.daysWeek[i.getDateToday].nextAction.day),1)])]),_:1}),f("div",YC,[f("div",{class:he(["px-8 py-2 w-3/6 rounded-l-full",{"bg-sky-500 text-slate-50":s.choreTab==="Garbage","bg-slate-100 border-emerald-500 text-cyan-900":s.choreTab!=="Garbage"}]),onClick:e[0]||(e[0]=v=>s.choreTab="Garbage")}," Garbage ",2),f("div",{class:he(["px-8 py-2 w-3/6 rounded-r-full",{"bg-emerald-500 text-slate-50":s.choreTab==="Groceries","bg-slate-100 text-emerald-900":s.choreTab!=="Groceries"}]),onClick:e[1]||(e[1]=v=>s.choreTab="Groceries")}," Groceries ",2)]),f("div",JC,[s.choreTab==="Garbage"?(w(),ge(m,{key:0,daysWeek:s.daysWeek},null,8,["daysWeek"])):oe("",!0),s.choreTab==="Groceries"?(w(),ge(E,{key:1})):oe("",!0)])])}const ZC=ne(zC,[["render",XC]]),e7="/groceries.png",t7={name:"GroceriesIcon"},n7={src:e7,alt:"groceries img"};function r7(n,e,t,r,s,i){return w(),D("img",n7)}const s7=ne(t7,[["render",r7]]),i7={name:"AppRoom",computed:{...$n(Ui,["duoRoomsGarbage","duoRoomsGroceries"]),...$n(Ap,["weekIDs","monthIDs"])},props:["roomNumber","residentName","residentNameKanji","houseSelect"],components:{GroceriesIcon:s7,ThrowAwayIcon:bp}},o7={key:0},a7={class:"flex flex-col text-lg text-center w-3/6"},c7={class:"text-xl font-semibold tracking-wider"};function l7(n,e,t,r,s,i){const o=K("ThrowAwayIcon"),a=K("GroceriesIcon");return t.roomNumber.includes(t.houseSelect[0])?(w(),D("div",o7,[f("div",{class:he(["w-full h-16 px-1 mb-3 flex rounded-full items-center border-4 bg-white bg-opacity-70 font-montserrat",{" border-cyan-500 flex-row text-teal-700":t.houseSelect==="A house"," border-purple-500 flex-row-reverse text-violet-600":t.houseSelect==="B house"}])},[f("div",{class:he(["ml-3 mr-1 w-2/6 font-bold text-lg tracking-wider",{"text-left":t.houseSelect==="A house","text-right":t.houseSelect==="B house"}])},[f("p",null,_e(t.roomNumber),1)],2),f("div",a7,[f("p",c7,_e(t.residentName),1),f("p",null,_e(t.residentNameKanji),1)]),this.duoRoomsGarbage[this.weekIDs.thisWeekID].includes(this.roomNumber)?(w(),ge(o,{key:0,class:"h-4/6 mx-1 font-bold text-2xl text-red-500 text-center"})):oe("",!0),this.duoRoomsGroceries[this.monthIDs.thisMonthID].includes(this.roomNumber)?(w(),ge(a,{key:1,class:"h-4/6 mx-1 font-bold text-2xl text-green-500 text-center"})):oe("",!0)],2)])):oe("",!0)}const u7=ne(i7,[["render",l7]]),h7={name:"AppListRooms",data(){return{houseSelect:"A house"}},computed:{...$n(Ui,["listRooms"])},components:{AppRoom:u7}},d7=f("div",{class:"flex flex-col justify-center w-full py-3 text-center bg-teal-400/90 font-montserrat",style:{height:"10%"}},[f("h2",{class:"text-white text-3xl italic tracking-widest"},"Rooms")],-1),f7={class:"pt-3 mb-5 flex flex-row justify-around font-montserrat font-semibold"},p7={class:"mx-5 overflow-y-auto rounded-2xl",style:{height:"70%"}},m7={key:0},g7={key:1};function _7(n,e,t,r,s,i){const o=K("AppRoom");return w(),D(De,null,[d7,f("div",f7,[f("div",{class:he(["px-8 py-2 border-4 rounded-full",{"bg-teal-500 border-cyan-300 text-slate-50":s.houseSelect==="A house","bg-white bg-opacity-30 border-emerald-500 text-cyan-900":s.houseSelect==="B house"}]),onClick:e[0]||(e[0]=a=>s.houseSelect="A house")}," A House ",2),f("div",{class:he(["px-8 py-2 border-4 rounded-full",{"bg-purple-600 border-orange-600 text-slate-50":s.houseSelect==="B house","bg-white bg-opacity-30 border-purple-600 text-purple-700":s.houseSelect==="A house"}]),onClick:e[1]||(e[1]=a=>s.houseSelect="B house")}," B House ",2)]),f("div",p7,[s.houseSelect==="A house"?(w(),D("div",m7,[(w(!0),D(De,null,Bn(n.listRooms,a=>(w(),D("div",{key:a.roomNumber,class:""},[ae(o,{roomNumber:a.roomNumber,residentName:a.residentName,residentNameKanji:a.residentNameKanji,houseSelect:s.houseSelect},null,8,["roomNumber","residentName","residentNameKanji","houseSelect"])]))),128))])):s.houseSelect==="B house"?(w(),D("div",g7,[(w(!0),D(De,null,Bn(n.listRooms,a=>(w(),D("div",{key:a.roomNumber,class:""},[ae(o,{roomNumber:a.roomNumber,residentName:a.residentName,residentNameKanji:a.residentNameKanji,houseSelect:s.houseSelect},null,8,["roomNumber","residentName","residentNameKanji","houseSelect"])]))),128))])):oe("",!0)])],64)}const y7=ne(h7,[["render",_7]]),v7="/date.png",I7={name:"DateIcon"},w7={src:v7,alt:"date img"};function E7(n,e,t,r,s,i){return w(),D("img",w7)}const T7=ne(I7,[["render",E7]]),b7="/location.png",A7={name:"PlaceIcon"},R7={src:b7,alt:"place img"};function S7(n,e,t,r,s,i){return w(),D("img",R7)}const x7=ne(A7,[["render",S7]]),P7="/link.png",C7={name:"LinkIcon"},k7={src:P7,alt:"link img"};function D7(n,e,t,r,s,i){return w(),D("img",k7)}const N7=ne(C7,[["render",D7]]),V7="/user.png",O7={name:"UserIcon"},M7={src:V7,alt:"user img"};function L7(n,e,t,r,s,i){return w(),D("img",M7)}const F7=ne(O7,[["render",L7]]),U7="/edit-button.png",B7={name:"EditIcon"},$7={src:U7,alt:"edit button"};function q7(n,e,t,r,s,i){return w(),D("img",$7)}const j7=ne(B7,[["render",q7]]),z7="/x-button.png",G7={name:"DeleteIcon"},K7={src:z7,alt:"delete button"};function H7(n,e,t,r,s,i){return w(),D("img",K7)}const W7=ne(G7,[["render",H7]]),Q7="/event-bg-min.png",Y7={name:"EventCard",data(){return{triggerConfirmDelete:!1}},methods:{deleteEvent(){console.log("deleting event",this.event.id)}},props:["event","toggleEdit"],components:{DateIcon:T7,PlaceIcon:x7,LinkIcon:N7,UserIcon:F7,EditIcon:j7,DeleteIcon:W7}},J7={key:0,class:"flex flex-col justify-around items-center w-full h-44 px-1 py-1 border-t-2 bg-red-600/90 border-red-700"},X7=f("p",{class:"text-white text-2xl text-center"},"Are you sure you want to delete this event ?",-1),Z7={class:"w-full text-center text-2xl font-bold text-white"},ek={class:""},tk={class:"relative w-full h-full"},nk={key:0,src:Q7,class:"absolute -z-5 w-full h-full"},rk={key:1,class:"relative z-5 flex flex-col w-full h-44 px-1 py-1 border-t-2 bg-slate-100/90 border-violet-700"},sk={class:"relative w-full h-full"},ik={class:"absolute top-1 left-2"},ok={class:"h-1/6 w-full text-center text-xl font-bold text-purple-900"},ak={class:"flex flex-row w-full h-5/6 justify-around items-center"},ck={class:"flex flex-col justify-around w-2/5 h-full text-md font-bold text-violet-900"},lk={class:"flex flex-row items-center"},uk={class:"flex flex-col justify-center items-center w-full text-center"},hk={class:""},dk={class:""},fk={class:"flex flex-row items-center"},pk={class:"w-full text-center"},mk={class:"flex flex-row items-center"},gk={class:"w-full text-center"},_k={class:"flex flex-col justify-around items-center w-3/5 h-full px-1 py-2"},yk={class:"text-center italic text-sm font-medium h-3/5"},vk={class:"flex flex-col items-center w-full"},Ik=f("p",{class:"text-md font-bold"},"Links",-1),wk={class:"flex flex-row w-full h-fit justify-around"},Ek=["href"];function Tk(n,e,t,r,s,i){const o=K("EditIcon"),a=K("DeleteIcon"),c=K("DateIcon"),l=K("PlaceIcon"),u=K("UserIcon"),h=K("LinkIcon");return w(),D(De,null,[s.triggerConfirmDelete?(w(),D("div",J7,[X7,f("p",Z7,_e(t.event.title),1),f("div",ek,[f("button",{class:"px-3 mx-4 rounded-lg border-2 border-slate-100 bg-red-700 text-white text-xl",onClick:e[0]||(e[0]=(...d)=>i.deleteEvent&&i.deleteEvent(...d))}," Delete event "),f("button",{class:"px-3 mx-4 rounded-lg border-2 border-slate-100 bg-slate-500 text-white text-xl",onClick:e[1]||(e[1]=d=>s.triggerConfirmDelete=!s.triggerConfirmDelete)}," Keep event ")])])):oe("",!0),f("div",tk,[s.triggerConfirmDelete?oe("",!0):(w(),D("img",nk)),s.triggerConfirmDelete?oe("",!0):(w(),D("div",rk,[f("div",sk,[f("div",ik,[f("button",{class:"text-green-500 mx-3",onClick:e[2]||(e[2]=d=>t.toggleEdit())},[ae(o,{class:"h-6 w-6"})]),f("button",{class:"text-red-500 mx-3",onClick:e[3]||(e[3]=d=>s.triggerConfirmDelete=!s.triggerConfirmDelete)},[ae(a,{class:"h-6 w-6"})])]),f("p",ok,_e(t.event.title),1)]),f("div",ak,[f("div",ck,[f("div",lk,[ae(c,{class:"h-7 w-7 ml-1.5 mr-2"}),f("div",uk,[f("p",hk,_e(t.event.date.day),1),f("p",dk,_e(t.event.date.time),1)])]),f("div",fk,[ae(l,{class:"h-7 w-6 ml-3 mr-2"}),f("p",pk,_e(t.event.place),1)]),f("div",mk,[ae(u,{class:"h-7 w-7 ml-2 mr-2"}),f("p",gk,_e(t.event.author),1)])]),f("div",_k,[f("p",yk,_e(t.event.description),1),f("div",vk,[Ik,f("div",wk,[(w(!0),D(De,null,Bn(t.event.links,d=>(w(),D("div",{key:d},[f("a",{href:d,target:"_blank"},[ae(h,{class:"h-8 w-8"})],8,Ek)]))),128))])])])])]))])],64)}const bk=ne(Y7,[["render",Tk]]),Ak={name:"EventNewForm",data(){return{author:"",title:"",description:"",date:{day:"",time:""},place:"",links:[],link1:"",link2:"",link3:""}},methods:{createNewEvent(){const n={author:this.author,title:this.title,description:this.description,date:{day:this.date.day,time:this.date.time},place:this.place,links:[this.link1,this.link2,this.link3]};console.log(n)}}},Rk={class:"flex flex-col items-center w-full"},Sk=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},[f("span",{class:"text-red-600"},"* "),Ie("Title :")],-1),xk={class:"flex flex-col items-center w-full"},Pk=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},"Description :",-1),Ck={class:"flex flex-col items-center w-full"},kk=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},[f("span",{class:"text-red-600"},"* "),Ie("Location :")],-1),Dk={class:"flex flex-row w-full justify-around"},Nk={class:"flex flex-col items-center w-3/6"},Vk=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},[f("span",{class:"text-red-600"},"* "),Ie("Day :")],-1),Ok={class:"flex flex-col items-center w-3/6"},Mk=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},[f("span",{class:"text-red-600"},"* "),Ie("Time :")],-1),Lk={class:"flex flex-col items-center w-full"},Fk=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},"Links :",-1),Uk={class:"flex flex-col items-center w-full"},Bk=f("label",{class:"font-bold text-md text-slate-800"},"Link 1",-1),$k=f("label",{class:"font-bold text-md text-slate-800"},"Link 2",-1),qk=f("label",{class:"font-bold text-md text-slate-800"},"Link 3",-1),jk=f("button",{type:"submit",class:"mt-5 px-8 py-2 bg-yellow-500/95 border-4 border-yellow-600 rounded-full text-slate-100 text-xl"}," Create new event ",-1);function zk(n,e,t,r,s,i){return w(),D("form",{onSubmit:e[8]||(e[8]=Wt((...o)=>i.createNewEvent&&i.createNewEvent(...o),["prevent"])),class:"h-full w-full flex flex-col justify-start items-center py-3 px-6 text-center overflow-y-auto over"},[f("div",Rk,[Sk,Oe(f("input",{type:"text",class:"w-4/5 rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-4 focus:ring-sky-400","onUpdate:modelValue":e[0]||(e[0]=o=>s.title=o),placeholder:"Hiking day",required:""},null,512),[[it,s.title]])]),f("div",xk,[Pk,Oe(f("textarea",{class:"w-4/5 h-24 rounded-xl px-4 py-2 outline-none border-2 border-cyan-700 focus:ring-4 focus:ring-sky-400","onUpdate:modelValue":e[1]||(e[1]=o=>s.description=o),placeholder:"Let's go to the mountain ! "},null,512),[[it,s.description]])]),f("div",Ck,[kk,Oe(f("input",{type:"text",class:"w-4/5 rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-4 focus:ring-sky-400","onUpdate:modelValue":e[2]||(e[2]=o=>s.place=o),placeholder:"Mt Oyama",required:""},null,512),[[it,s.place]])]),f("div",Dk,[f("div",Nk,[Vk,Oe(f("input",{type:"date",class:"w-5/6 text-center rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-4 focus:ring-sky-400","onUpdate:modelValue":e[3]||(e[3]=o=>s.date.day=o),required:""},null,512),[[it,s.date.day]])]),f("div",Ok,[Mk,Oe(f("input",{type:"time",class:"w-5/6 text-center rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-4 focus:ring-sky-400","onUpdate:modelValue":e[4]||(e[4]=o=>s.date.time=o),required:""},null,512),[[it,s.date.time]])])]),f("div",Lk,[Fk,f("div",Uk,[Bk,Oe(f("input",{type:"text",class:"w-3/5 rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-2 focus:ring-sky-400","onUpdate:modelValue":e[5]||(e[5]=o=>s.link1=o),placeholder:"Insert URL here"},null,512),[[it,s.link1]]),$k,Oe(f("input",{type:"text",class:"w-3/5 rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-2 focus:ring-sky-400","onUpdate:modelValue":e[6]||(e[6]=o=>s.link2=o),placeholder:"Insert URL here"},null,512),[[it,s.link2]]),qk,Oe(f("input",{type:"text",class:"w-3/5 rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-2 focus:ring-sky-400","onUpdate:modelValue":e[7]||(e[7]=o=>s.link3=o),placeholder:"Insert URL here"},null,512),[[it,s.link3]])])]),jk],32)}const Gk=ne(Ak,[["render",zk]]),Kk={name:"EventEditForm",mounted(){console.log("getting db information")},data(){return{id:"",author:"",title:"",description:"",date:{day:"",time:""},place:"",links:[],link1:"",link2:"",link3:""}},methods:{EditEvent(){const n={author:this.author,title:this.title,description:this.description,date:{day:this.date.day,time:this.date.time},place:this.place,links:[this.link1,this.link2,this.link3]};console.log(n)}}},Hk={class:"flex flex-col items-center w-full"},Wk=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},[f("span",{class:"text-red-600"},"* "),Ie("Title :")],-1),Qk={class:"flex flex-col items-center w-full"},Yk=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},"Description :",-1),Jk={class:"flex flex-col items-center w-full"},Xk=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},[f("span",{class:"text-red-600"},"* "),Ie("Location :")],-1),Zk={class:"flex flex-row w-full justify-around"},eD={class:"flex flex-col items-center w-3/6"},tD=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},[f("span",{class:"text-red-600"},"* "),Ie("Day :")],-1),nD={class:"flex flex-col items-center w-3/6"},rD=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},[f("span",{class:"text-red-600"},"* "),Ie("Time :")],-1),sD={class:"flex flex-col items-center w-full"},iD=f("label",{class:"font-bold text-xl text-slate-800 mb-1"},"Links :",-1),oD={class:"flex flex-col items-center w-full"},aD=f("label",{class:"font-bold text-md text-slate-800"},"Link 1",-1),cD=f("label",{class:"font-bold text-md text-slate-800"},"Link 2",-1),lD=f("label",{class:"font-bold text-md text-slate-800"},"Link 3",-1),uD=f("button",{type:"submit",class:"mt-5 px-8 py-2 bg-teal-500/95 border-4 border-teal-600 rounded-full text-slate-100 text-xl"}," Edit event ",-1);function hD(n,e,t,r,s,i){return w(),D("form",{onSubmit:e[8]||(e[8]=Wt((...o)=>i.EditEvent&&i.EditEvent(...o),["prevent"])),class:"h-full w-full flex flex-col justify-start items-center py-3 px-6 text-center overflow-y-auto"},[f("div",Hk,[Wk,Oe(f("input",{type:"text",class:"w-4/5 rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-4 focus:ring-sky-400","onUpdate:modelValue":e[0]||(e[0]=o=>s.title=o),placeholder:"Hiking day",required:""},null,512),[[it,s.title]])]),f("div",Qk,[Yk,Oe(f("textarea",{class:"w-4/5 h-24 rounded-xl px-4 py-2 outline-none border-2 border-cyan-700 focus:ring-4 focus:ring-sky-400","onUpdate:modelValue":e[1]||(e[1]=o=>s.description=o),placeholder:"Let's go to the mountain ! "},null,512),[[it,s.description]])]),f("div",Jk,[Xk,Oe(f("input",{type:"text",class:"w-4/5 rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-4 focus:ring-sky-400","onUpdate:modelValue":e[2]||(e[2]=o=>s.place=o),placeholder:"Mt Oyama",required:""},null,512),[[it,s.place]])]),f("div",Zk,[f("div",eD,[tD,Oe(f("input",{type:"date",class:"w-5/6 text-center rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-4 focus:ring-sky-400","onUpdate:modelValue":e[3]||(e[3]=o=>s.date.day=o),required:""},null,512),[[it,s.date.day]])]),f("div",nD,[rD,Oe(f("input",{type:"time",class:"w-5/6 text-center rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-4 focus:ring-sky-400","onUpdate:modelValue":e[4]||(e[4]=o=>s.date.time=o),required:""},null,512),[[it,s.date.time]])])]),f("div",sD,[iD,f("div",oD,[aD,Oe(f("input",{type:"text",class:"w-3/5 rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-2 focus:ring-sky-400","onUpdate:modelValue":e[5]||(e[5]=o=>s.link1=o),placeholder:"Insert URL here"},null,512),[[it,s.link1]]),cD,Oe(f("input",{type:"text",class:"w-3/5 rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-2 focus:ring-sky-400","onUpdate:modelValue":e[6]||(e[6]=o=>s.link2=o),placeholder:"Insert URL here"},null,512),[[it,s.link2]]),lD,Oe(f("input",{type:"text",class:"w-3/5 rounded-full px-4 py-1 outline-none border-2 border-cyan-700 focus:ring-2 focus:ring-sky-400","onUpdate:modelValue":e[7]||(e[7]=o=>s.link3=o),placeholder:"Insert URL here"},null,512),[[it,s.link3]])])]),uD],32)}const dD=ne(Kk,[["render",hD]]),fD={name:"AppEventPlanner",data(){return{eventTab:"list",events:[{id:"0001",title:"Beach day",author:"Florian",date:{day:"2023/08/13",time:"12:30"},place:"Zushi",description:"Let's go to the beach ! Do not forget to bring your suncream and swimming suit !",links:["https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu","https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu","https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu"]},{id:"0002",title:"Hiking day",author:"Florian",date:{day:"2023/08/13",time:"12:30"},place:"Mt Fuji",description:"Let's go to the beach ! Do not forget to bring your suncream and swimming suit !",links:["https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu","https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu","https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu","https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu","https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu"]},{id:"0003",title:"Skydiving",author:"Siyun",date:{day:"2023/08/13",time:"12:30"},place:"Chiba",description:"Let's go to the beach ! Do not forget to bring your suncream and swimming suit !",links:["https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu","https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu","https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu"]},{id:"0004",title:"Camping",author:"Yusei",date:{day:"2023/08/13",time:"12:30"},place:"Okutama",description:"Let's go to the beach ! Do not forget to bring your suncream and swimming suit !",links:["https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu","https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu","https://www.google.com/maps/place/Zushi+Beach/@35.2918785,139.562345,15z/data=!3m1!4b1!4m6!3m5!1s0x601846f4dd02697f:0xe9deb104bdb63dd8!8m2!3d35.2918619!4d139.5726447!16s%2Fg%2F122nzdn0?entry=ttu"]}]}},methods:{toggleEdit(){this.eventTab="edit"}},components:{EventCard:bk,EventNewForm:Gk,EventEditForm:dD}},pD={class:"w-full h-full font-montserrat"},mD={key:0,class:"text-white text-3xl italic tracking-widest"},gD={key:1,class:"text-white text-3xl italic tracking-widest"},_D={key:2,class:"text-white text-3xl italic tracking-widest"},yD=f("p",{class:"relative"},"+",-1),vD=[yD],ID=f("p",{class:"relative font-bold"},"⬅",-1),wD=[ID],ED={key:0,class:"w-full",style:{height:"90%"}},TD={key:1,class:"w-full",style:{height:"90%"}},bD={key:2,class:"w-full overflow-y-auto",style:{height:"90%"}};function AD(n,e,t,r,s,i){const o=K("EventNewForm"),a=K("EventEditForm"),c=K("EventCard");return w(),D("div",pD,[f("div",{class:he(["flex flex-col justify-center w-full py-3 text-center",{"bg-fuchsia-500/95":s.eventTab==="list","bg-yellow-500/95":s.eventTab==="create","bg-teal-500/95":s.eventTab==="edit"}]),style:{height:"10%"}},[s.eventTab==="create"?(w(),D("h2",mD," New Event ? ")):s.eventTab==="edit"?(w(),D("h2",gD," Edit Event ? ")):(w(),D("h2",_D,"Upcoming events")),s.eventTab==="list"?(w(),D("button",{key:3,class:"absolute z-30 right-3 top-48 flex flex-col justify-center items-center h-12 w-12 border-2 text-4xl font-bolder rounded-full bg-emerald-500 border-emerald-800 text-white",onClick:e[0]||(e[0]=Wt(l=>s.eventTab="create",["prevent"]))},vD)):(w(),D("button",{key:4,class:"absolute z-30 right-3 top-48 flex flex-col justify-center items-center h-12 w-12 border-2 text-4xl font-bolder rounded-full bg-slate-400 border-white text-white",onClick:e[1]||(e[1]=Wt(l=>s.eventTab="list",["prevent"]))},wD))],2),s.eventTab==="create"?(w(),D("div",ED,[ae(o)])):s.eventTab==="edit"?(w(),D("div",TD,[ae(a)])):(w(),D("div",bD,[(w(!0),D(De,null,Bn(s.events,l=>(w(),D("div",{class:"w-full",key:l.id},[ae(c,{event:l,toggleEdit:i.toggleEdit},null,8,["event","toggleEdit"])]))),128))]))])}const RD=ne(fD,[["render",AD]]),SD={name:"BikeHistoryCard",props:["entry"]},xD={class:"flex flex-col justify-center items-start px-3 py-1 my-1 w-full h-20 border-2 border-emerald-400 bg-sky-50 rounded-3xl"},PD={class:"font-bold text-center w-full text-slate-700"},CD=f("span",{class:"font-bold text-green-600 mr-2"},"Start: ",-1),kD=f("span",{class:"font-bold text-red-700 mr-2"},"End: ",-1);function DD(n,e,t,r,s,i){return w(),D("div",xD,[f("p",PD,_e(t.entry.user),1),f("p",null,[CD,Ie(_e(t.entry.startDate),1)]),f("p",null,[kD,Ie(_e(t.entry.endDate),1)])])}const ND=ne(SD,[["render",DD]]),VD=mu("bike",{state:()=>({selectedName:"",isNameSelected:!1,isBikeUsed:!1,currentBikeUser:"Florian",history:[{user:"Florian 🦊",startDate:"2023/08/12 21:21",endDate:"2023/08/12 23:56"},{user:"Florian 🦊",startDate:"2023/08/12 21:21",endDate:"2023/08/12 23:56"},{user:"Florian 🦊",startDate:"2023/08/12 21:21",endDate:"2023/08/12 23:56"},{user:"Florian 🦊",startDate:"2023/08/12 21:21",endDate:"2023/08/12 23:56"}]}),actions:{handleNameSelection(){this.selectedName===""?this.isNameSelected=!1:this.isNameSelected=!0},startUsing(){this.currentBikeUser=this.selectedName,this.isBikeUsed=!0},stopUsing(){this.currentBikeUser="",this.isBikeUsed=!1}}});const OD={name:"AppBike",data(){return{}},mounted(){console.log("mounted comp bike")},methods:{isScreenHeightLessThan670(){return window.innerHeight<670},isScreenHeightGreaterThanOrEqualTo670(){return window.innerHeight>=670}},computed:{...$n(Ui,["listRooms"]),...Vx(VD)},components:{BikeHistoryCard:ND}},MD={class:"flex flex-col items-center h-full w-full pb-3 font-montserrat text-center"},LD={class:"flex flex-col items-center justify-center w-full py-2 bg-green-200/95",style:{height:"10%"}},FD=f("h2",{class:"text-3xl tracking-widest italic text-green-700 font-bold"},"Omote-bike",-1),UD={key:0,class:"text-xl"},BD={class:"text-red-700 font-bold text-2xl"},$D={key:1,class:"text-xl"},qD={class:"w-full h-52 py-3"},jD=f("label",{class:"text-2xl font-bold text-emerald-700 mb-2"},"Select your name :",-1),zD=f("option",{value:""},"Choose your name",-1),GD=["value"],KD=["disabled"],HD=f("div",{class:"flex flex-col"},[f("p",{class:"text-xl"},"The lock passcode is :"),f("p",{class:"text-3xl font-bold my-1 text-green-700"},"7 1 5 3")],-1),WD=f("button",{type:"submit",class:"flex flex-col items-center justify-center h-12 w-2/5 mt-3 border-2 rounded-full text-xl font-bold border-white bg-red-600 text-white active:translate-y-1"}," Stop ",-1),QD=[HD,WD],YD=f("h3",{class:"text-xl font-bold italic text-slate-800"},"History",-1);function JD(n,e,t,r,s,i){const o=K("BikeHistoryCard");return w(),D("div",MD,[f("div",LD,[FD,n.bikeStore.isBikeUsed?(w(),D("p",UD,[f("span",BD,_e(n.bikeStore.currentBikeUser),1),Ie(" is using the bike now ")])):(w(),D("p",$D,"Nobody is using the bike"))]),f("div",qD,[n.bikeStore.isBikeUsed?(w(),D("form",{key:1,class:"h-full w-full flex flex-col items-center justify-center",onSubmit:e[3]||(e[3]=(...a)=>n.bikeStore.stopUsing&&n.bikeStore.stopUsing(...a))},QD,32)):(w(),D("form",{key:0,class:"h-full w-full flex flex-col items-center justify-center",onSubmit:e[2]||(e[2]=(...a)=>n.bikeStore.startUsing&&n.bikeStore.startUsing(...a))},[jD,Oe(f("select",{id:"nameChoice",name:"name",class:"border-2 border-yellow-500 p-3 rounded-full overflow-y-auto","onUpdate:modelValue":e[0]||(e[0]=a=>n.bikeStore.selectedName=a),onChange:e[1]||(e[1]=(...a)=>n.bikeStore.handleNameSelection&&n.bikeStore.handleNameSelection(...a))},[zD,(w(!0),D(De,null,Bn(n.listRooms,a=>(w(),D("option",{key:a.residentName,value:a.residentName},_e(a.residentName),9,GD))),128))],544),[[GI,n.bikeStore.selectedName]]),f("button",{type:"submit",class:he(["z-10 relative flex flex-col items-center justify-center h-12 w-2/5 mt-3 border-2 rounded-full text-xl font-bold",{"bg-gray-600 text-white opacity-20":n.bikeStore.isNameSelected===!1,"border-white text-white rolling_bg active:translate-y-1":n.bikeStore.isNameSelected===!0}]),disabled:n.bikeStore.isNameSelected===!1}," Start ",10,KD)],32))]),YD,f("div",{class:he(["flex flex-col items-center px-3 py-2 mx-2 border-4 border-green-500 rounded-3xl bg-slate-50 bg-opacity-50 overflow-y-auto",{"h-52":i.isScreenHeightLessThan670(),"h-96":i.isScreenHeightGreaterThanOrEqualTo670()}]),style:{width:"95%"}},[(w(!0),D(De,null,Bn(n.bikeStore.history,a=>(w(),D("div",{class:"flex flex-col w-full",key:a.startDate},[ae(o,{entry:a},null,8,["entry"])]))),128))],2)])}const XD=ne(OD,[["render",JD]]),il=mu("authentication",{state:()=>({isConnected:!0,userData:{roomNumber:"",residentName:"",residentNameKanji:"",roomEmoji:"",roomEvents:[]}}),actions:{async sendLoginDB(n,e,t,r){const s=gi(zh,"users",e),i=await $h(s);if(i.data().residentName.toLowerCase()===t.toLowerCase())try{return await Gv.signInWithEmailAndPassword(i.data().roomEmail,r),console.log("NICEEEEE"),setTimeout(()=>{this.isConnected=!0},1500),!0}catch(o){return console.log(o),!1}else return!1},async getUserData(n){try{const e=gi(zh,"users",n),t=await $h(e);this.userData={roomNumber:t.data().roomNumber,residentName:t.data().residentName,residentNameKanji:t.data().residentNameKanji,roomEmoji:t.data().roomEmoji,roomEvents:t.data().roomEvents}}catch(e){console.log(e)}},async createAuthAndFirestoreDB(n){try{for(let e=0;e<=17;e++)await W5.doc(Object.keys(n)[e]).set({roomNumber:n[Object.keys(n)[e]].roomNumber,residentName:n[Object.keys(n)[e]].residentName,residentNameKanji:n[Object.keys(n)[e]].residentNameKanji,roomEmail:n[Object.keys(n)[e]].roomEmail,roomEmoji:n[Object.keys(n)[e]].roomEmoji,roomEvents:n[Object.keys(n)[e]].roomEvents});console.log("ok")}catch(e){console.log(e)}}}}),ZD={name:"LoginForm",data(){return{selectedRoom:"A101",loginResidentName:"",loginRoomPassword:"",infoMsg:"",loginTabTrigger:!1,sendingLoginInfo:!1,credentialsCheck:""}},methods:{...YI(il,["sendLoginDB","getUserData"]),async sendLogin(){this.loginTabTrigger=!1,this.sendingLoginInfo=!0,this.infoMsg="Checking user credentials",this.credentialsCheck="checking",await this.sendLoginDB(this.listRooms,this.selectedRoom,this.loginResidentName,this.loginRoomPassword)===!0?(this.loginTabTrigger=!0,this.credentialsCheck="good",this.infoMsg="You are successfully logged in !",this.getUserData(this.selectedRoom)):(this.loginTabTrigger=!0,this.credentialsCheck="error",this.infoMsg="Something went wrong, try again",setTimeout(()=>{this.sendingLoginInfo=!1},800))}},computed:{...$n(Ui,["listRooms"]),...JI(il,["isConnected"])}},eN={class:"flex flex-col w-full justify-center items-center"},tN=f("label",{class:"text-3xl"},"Room N° :",-1),nN=["value"],rN={class:"mt-5 flex flex-col w-full justify-center items-center"},sN=f("label",{class:"text-3xl"},[Ie("Name "),f("span",{class:"text-sm"},"(Romaji)")],-1),iN={class:"mt-5 flex flex-col w-full justify-center items-center"},oN=f("label",{class:"text-3xl"},"Password",-1),aN={class:"flex flex-col items-center w-full mt-12"},cN=["disabled"];function lN(n,e,t,r,s,i){return w(),D(De,null,[s.loginTabTrigger?(w(),D("div",{key:0,class:he(["absolute flex flex-col justify-center items-center w-full px-3 py-2 border-2 text-center font-montserrat text-white text-2xl",{"bg-red-600/95 border-red-800":s.credentialsCheck==="error","bg-blue-600/95 border-blue-800":s.credentialsCheck==="checking","bg-green-600/95 border-green-800":s.credentialsCheck==="good"}])},_e(s.infoMsg),3)):oe("",!0),f("form",{class:"w-full h-full flex flex-col justify-center items-center font-montserrat",onSubmit:e[3]||(e[3]=Wt((...o)=>i.sendLogin&&i.sendLogin(...o),["prevent"]))},[f("div",eN,[tN,Oe(f("select",{id:"roomChoice",name:"room",class:"w-3/6 border-2 border-teal-400 py-1 rounded-xl text-center text-2xl overflow-y-auto","onUpdate:modelValue":e[0]||(e[0]=o=>s.selectedRoom=o),required:""},[(w(!0),D(De,null,Bn(Object.keys(n.listRooms),o=>(w(),D("option",{key:o,value:o},_e(n.listRooms[o].roomNumber),9,nN))),128))],512),[[GI,s.selectedRoom]])]),f("div",rN,[sN,Oe(f("input",{type:"text",id:"nameChoice",name:"name",class:"w-4/6 border-2 border-teal-400 py-1 rounded-xl text-center text-2xl overflow-y-auto",placeholder:"Your name","onUpdate:modelValue":e[1]||(e[1]=o=>s.loginResidentName=o),required:""},null,512),[[it,s.loginResidentName]])]),f("div",iN,[oN,Oe(f("input",{type:"password",id:"password",name:"password",class:"w-4/6 border-2 border-teal-400 py-1 rounded-xl text-center text-2xl overflow-y-auto",placeholder:"Password","onUpdate:modelValue":e[2]||(e[2]=o=>s.loginRoomPassword=o),required:""},null,512),[[it,s.loginRoomPassword]])]),f("div",aN,[f("button",{type:"submit",class:he(["w-3/6 border-2 text-white text-2xl py-1 rounded-full",{"border-teal-700 bg-teal-500":!s.sendingLoginInfo,"border-slate-700 bg-slate-600 opacity-20":s.sendingLoginInfo}]),disabled:s.sendingLoginInfo}," Login ",10,cN)])],32)],64)}const uN=ne(ZD,[["render",lN]]),hN={name:"App",data(){return{tab:"Chores",loggedUser:""}},methods:{...YI(il,["getUserData"])},components:{AppEventPlanner:RD,AppChores:ZC,AppListRooms:y7,AppBike:XD,LoginForm:uN},computed:{...JI(il,["isConnected","userData"])}},dN={class:"h-screen w-screen"},fN={class:"px-2 py-3 h-36 text-center bg-cyan-600"},pN=f("h1",{class:"font-montserrat text-3xl max-[364px]:text-2xl font-bold text-slate-100"}," Share House Manager ",-1),mN=f("h3",{class:"font-montserrat text-lg text-slate-100 drop-shadow-xl"},"Omotesando 1",-1),gN={key:0,class:"flex flex-row justify-around font-montserrat font-bold mt-2.5"},_N={key:1,class:"w-full px-3 bg-white/80 border-2 border-red-700 rounded-md text-red-600 text-lg font-montserrat"},yN={style:{height:"calc(100vh - 9rem)","background-image":"url('/bg-mobile-blue.jpg')","background-size":"cover","background-position":"center","background-repeat":"no-repeat"},class:""},vN={key:0,class:"w-full",style:{height:"calc(100vh - 9rem)"}},IN={key:1,class:"w-full h-full"};function wN(n,e,t,r,s,i){const o=K("LoginForm"),a=K("AppEventPlanner"),c=K("AppChores"),l=K("AppListRooms"),u=K("AppBike");return w(),D("div",dN,[f("header",fN,[pN,mN,n.isConnected?(w(),D("div",gN,[f("div",{class:he(["border-2 border-blue-300 text-slate-50 rounded-full px-3 py-2",{"bg-blue-500 ":s.tab==="Chores"," bg-transparent text-black":s.tab!=="Chores"}]),onClick:e[0]||(e[0]=h=>s.tab="Chores")}," Chores ",2),f("div",{class:he(["border-2 border-emerald-200 text-slate-50 rounded-full px-3 py-2",{"bg-teal-400":s.tab==="Rooms"," bg-transparent text-black":s.tab!=="Rooms"}]),onClick:e[1]||(e[1]=h=>s.tab="Rooms")}," Rooms ",2),f("div",{class:he(["border-2 border-purple-300 text-slate-50 rounded-full px-3 py-2",{"bg-purple-500 ":s.tab==="Events"," bg-transparent text-black":s.tab!=="Events"}]),onClick:e[2]||(e[2]=h=>s.tab="Events")}," Events ",2),f("div",{class:he(["border-2 border-green-300 text-slate-50 rounded-full px-3 py-2",{"bg-green-500 ":s.tab==="Bike"," bg-transparent text-black":s.tab!=="Bike"}]),onClick:e[3]||(e[3]=h=>s.tab="Bike")}," Bike ",2)])):(w(),D("h2",_N," This is a private website. To access it, please login first. "))]),f("div",yN,[n.isConnected?(w(),D("div",IN,[s.tab==="Events"?(w(),ge(a,{key:0})):oe("",!0),s.tab==="Chores"?(w(),ge(c,{key:1})):oe("",!0),s.tab==="Rooms"?(w(),ge(l,{key:2})):oe("",!0),s.tab==="Bike"?(w(),ge(u,{key:3})):oe("",!0)])):(w(),D("div",vN,[ae(o)]))])])}const EN=ne(hN,[["render",wN]]);let ic;Gv.onAuthStateChanged(()=>{ic||(ic=bx(EN),ic.use(Sx()),ic.mount("#app"))});
