<template>
  <div class="flex flex-col justify-start items-center w-full h-full">
    <div
      ...
      class="flex flex-col justify-center items-center w-full h-28 px-3 py-2 border-2 text-center text-white text-2xl"
      :class="{
    ...
    <div v-if="gotRoomSuccess" class="w-full h-full py-5 flex flex-col justify-center items-center">
      <form
        class="w-full flex flex-col justify-start items-center overflow-y-auto"
      ...
      >
        ...
        <div class="flex flex-col items-center w-full mt-12">
          ...
          <a href="/newresident" class="mt-12">
            <p class="px-5 py-1 border text-white rounded-full border-cyan-700 bg-cyan-500">
              New resident
            </p>
          </a>
        </div>
...
export default {
  ...
  async mounted() {
    ...
    if (!this.listRooms.A101.roomNumber) {
      ...
      this.loginResidentName = this.listRooms.A101.residentName
    } else {
